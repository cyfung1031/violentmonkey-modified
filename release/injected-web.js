      ...
      const Me = t ? null : r.cloneInto,
        xe = (() => {
          ...
          if (
            ...
            c &&
              !f(c[0]) &&
              ((g = c[0]), (m = g), e ? (d = c[1]) : (o = !g.document.requestStorageAccessFor), (c = !1)),
            c || (c = { __proto__: null }),
            (c = [
              (T = c[(p += 1)] || g.CustomEvent),
              (E = c[(p += 1)] || g.DOMParser),
              (R = c[(p += 1)] || g.Error),
              (O = c[(p += 1)] || g.EventTarget),
              (A = c[(p += 1)] || g.KeyboardEvent),
              (I = c[(p += 1)] || g.MouseEvent),
              (P = c[(p += 1)] || g.Object),
              (L = c[(p += 1)] || g.Symbol),
              (N = c[(p += 1)] || g.Proxy),
              (q = c[(p += 1)] || g.dispatchEvent),
              (F = c[(p += 1)] || g.removeEventListener),
              (J = c[(p += 1)] || g.addEventListener),
              (B = ((s = P) && c[(p += 1)]) || s.defineProperty),
              (z = c[(p += 1)] || s.getOwnPropertyDescriptor),
              (u = c[(p += 1)] || s.getOwnPropertyNames),
              (X = c[(p += 1)] || s.getPrototypeOf),
              (Q = c[(p += 1)] || s.setPrototypeOf),
              (W = c[(p += 1)] || s.assign),
              (Y = c[(p += 1)] || s.keys),
              (Z = c[(p += 1)] || s.values),
              (ee = c[(p += 1)] || (t = g.Array[_]).concat),
              (te = c[(p += 1)] || t.filter),
              (V = c[(p += 1)] || t.forEach),
              (ne = c[(p += 1)] || t.indexOf),
              (oe = c[(p += 1)] || g.Element[_].remove),
              (re = c[(p += 1)] || g.String[_].slice),
              (k = c[(p += 1)] || (i = g.Reflect).apply),
              ($ = c[(p += 1)] || (a = s.call).bind(a)),
              (S = c[(p += 1)] || a.bind(s.bind)),
              (ie = c[(p += 1)] || g.URL[_].toString),
              (C = c[(p += 1)] || S(s.create, s, null)),
              (ae = c[(p += 1)] || g.FormData[_].entries),
              (ue = c[(p += 1)] || S(a, s[_].hasOwnProperty)),
              (se = c[(p += 1)] || g.Array.isArray),
              (ce = c[(p += 1)] || g.JSON.parse),
              (de = c[(p += 1)] || g.JSON.stringify),
              (fe = c[(p += 1)] || y((d || g).console)),
              (pe = c[(p += 1)] || g.Math.random),
              (_e = c[(p += 1)] || E[_].parseFromString),
              (ge = c[(p += 1)] || i.ownKeys),
              (he = c[(p += 1)] || g.Event[_].stopImmediatePropagation),
              (U = c[(p += 1)] || g.Promise),
              (j = c[(p += 1)] || ((t = U[_]), e ? U : t.constructor)),
              (me = c[(p += 1)] || t.then),
              (ye = c[(p += 1)] || g.URLSearchParams[_].toString),
              (ve = c[(p += 1)] || z(g.Document[_], "currentScript").get),
              (we = c[(p += 1)] || z(T[_], "detail").get),
              (be = c[(p += 1)] || z(I[_], "relatedTarget").get),
              (D = c[(p += 1)] || z(m, "length").get || (() => h(l, "length", 1e9))),
              (H = c[(p += 1)] || z(m, "parent").get || (() => h(l, "parent"))),
              (le = c[(p += 1)] || [u(m), g !== m && u(g)]),
            ]),
            (K = L.toStringTag),
            o)
          )
