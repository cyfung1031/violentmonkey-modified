  ...
  1 !== window[e] &&
    (window[e] = function (e, t, n) {
      ...
      ;(() => {
        ...
        n.r(z), n.d(z, { __proto__: null, default: () => Wt })
        const fe = C(),
          he = (e) => K(fe, e),
          xe = C(),
          Ge = {
        ...
        function Ce(e, t, n, o, r) {
          const l = M()
          if (((xe[l] = o || Ve), r ? m(t, r, l) : (t = { __CBID: l, data: t }), Ge.post(e, t, n), !o)) return $e
        }
        function Ve(e) {
          $e = e
        }
          ...
          Ne = (e, t, n) => {
            ...
            $(
              ...
              (n.post = (e, o, r, i) => {
                ...
                Pe(t, { cmd: e, data: o, node: !!a }), a && $(q, l, a)
              })
          }
        let Le = 0
        const je = C()
        function Ae(e) {
          ...
          return (je[t] = n), ke.post("TabOpen", { key: t, data: e }), n
        }
        he({
          TabClosed(e) {
            const t = je[e]
        ...
        function Ze(e, t, n) {
          ...
          if (Fe in e) {
            if (
              ((r = e[Fe]),
              e[d] || ((i = r), (r = ""), $(V, i, (e) => (r += e)), (e[Fe] = [r]), (e[u] = r)),
        ...
        function at(e, t, n, o, r, l) {
          ...
          if (o !== r) {
            var s
            i = ke[l.async ? "send" : "post"]("UpdateValue", { id: e, key: t, raw: o })
        ...
        const pt = j.isConcatSpreadable,
          _t = (...e) => {
            const t = []
            return m(t, pt, !0), $(V, e, (e) => m(e, pt, !0)), k(Z, t, e)
          },
          gt = (e, t) => {
            let n
            if (null === e) n = "null"
          ...
          vt = {
            bound: {
              ...
              GM_registerMenuCommand(e, t, n) {
                ...
                const { id: o } = this,
                  r = n.id || e,
                  l = w(Te, o, r)
                return (l.cb = t), (l.text = e), ke.post("RegisterMenu", { id: o, key: r, val: n }), r
              },
              GM_unregisterMenuCommand(e) {
                const { id: t } = this,
                  n = Te[t]
                n && (n[e] || (e = Gt(e, n))) && (delete n[e], ke.post("UnregisterMenu", { id: t, key: e }))
              },
              GM_download(e, t) {
                if (
            ...
            free: {
              ...
              GM_openInTab: (e, t) => (((t = y(p(t) ? t : { active: !t })).url = e), Ae(t)),
              GM_setClipboard(e, t) {
                ke.post("SetClipboard", { data: e, type: t })
              },
              GM_log: de.log,
            },
          }
        ...
        function xt(e, t, n, o) {
          ...
          if (a) {
            ...
            ;(r = (e && !1 === n) || w(i, t, a, !1)),
              r || ((r = ke.call("GetResource", { id: l, isBlob: n, key: a, raw: e && a })), w(i, t, a, r))
          }
          return yt(e, !0 === r ? a : r)
        }
        function Gt(e, t) {
          ...
          Et = (e) => {
            ...
            if (o) {
              if ((n || X(o, null), n)) {
                ...
                ;(o.value = W(n, "name", { __proto__: null, value: e })), (kt[e] = void 0), (Vt[e] = o)
              } else (+e >= 0 && e < $(D, l)) || (Vt[e] = o)
              return o
            }
          }
        function Ot(e) {
          ...
          const n = C(),
            o = new L(e, {
              ...
              defineProperty(t, n, o) {
                if (n in e || !(t = Vt[n] || Et(n)) || t.configurable) return W(e, n, o)
              },
              deleteProperty: (n, o) => (
                (n = delete e[o]) &&
                  (n = Vt[o] || Et(o)) &&
              ...
              get: (t, r) => {
                if ("undefined" !== r && r !== Ct) return void 0 !== (t = e[r]) || r in e ? t : Pt(e, r, o, n) && e[r]
              },
          ...
          return (
            ...
            ("parent" === t && l === $(H, l))
              ...
              : i && s && "string" == typeof t && t.length >= 3 && "o" === t[0] && "n" === t[1]
                ? Nt(r, t, o, n)
                : (i && (r.get = T(i, l)), s && (r.set = T(s, l)), a && t === $t && (r.value = mt({}, a))),
            W(e, t, r),
            r
          )
        }
        ...
        $(V, [O, N], (e) => {
          ...
          for (let t = 0, n = _e(e); t < n.length; t++) {
            const o = n[t],
              r = B(e, o)
            X(r, null), ((f(r.value) ? kt : St)[o] = r)
          }
        }),
          (re = null)
        const jt = { __proto__: null, getResourceUrl: wt, xmlHttpRequest: bt },
        ...
        function Jt(e) {
          const { meta: t } = e,
            ...
            l = v({ resources: o, resCache: C(), async: !1 }, e, qt),
            i = Ft(e.gmi, t, o),
          ...
          for (let e = 0; e < n.length; e++) {
            let t,
              ...
              i,
              c = n[e]
            ;("GM." === $(oe, c, 0, 3) && (i = $(oe, c, 3)) && (o = jt[i])) || (t = vt.bound[(r = i ? `GM_${i}` : c)])
              ? (t = T(o || t, o || i in At ? u || (u = K(C(), l, { async: !0 })) : l))
              : !(t = vt.free[r]) &&
                (t = ("window.close" === c && Ht) || ("window.focus" === c && Ut)) &&
                (c = $(oe, c, 7)),
              t && (i ? (s[i] = t) : (a[c] = t))
          }
          return d && ((c = Ot(a)), (a.c = a)), { gm: a, wrapper: c }
        }
        function Ft(e, t, n) {
          const o = Q(n)
          return (
            ...
            (t.resources = o),
            mt(e, ke.gmi),
            mt(e, { injectInto: ke.mode, platform: mt({}, ke.ua), script: t, scriptHandler: i, version: "2.19.0" })
          )
        }
        const Kt = C()
        function Wt(n, o) {
          if (!t)
            return (
              ...
              (de = o),
              (e, t, n, o) => {
                ke.onHandle({ cmd: e, data: t, node: o })
              }
            )
          if (
            ($(
        ...
        function Bt(e) {
          ...
          delete l[t.key.win], n && $(ne, n), ke.post("Run", t.id), $(e, i, o, de.error)
        }
        he({
          ...
          Callback({ id: e, data: t }) {
            if ("Error" === e) throw t
            const n = xe[e]
            delete xe[e], n && $(n, this, t)
          },
          async Plant({ data: e, win: t }) {
            m(l, t, Bt, !0, "set"), await 0, delete Kt[e], delete l[t]
          },
          ScriptData({ info: n, items: o }) {
            ...
            for (let e = 0; e < o.length; e++) {
              const n = o[e],
                { key: i } = n
              if (((Kt[i.data] = n), (Re[n.id] = X(n.values || {}, null)), !t)) {
                const e = i.win,
                  t = l[e]
                t ? (G(r, t), delete l[e]) : W(l, e, { __proto__: null, configurable: !0, set: Bt })
              }
            }
          ...
          Expose(e) {
            ...
            ;(p(n) ? n : (l[t] = {}))[i] = {
              version: "2.19.0",
              isInstalled: (t, n) => (e ? ke.send("GetScriptVer", { meta: { name: t, namespace: n } }) : b()),
            }
          },
        }),
          (o.exports = z)
