    ...
    (window[e] = function (e, t, n) {
      ...
      const Me = t ? null : r.cloneInto,
        xe = (() => {
          ...
          return (
            n && ((c = l[n]), delete l[n]),
            c && !f(c[0]) && ((g = c[0]), (m = g), (d = e && c[1]), (c = !1)),
            c || (c = { __proto__: null }),
            (c = [
              (E = c[(p += 1)] || g.CustomEvent),
              (R = c[(p += 1)] || g.DOMParser),
              (S = c[(p += 1)] || g.Error),
              (O = c[(p += 1)] || g.EventTarget),
              (I = c[(p += 1)] || g.KeyboardEvent),
              (A = c[(p += 1)] || g.MouseEvent),
              (P = c[(p += 1)] || g.Object),
              (L = c[(p += 1)] || g.Symbol),
              (N = c[(p += 1)] || g.Proxy),
              (D = c[(p += 1)] || g.dispatchEvent),
              (J = c[(p += 1)] || g.removeEventListener),
              (F = c[(p += 1)] || g.addEventListener),
