  ...
  1 !== window[e] &&
    (window[e] = function (e, t, n) {
      ...
      ;(() => {
        ...
        const Ae = ["log", "info", "warn", "error", "debug"],
          Ne = (e, t) => {
        ...
        const St = "console",
          ...
          Nt = (() => {
            ...
            return (
              r !== l &&
                $(V, le[1], (e) => {
                  ;(+e >= 0 && e < s) || (At.set(e, -1), (c = !1))
                }),
              e && !t && n in r && !At.get(n) && (At.set(n, 1), c && m(i, i.length, n)),
              c ? i : At.toArray()
            )
          })(),
          Lt = C(),
          ...
          Ut = (e) => {
            let t, n
            const o = Pt[e],
              i = o || Lt[e] || ((t = At.get(e) || (n = jt(e))) && z((t = t > 0 ? l : r), e))
            if (i) {
              if ((o || Q(i, null), o)) {
        ...
        function Ht(e, t) {
          ...
          return at(n, t === At ? Nt : t.toArray(), $(te, ge(e), Ft, t.get))
        }
        ...
        const Kt = ["displayName", "id"],
          ...
          Qt = (e) => (e = Ee.call("UAD")) && m(e, "getHighEntropyValues", Xt),
          Yt = () => Ee.post("TabClose"),
          Zt = () => Ee.post("TabFocus")
        function en(e) {
          const { meta: t } = e,
