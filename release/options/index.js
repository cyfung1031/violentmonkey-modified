    ...
    var h,
      ...
      D = {
        ...
        5630: (e, t, n) => {
          ...
          function b(e, t, n) {
            if (i.S1) return i.S1.then(b.bind(null, ...arguments))
            const s = (0, l.Wk)(e),
              r = s[0]
            if (((e = s.join(".")), !f(o.ZP, r))) return
            const u = s.length > 1 && s.slice(1),
              d = h([r])
            ;(0, a.vZ)(t, u ? (0, a._M)(d, u) : d) || ((c[r] = u ? (0, a.iA)(d, u, t) : t), w(r), m(), g(e, t, n))
          }
          function w(e) {
          ...
          class s {
            ...
            async getMulti(e, t) {
              const n = null == e ? void 0 : e.map(this.toKey, this),
                a = await i.get(n)
              return t || this.prefix ? b(l.Xw, a, t, this.toId, this) : a
            }
            async remove(e) {
            ...
            async set(e) {
              return await i.set(this.prefix ? b(l.Xw, e, null, this.toKey, this) : e), e
            }
          }
          const c = "cache",
            u = "code",
        ...
        5475: (h, U, z) => {
            ...
            for (let o; (o = M.exec(e)); ) {
              ...
              ;(i = !!i),
                ...
                "#" === s
                  ...
                  : (u || d ? (b = "i") : f ? (e = f) : (v || (b = "i"), (e = (0, D.YC)(e))),
          ...
          let Te, Me, Oe, Ee, Ze, Ve, Ye, Pe, Le, Ae, Fe, qe, Ne, Ke, Be, Je, Ge, Xe
          function Qe(e, t, n) {
            const l = n ? p : m
            ;(Fe = e),
              (qe = t),
              b(l, Fe, We.start, W.T ? lt : it),
              W.T || (b(l, Fe, "dblclick", et, !0), b(l, Fe, "mousedown", tt, !0), n || nt())
          }
          function et(e) {
          ...
          function tt(e) {
            !e.altKey && ht(e) && (Ae.draggable = !0), b(p, Fe, "mouseup", nt, !0)
          }
          function nt() {
            Ae && (Ae.draggable = !1), b(m, Fe, "mouseup", nt, !0)
          }
          function lt(e) {
            ht(e) && ((Ve = e), (Ye = setTimeout(at, je, "timer")), p(We.move, at), p(We.end, ot))
          }
          function at(e) {
            ot(), "timer" === e && (b(it, Ae, Ve), w && ut() && ((Fe.scrollTop += 1), (Fe.scrollTop -= 1)))
          }
          function ot() {
          ...
          function it(e) {
            ...
            ;(Te = Ae.cloneNode(!0)),
              (Me = b([].filter, Fe.children, (e) => "none" !== e.style.display)),
              (Ee = Me.indexOf(Ae)),
              (Ze = Ee),
              Me.splice(Ee, 1),
              (Oe = a.height),
          ...
          function st(e) {
            ...
            if (i && i !== Ae) {
              ...
              ;(o = Ae !== i[(t ? "next" : "previous") + "ElementSibling"]),
                o && (i.insertAdjacentElement(t ? "afterEnd" : "beforeBegin", Ae), ct(Me.indexOf(i) + t))
            }
            ;(Te.style.transform = `translate(${n - Pe}px, ${l - Le}px)`), (dt(l) || o) && (Xe = {})
          }
          function rt() {
            m(We.move, st),
              m(We.end, rt),
          ...
          function dt(e) {
            const t = ut() && Math.min(1, Math.max(0, e - Ke, Ne - e) / De)
            return (
              !t && Be && mt(),
              t && !Be && ((Be = setInterval(pt, He)), Re.forEach((e) => p(e, gt, !0))),
              (Je = t && (e > Ke ? 1 : -1) * ((1 + t * $e) | 0)),
              (Ge = v.now()),
              !!t
            )
          }
          ...
          function mt() {
            Re.forEach((e) => m(e, gt, !0)), Be && clearInterval(Be), (Be = 0)
          }
          function gt(e) {
            e.stopPropagation()
          }
          ...
          function ht(e) {
            return (Ae = e.target.closest(ze)), Ae
          }
          const ft = ["tabIndex"],
            ...
            Pt = {
                ...
                focused(e, t) {
                  ...
                  if (e && !t && n) {
                    ...
                    e.bottom > t.bottom - 8
                      ...
                      (0, be.u7)((0, W.vY)()) || n.focus({ preventScroll: !0 }),
              ...
              methods: {
                ...
                onFocus() {
                  be.$J.setContext("scriptFocus", !0)
                },
                onBlur() {
                  be.$J.setContext("scriptFocus", !1)
                },
                onTagClick(e) {
                                  ...
                                  return (
                                    ...
                                    (0, ce.iD)(
                                      "a",
                                      {
                                        ...
                                        onClick: (0, we.iM)((t) => o.onTagClick(e), ["prevent"]),
                                        class: (0, ue.C_)({
          ...
          var Ft = z(206),
            qt = z(6115),
            Nt = z(715)
          const Kt = { class: "form-group condensed" },
            Bt = ["textContent"],
            Jt = ["textContent"],
            Gt = ["textContent"],
            Xt = ["disabled"],
                    ...
                    (0, ce._)("div", Kt, [
                      (0, ce._)("label", null, [
                        (0, ce.wy)(
                          ...
                          [[we.e8, n.value.shouldUpdate]]
                        ),
                        (0, ce._)("span", { textContent: (0, ue.zw)(e.i18n("labelAllowUpdate")) }, null, 8, Bt),
                        (0, ce._)(
                          "span",
            ...
            En = {
              ...
              setup(e) {
                const t = e,
                  ...
                  r = [
                    [L, ee, ...l((0, D.ag)("labelInclude"))],
                    [A, te, ...l((0, D.ag)("labelMatch"))],
                  ...
                  (0, ce.iD)("div", nn, [
                    ...
                    (0, ce._)("table", null, [
                      ...
                      (0, ce._)("tr", null, [
                        bn,
                        (0, ce._)("td", null, [
                          (0, ce._)("p", { textContent: (0, ue.zw)((0, R.SU)(D.ag)("labelNoFrames")) }, null, 8, wn),
                        ]),
                        (0, ce._)("td", null, [
                          (0, ce.wy)(
                            (0, ce._)(
          ...
          const Pn = ["data-editing"],
            ...
            _l = {
              ...
              setup(e) {
                const t = e,
                  ...
                  h = (0, R.iH)(),
                  f = (0, R.iH)(),
                  w = (0, ce.Fl)(() => q(u.values(f.value), "key")),
                  y = { error: "", dirty: !1 },
                  ...
                  _ = { condition: "!edit" },
                  k = (e) => be.$J.setContext("edit", "selectionEnd" in e.target),
                ...
                function B(e, t = h.value[e], n = P(e, !0), l = Y(e, t)) {
                ...
                async function ee(e) {
                  ...
                  if ((1 === e ? (H.markClean(), (n.dirty = !1)) : (r.value = null), n.isAll)) {
                    const e = b(xe.Xw, n.jsonValue, (e) => (0, D.bd)(e) || "")
                    await (0, D.gj)("SetValueStores", { [t.script.props.id]: e }), A(e, !0)
                  } else await N(n, !0)
                }
                function te() {
                  const e = r.value
                ...
                function ie(e) {
                  ...
                  if (t) {
                    const e = r.value,
                      ...
                      l = e && (e.isAll ? L : P)
                    if ((A(t instanceof u ? t : (0, xe.p$)(t)), e)) {
                      const t = l(n)
                ...
                function se(e) {
                  ;(0, be.nk)(("ArrowDown" === e.key ? 1 : e.target !== l.value && -1) || 0)
                }
                return (
                  (0, ce.dl)(() => {
                    var e
                    ...
                    b(p, l, "focusin", k),
                      ...
                      (0, D.gj)("GetValueStore", a, void 0, (M = { tab: { id: Math.random() - 2 }, [S]: 0 })).then(
                        (e) => {
                          const t = !h.value
                          A(e) && t && U.value.length && Z(!0), (c.value = !1)
                        }
                      ),
                      (I = [
                        () => b(m, l, "focusin", k),
                        be.$J.register("pageup", () => V(-1), _),
                        be.$J.register("pagedown", () => V(1), _),
                        ...
                        (0, ce._)("div", Ln, [
                          (0, ce._)("nav", An, [
                            e.readOnly
                              ? (0, ce.kq)("", !0)
                              : ((0, ce.wg)(),
                                (0, ce.iD)("a", { key: 0, onClick: K, class: "btn-ghost", tabindex: "0" }, [
                          ...
                          (0, ce._)(
                            "div",
                            {
                              ...
                              onKeydown: [
                                (0, we.D2)((0, we.iM)(se, ["exact"]), ["down"]),
                                (0, we.D2)((0, we.iM)(se, ["exact"]), ["up"]),
                              ],
                            },
                            [
                              (0, ce._)(
                                      ...
                                      [
                                        ...
                                        e.readOnly
                                          ...
                                          : ((0, ce.wg)(),
                                            (0, ce.iD)(
                                              "div",
                                              { key: 0, class: "del", onClick: (0, we.iM)((e) => J(t), ["stop"]) },
                                    ...
                                    (0, ce.wy)(
                                      (0, ce._)(
                                        "input",
                                        {
                                          ...
                                          ref: a,
                                          spellcheck: "false",
                                          onKeydown: [oe, (0, we.D2)((0, we.iM)(te, ["exact", "stop"]), ["esc"])],
                                        },
                                        null,
                                        40,
                                        xl
            ...
            Nl = ["textContent"],
            Kl = { key: 2, class: "errors shelf my-1c" },
            Bl = ["textContent"],
            Jl = ["textContent"],
            Gl = { key: 1, class: "my-1" },
            Xl = "https://violentmonkey.github.io/api/matching/",
            Ql = { [G]: "", [B]: "", [le]: "", [K]: "", [J]: "", [ee]: !0, [X]: !0, [te]: !0, [Q]: !0, tags: "" },
            ea = (e) => ("" !== e ? e : null),
            ta = [L, A, F, q],
            na = (e) =>
              e.trim()
                ...
                return (
                  (0, ce.bv)(() => {
                    ...
                    ;(o = m.value),
                      ...
                      j.Z.get("editorWindow") &&
                        1 === e.history.length &&
                        (null == (t = browser.windows) || t.getCurrent({ populate: !0 }).then(K))
                  ...
                  (0, ce.dl)(() => {
                    document.body.classList.add("edit-open"),
                      (i = [
                        be.$J.register("a-pageup", L),
                        be.$J.register("a-pagedown", A),
                        be.$J.register(ae.replace(/(?:Ctrl|Cmd)-/i, "ctrlcmd-"), E),
                        be.$J.register("escape", Z),
                        be.$J.register("f1", () => {
                          h.value = "help"
                        }),
                      ]),
                              ...
                              z.value
                                ? ((0, ce.wg)(),
                                  (0, ce.j4)(
                                    ...
                                    {
                                      default: (0, ce.w5)(() => [
                                        (0, ce._)("code", { textContent: (0, ue.zw)(z.value) }, null, 8, Bl),
                                      ]),
                                      _: 1,
                                    }
                                  ))
            ...
            ha = ["textContent"],
            fa = ["textContent"],
            ba = ["textContent", "onClick"],
            wa = { key: 0, class: "btn-group" },
            ...
            Ka = {
              ...
              setup(e) {
                ...
                const a = `${Fa} && inputFocus`,
                  ...
                  f = { [Za]: "e", [Pa]: "space", [Aa]: "r", [Ya]: "r", [Va]: "x" },
                  y = (e, t) => t.map(([t, n, l]) => be.$J.register(t, e, { condition: n, caseSensitive: l }))
                let x,
                  C = 0,
                  _ = [],
                  S = []
                const U = (0, R.iH)(),
                  ...
                  L = (0, ce.Fl)(() => H.filteredScripts[H.focusedIndex]),
                  A = (0, ce.Fl)(() =>
                    P.loading ||
                  ...
                  K = (e) => e.target.closest("[data-batch-action]"),
                  B = {
                    [Pa]: {
                      icon: Na,
                      arg(e) {
                ...
                function We() {
                  const e = () => {
                    var e
                    be.$J.setContext("buttonFocus", (null == (e = (0, W.vY)()) ? void 0 : e.tabIndex) >= 0)
                  }
                  p("focus", e, !0)
                  const t = [
                    () => m("focus", e, !0),
                ...
                Q(),
                  ...
                  (0, ce.YP)(L, (e) => {
                    be.$J.setContext("selectedScript", e)
                  }),
                  (0, ce.YP)(
                    () => H.showHotkeys,
                    (e) => {
                      be.$J.setContext("showHotkeys", e)
                    }
                  )
                const Re = []
                return (
                              ...
                              (0, ce._)("header", pa, [
                                              ...
                                              content: (0, ce.w5)(() => [
                                                (0, ce._)(
                                                  "a",
                                                  {
                                                    ...
                                                    tabindex: "0",
                                                    onClick:
                                                      t[0] || (t[0] = (0, we.iM)((e) => oe("_new"), ["prevent"])),
                                                  },
                                                  null,
                                                  8,
                                                  va
                                ...
                                (0, ce._)(
                                  "form",
                                  {
                                    ...
                                    onSubmit: t[5] || (t[5] = (0, we.iM)(() => {}, ["prevent"])),
                                    style: (0, ue.j5)({
                                      "min-width": "10em",
                                    ...
                                    (0, ce.iD)(
                                      ...
                                      (0, ce.Ko)(H.sortedScripts, (e, t) =>
                                        (0, ce.wy)(
                                          ...
                                          [[we.F8, !H.search.rules.length || !1 !== e.$cache.show]]
                                        )
                                      ),
                                      128
                                    )),
          ...
          const Po = (0, z(4288).HP)(async () => {
            ...
            Lo = ["textContent", "disabled"],
            Ao = ["textContent", "title"],
            Fo = { class: "mt-1" },
              ...
              setup(e) {
                ...
                async function f(e) {
                  ...
                  const p = {},
                    ...
                    h = (v && (await U(v))) || {},
                    f = j.Z.get("importSettings") && h.settings,
                    b = h.scripts || {},
                    y = h.values || {}
                  let x,
                    C = 0,
                  ...
                  ;(r = (0, D.xA)()),
                    ...
                    c ||
                      ...
                      (c = g.runtime.connect({ name: "undoImport" })),
                      await new d(w)),
                    await S(async (e, n, l) => {
                    ...
                    s(f) && (delete f.sync, (0, D.gj)("SetOptions", f)),
                ...
                async function b() {
                  ;(await (0, W.GW)(a)) && ((l.value = ""), c.postMessage(!0), await new d(w))
                }
                function w(e) {
                  c.onMessage.addListener(function t() {
                    c.onMessage.removeListener(t), e()
                  })
                }
                function y(e) {
                  let t
                  const n = (t) => e.classList.toggle("drop-allowed", t),
                    ...
                    i = async (e) => {
                      ...
                      ;(await (0, W.GW)((0, D.ag)("buttonImportData"))) && (await h(t))
                    }
                  return () => {
                            ...
                            ({ type: e, name: t, text: n }, l) => (
                              ...
                              (0, ce.iD)(
                                ...
                                [
                                  t
                                    ? ((0, ce.wg)(),
                                      (0, ce.iD)("td", { key: 0, textContent: (0, ue.zw)(t) }, null, 8, Bo))
                                    : (0, ce.kq)("", !0),
          ...
          const ni = (0, D.ag)("msgDateFormatInfo", u.keys(ei.q).join(", ")),
            ...
            mi = {
              ...
              setup(e) {
                ...
                function s(e) {
                  const n = w && parseFloat(t.browserVersion),
                    l = o.value
              ...
              setup(e) {
                ...
                function i() {
                  const e = ["lastModified", "lastUpdate", "sync"],
                    t = b(xe.Xw, Yo.ZP, null, (t, n) => !e.includes(t) && !(0, xe.vZ)(n, j.Z.get(t)) && t)
                  return (
          ...
          const Ai = {
                          ...
                          (0, ce.iD)("fieldset", Di, [
                            (0, ce._)("label", $i, [
                              ...
                              (0, ce.wy)(
                                ...
                                [[we.nr, o.state.userConfig.serverUrl]]
                              ),
                            ]),
                            (0, ce._)("div", Wi, [
                              (0, ce._)("label", null, [
                                ...
                                (0, ce.wy)(
                                  ...
                                  [[we.nr, o.state.userConfig.username]]
                                ),
                              ]),
                              (0, ce._)("label", Ti, [
                                (0, ce._)(
                                ...
                                (0, ce.wy)(
                                  ...
                                  [[we.nr, o.state.userConfig.password]]
                                ),
                              ]),
                              (0, ce._)("label", null, [
                                (0, ce.wy)(
                                  ...
                                  [[we.e8, o.state.userConfig.anonymous]]
                                ),
                                (0, ce._)(
                                  "span",
                  ...
                  (e, i) => (
                    ...
                    (0, ce.iD)(
                      ...
                      [
                        ...
                        (0, ce._)("div", Ni, [
                          (0, ce._)("span", { textContent: (0, ue.zw)(e.i18n("labelTheme")) }, null, 8, Ki),
                          (0, ce.wy)(
                            (0, ce._)(
                              "select",
                              {
                              ...
                              (0, ce.iD)("ol", fs, [
                                ...
                                (0, ce.iD)(
                                  ...
                                  (0, ce.Ko)(
                                    ...
                                    (e) => (
                                      (0, ce.wg)(),
                                      (0, ce.iD)("li", { key: e, textContent: (0, ue.zw)(e) }, null, 8, bs)
                                    )
                                  ),
                                  128
                                )),
            ...
            Cs = {
              ...
              setup: (e) => (e, t) => (
                ...
                (0, ce.iD)("section", null, [
                  ...
                  (0, ce.Wm)((0, R.SU)(ws), { name: (0, R.SU)(Nt.hl), desc: e.i18n("descBlacklist") }, null, 8, [
                    "name",
                    "desc",
                  ]),
                  (0, ce.Wm)((0, R.SU)(ws), { name: (0, R.SU)(Nt.g4), desc: e.i18n("descBlacklistNet") }, null, 8, [
                    "name",
                    "desc",
                  ]),
                ])
            ...
            Hs = {
              ...
              activated() {
                ;(0, W.wO)(this.$el),
                  (this.revokers = [be.$J.register("ctrlcmd-s", this.ctrlS, { condition: "inputFocus" })]),
                  b(xe.LI, Us, ([e, { normalize: t = zs }]) => {
                    this.revokers.push(
                      (0, ye.Z)(e, (n) => {
                        $s[e] = t(n, e)
                      })
                  ...
                  return (
                    ...
                    (0, ce.iD)(
                      ...
                      [
                        ...
                        (0, ce._)("section", Xa, [
                          ...
                          (0, ce._)("div", eo, [
                            ...
                            (0, ce.wy)(
                              ...
                              [[we.F8, null == (i = e.$refs.EW) ? void 0 : i.value]]
                            ),
                          ]),
                          (0, ce._)("div", no, [
                            (0, ce._)("label", null, [
                            ...
                            (0, ce.wy)(
                              ...
                              [[we.F8, "exec" === a.settings["filtersPopup.sort"]]]
                            ),
                            (0, ce._)("label", null, [
                              ((0, ce.wg)(!0),
                              (0, ce.iD)(
                            ...
                            (0, ce.wy)(
                              ...
                              [[we.F8, !a.settings["filtersPopup.hideDisabled"]]]
                            ),
                          ]),
                          (0, ce._)("div", null, [
                            (0, ce._)("label", null, [
                        ...
                        (0, ce._)("section", bo, [
                          (0, ce._)("h3", { textContent: (0, ue.zw)(e.i18n("labelBackupMaintenance")) }, null, 8, wo),
                          (0, ce.Wm)(u),
                          (0, ce.Wm)(d),
                          yo,
                          (0, ce.Wm)(p),
                            ...
                            (t, n) => (
                              ...
                              (0, ce.iD)(
                                ...
                                [
                                  (0, ce._)(
                                    "summary",
                                    { onClick: (0, we.iM)((e) => (t[n] = !t[n]), ["prevent"]) },
                                    [
                                      ((0, ce.wg)(),
                                      (0, ce.j4)(
                                        (0, ce.LL)(t[n] ? "h1" : "h3"),
                ...
                return (e, l) => (
                  ...
                  (0, ce.iD)("div", Ws, [
                    (0, ce._)("h1", Is, [
                      ...
                      (0, ce._)("small", { textContent: (0, ue.zw)(`v${(0, R.SU)("2.20.3")}`) }, null, 8, Ts),
                    ]),
                    ...
                    (0, ce._)("div", null, [
                      ...
                      (0, ce._)("span", { class: "current", textContent: (0, ue.zw)((0, R.SU)(n)) }, null, 8, Ls),
                      (0, ce.Uk)(" | "),
                      (0, ce._)(
                        "a",
                        {
            ...
            qs = [
              ...
              { name: k, comp: Ba, label: (0, D.ag)("buttonRecycleBin") },
            ],
            Ns = (0, D.ag)("extName"),
            Ks = "!editScript",
            Bs = (0, ce.Fl)(() => {
          ...
          function Gs() {
            const e = Bs.value.name === o,
              { paths: t } = P.route
            be.$J.setContext("editScript", e && t[1]),
              be.$J.setContext("tabScripts", e && !t[1]),
              be.$J.setContext("showRecycle", Bs.value.name === k)
          }
          function Xs(e) {
            const n = qs.indexOf(Bs.value),
          ...
          const Qs = {
              setup() {
                ...
                return (
                  ...
                  (0, ce.bv)(() => {
                    const e = [
                      be.$J.register("a-pageup", () => Xs(-1), { condition: Ks }),
                      be.$J.register("a-pagedown", () => Xs(1), { condition: Ks }),
                    ]
                    return (
                      be.$J.enable(),
                      Gs(),
                  ...
                  { tabs: qs, current: Bs, numbers: Js, canRenderAside: n }
                )
              },
            },
            er = (0, Lt.Z)(Qs, [
          ...
          function lr(e, t, n) {
            const l = e.$cache || (e.$cache = {}),
              ...
              { custom: o } = e,
              i = (0, D.iQ)(a, G),
              s = b(D.Hv, [a[G], i, a[N], (0, D.iQ)(a, N), o[G], o[N]], "\n"),
              r = o[G] || i
            let c = 0,
              u = ""
            t.forEach((e, t) => {
