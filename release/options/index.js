(() => {
  ...
  onReadyPromise.then(async () => {
    ...
    const vsPath = "/public/lib/monaco-editor/0.49.0/min/vs";
...
})();
{
  ...
  ;(() => {
            ...
            Ul = {
              ...
              setup(e) {
                const t = e,
                  ...
                  x = (e) => {
                    try {
                      return JSON.stringify(JSON.parse(e), null, O)
                    } catch (t) {
                      return e
                    }
                  },
                  C = { condition: "!edit" },
                  _ = (e) => he.$J.setContext("edit", "selectionEnd" in e.target),
                  k = (0, se.Fl)(() => u.keys(h.value || {}).sort()),
                  U = (0, se.Fl)(() => Math.ceil(k.value.length / 25)),
                  z = (0, se.Fl)(() => {
                ...
                function A(e, t) {
                  ...
                  if (
                    ...
                    return (h.value = e), (d.value = Math.min(d.value, U.value) || 1), L(), !0
                }
                function L() {
                  const { script: e } = t,
                    { $cache: n = (e.$cache = {}) } = e,
                    l = k.value.reduce((e, t) => e + t.length + 4 + h.value[t].length + 2, 0)
                  n[ne] = l ? l + 2 : l
                }
                async function F({ key: e, jsonValue: n, rawValue: l = (0, D.bd)(n) || "" }, a) {
                  a && N(e)
                ...
                function B(e) {
                  var t
                  F({ key: e }), N(e), (null == (t = r.value) ? void 0 : t.key) === e && (r.value = null)
                }
                function K(e) {
                  const t = f.value,
                    n = t[e]
                  delete t[e], (0, D.xb)(t) && (f.value = null), F(n)
                }
                function J(e) {
                  r.value = { key: e, value: P(e), ...b }
                }
                function G() {
                  r.value = { isAll: !0, value: Y(), ...b }
                }
                async function X(e) {
                  const n = r.value
                  if ((n.jsonPaused && ((n.jsonPaused = !1), ee()), n.error)) {
                    const e = n.errorPos
                    return (
                ...
                function Q() {
                  ...
                  if (e.dirty) {
                    const t = `${e.key} ${(1e9 * Math.random()) | 0}`,
                      n = $.getValue(),
                      l = (0, D.bd)(n)
                    ;(f.value || (f.value = {}))[t] = { key: t, rawValue: l, cut: y(n), len: V(t, l) }
                  }
                  r.value = null
                }
                function ee(e) {
                ...
                function te(e) {
                  ...
                  if (t) {
                    const e = r.value,
                      ...
                      l = e && (e.isAll ? Y : P)
                    if ((A(t instanceof u ? t : (0, be.p$)(t)), e)) {
                      const t = l(n)
                      $.getValue() === t ? ((e.isNew = !1), (e.dirty = !1)) : e.dirty || ((e.value = t), ee())
                    }
                  } else A(t)
                }
                function le(e) {
                ...
                return (
                  (0, se.dl)(() => {
                    ...
                    const l = n.value,
                      ...
                      o = (0, D.K0)()
                    w(p, l, "focusin", _),
                      null == (e = r.value ? $ : I) || e.focus(),
                      (0, D.gj)("GetValueStore", a, void 0, (T = { tab: { id: Math.random() - 2 }, [S]: 0 })).then(
                        (e) => {
                          const t = !h.value
                          A(e) && t && k.value.length && E(!0), (c.value = !1)
                        }
                      ),
                      (j = [
                        () => w(m, l, "focusin", _),
                        he.$J.register("pageup", () => Z(-1), C),
                        he.$J.register("pagedown", () => Z(1), C),
                        (0, we.Z)("valueEditor", (e) => {
                          if (((H = e), (O = " ".repeat((null == e ? void 0 : e.tabSize) || 2)), $ && e))
                      ...
                      (M = g.runtime.connect({
                        name:
                          Ft.vy +
                          JSON.stringify({ cfg: { value: a }, id: null == o ? void 0 : o[Ft.vy](te), tabId: T.tab.id }),
                      })),
                      o || M.onMessage.addListener(te),
                      (s.value = !0)
                  }),
                  (0, se.se)(() => {
                    var e, t
                      ...
                      [
                        (0, se._)("div", Zn, [
                          (0, se._)("div", Vn, [
                            e.readOnly
                              ? (0, se.kq)("", !0)
                              : ((0, se.wg)(), (0, se.iD)("button", { key: 0, onClick: q }, "+")),
                            U.value > 1
                              ? ((0, se.wg)(),
                                (0, se.iD)("div", Pn, [
                                  (0, se._)(
                                  ...
                                  (0, se.Uk)(" / "),
                                  (0, se._)("span", { class: "mr-1", textContent: (0, re.zw)(U.value) }, null, 8, Ln),
                                  (0, se._)(
                                    "button",
                          ...
                          (0, se._)(
                            "div",
                            {
                              ...
                              style: (0, re.j5)({ "--keyW": z.value.width + "ch" }),
                              onKeydown: [
                                (0, fe.D2)((0, fe.iM)(le, ["exact"]), ["down"]),
                                (0, fe.D2)((0, fe.iM)(le, ["exact"]), ["up"]),
                              ],
                            },
                            [
                              (0, se._)(
                                  ...
                                  (e) => (
                                    ...
                                    (0, se.iD)(
                                      ...
                                      [
                                        ...
                                        (0, se._)(
                                          "div",
                                          { class: "ellipsis flex-auto", textContent: (0, re.zw)(P(e, !0)) },
                                          null,
                                          8,
                                          il
                                        ),
                                        (0, se._)("pre", { textContent: (0, re.zw)(V(e)) }, null, 8, sl),
                                        (0, se._)(
                                          "div",
                                          { class: "del", onClick: (0, fe.iM)((t) => B(e), ["stop"]) },
                          ...
                          f.value
                            ? ((0, se.wg)(),
                              (0, se.iD)(
                                "h3",
                                { key: 0, textContent: (0, re.zw)(t.i18n("headerRecycleBin")) },
                                null,
                                8,
                                cl
                              ))
                                  ...
                                  (0, se.iD)(
                                    ...
                                    (0, se.Ko)(
                                      ...
                                      ({ key: e, cut: t, len: n }, l) => (
                                        ...
                                        (0, se.iD)(
                                          "div",
                                          { key: l, class: "edit-values-row flex", onClick: (e) => K(l) },
                                          [
                                            (0, se._)(
                                              "a",
                                            ...
                                            (0, se._)("pre", { textContent: (0, re.zw)(n) }, null, 8, gl),
                                          ],
                                          8,
                                          dl
                                        )
                            ...
                            (0, se.iD)("div", hl, [
                              (0, se._)("div", fl, [
                                ...
                                (0, se._)("div", bl, [
                                  ...
                                  (0, se._)(
                                    "button",
                                    { textContent: (0, re.zw)(t.i18n("buttonCancel")), onClick: Q, title: "Esc" },
                                    null,
                                    8,
                                    xl
                                  ),
                                    ...
                                    (0, se.wy)(
                                      (0, se._)(
                                        "input",
                                        {
                                          ...
                                          ref: a,
                                          spellcheck: "false",
                                          onKeydown: (0, fe.D2)((0, fe.iM)(Q, ["exact", "stop"]), ["esc"]),
                                        },
                                        null,
                                        40,
                                        kl
                                      ...
                                      [
                                        (0, se._)("div", ha, [
                                          ...
                                          (0, se.Wm)(
                                            (0, R.SU)(xe.Z),
                                            {
                                              content: (0, R.SU)(D.ag)("buttonUpdateAll"),
                                              placement: "bottom",
                                              align: "start",
                                            },
                                            {
                ...
                return (e, l) => (
                  ...
                  (0, se.iD)("div", Rs, [
                    (0, se._)("h1", Ts, [
                      ...
                      (0, se._)("small", { textContent: (0, re.zw)(`v${(0, R.SU)("2.19.1")}`) }, null, 8, Os),
                    ]),
    ...
    var j = H.O(void 0, [386, 84], () => H(2401))
    j = H.O(j)
  })()
}
