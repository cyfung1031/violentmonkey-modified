    ...
    var f,
      ...
      D = {
        ...
        1835: (f, U, z) => {
          ...
          let Ie, Ee, Re, Ve, Ye, Pe, Fe, Le, Ae, qe, Ne, Ke, Be, Je, Ge, Xe, Qe, et
          function tt(e, t, n) {
            const l = n ? p : m
            ;(Ne = e),
              (Ke = t),
          ...
          function ot(e) {
            wt(e) && ((Pe = e), (Fe = setTimeout(it, Ze, "timer")), p(Oe.move, it), p(Oe.end, st))
          }
          function it(e) {
            st(), "timer" === e && (w(rt, qe, Pe), b && pt() && ((Ne.scrollTop += 1), (Ne.scrollTop -= 1)))
          }
          function st() {
          ...
          const bt = ["tabIndex"],
            ...
            Yt = { class: "script-buttons script-buttons-right" },
                ...
                return (
                  (0, de.dl)(() => {
                    ...
                    w(p, l, "focusin", k),
                      ...
                      (Z = [
                        () => w(m, l, "focusin", k),
                        ye.$J.register("pageup", () => V(-1), _),
                        ye.$J.register("pagedown", () => V(1), _),
                                  ...
                                  (t) => (
                                    ...
                                    (0, de.iD)(
                                      ...
                                      [
                                        ...
                                        (0, de._)(
                                          "div",
                                          { class: "ellipsis flex-auto", textContent: (0, pe.zw)(P(t, !0)) },
                                          null,
                                          8,
                                          al
                                        ),
                                        (0, de._)("pre", { textContent: (0, pe.zw)(Y(t)) }, null, 8, ol),
                                        e.readOnly
                                          ? (0, de.kq)("", !0)
                                          : ((0, de.wg)(),
                                            (0, de.iD)(
            ...
            ca = {
              ...
              setup(t, { emit: n }) {
                ...
                const d = n,
                  ...
                  E = (0, de.Fl)(() => (P.title = (0, D.pV)(C.value)))
                ;(0, de.YP)(
                  h,
                  async (e) => {
                  ...
                  (0, de.YP)(
                    () => m.initial.error,
                    (e) => {
                      e && (0, W.PV)({ text: `${m.initial.message}\n\n${e}` })
                    }
                  ),
                  (0, de.YP)(k, N),
                  (0, de.YP)(C, (e) => {
            ...
            Na = {
              ...
              setup(e) {
                ...
                const a = `${Aa} && inputFocus`,
                  ...
                  h = { [Ra]: "e", [Pa]: "space", [La]: "r", [Ya]: "r", [Va]: "x" },
                ...
                const U = (0, O.iH)(),
                  ...
                  T = (0, O.qj)({
                    ...
                    menuNew: !1,
                    showHotkeys: !1,
                    search: (P.search = { value: "", error: null, ...R("") }),
                    sortedScripts: [],
                    filteredScripts: [],
                    script: null,
                    code: "",
                  ...
                  I = (0, de.Fl)(() => P.route.paths[0] === k),
                  E = (0, de.Fl)(() => !I.value && "exec" === l.sort),
                  V = (0, de.Fl)(() => W.T && E.value),
                  F = (0, de.Fl)(() => {
                    var e
                  ...
                  K = () => (I.value ? P.removedScripts : P.scripts),
                  ...
                  J = {
                    ...
                    [Va]: {
                      icon: "trash",
                      async fn(e, t, n) {
                        await d.all(e.map((e) => re(e, !n))), n || (P.scripts = [])
                      },
                    },
                  },
                  G = (0, de.Fl)(() => {
                  ...
                  X = (0, D.Ds)(() => {
                    try {
                      ;(T.search = P.search = { ...T.search, ...R(T.search.value) }), (T.search.error = null)
                    } catch (e) {
                ...
                async function me() {
                  ...
                  if (
                    (t && (0, M.pV)(e, !0),
                    P.canRenderScripts || ((P.canRenderScripts = !0), or()),
                    ge(),
                    (T.script = null),
                    !b)
                  ) {
                ...
                ee(),
                  (0, de.YP)(I, ee),
                  (0, de.YP)(
                    () => P.canRenderScripts && $.value && E.value,
                    (e) => tt($.value, ie, e)
                  ),
                              ...
                              I.value
                                ? ((0, de.wg)(),
                                  (0, de.iD)("div", Oa, [
                                    ...
                                    (0, O.SU)(P).removedScripts.length
                                      ? ((0, de.wg)(),
                                        (0, de.iD)(
                                          "a",
                                          {
              ...
              setup(e) {
                ...
                function i() {
                  const e = ["lastModified", "lastUpdate", "sync"],
                    t = w(_e.Xw, Vo.ZP, null, (t, n) => !e.includes(t) && !(0, _e.vZ)(n, j.Z.get(t)) && t)
                  return (
                    ...
                    (0, de.Wm)(
                      ...
                      { content: (0, O.SU)(D.ag)("hintVacuum") },
                      {
                        default: (0, de.w5)(() => [
                          (0, de._)(
                            "button",
                            { onClick: s, disabled: (0, O.SU)(P).batch, textContent: (0, pe.zw)(t.value) },
                            null,
                            8,
                            vi
                          ),
          ...
          const Ni = ["textContent"],
            ...
            Ss = c.keys(ks),
            Us = { enum: ks, normalize: (e, t) => (/^#[0-9a-f]{6}$/i.test(e) ? e : Vo.ZP[t]) },
            zs = {
            ...
            js = {
              ...
              computed: {
                ...
                isCustomBadgeColor: () => Ss.some((e) => Hs[e] !== Vo.ZP[e]),
              },
              methods: {
                ctrlS() {
                ...
                return (e, l) => (
                  ...
                  (0, de.iD)("div", Zs, [
                    (0, de._)("h1", Os, [
                      ...
                      (0, de._)("small", { textContent: (0, pe.zw)(`v${(0, O.SU)("2.20.5")}`) }, null, 8, Ts),
                    ]),
            ...
            Gs = (0, de.Fl)(() => ({ [o]: P.scripts.length, [k]: P.removedScripts.length }))
          function Xs() {
          ...
          ;(P.loading = !0),
            ...
            c.assign($.Z, {
              ...
              async UpdateScript({ update: e, where: t, code: n } = {}) {
                var l
                if (!e) return
                ;(lr || ((lr = P.batch) && (lr = d.race([lr, (0, D.dL)(500)])))) && (await lr, (lr = null))
