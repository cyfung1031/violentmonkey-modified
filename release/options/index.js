    ...
    var h,
      ...
      D = {
        ...
        8506: (h, U, z) => {
          ...
          let Te, Me, Oe, Ze, Ee, Ve, Pe, Ye, Ae, Le, Fe, qe, Ne, Be, Ke, Je, Ge, Xe
          function Qe(e, t, n) {
            const l = n ? p : m
            ;(Fe = e),
              (qe = t),
          ...
          function lt(e) {
            ht(e) && ((Ve = e), (Pe = setTimeout(at, je, "timer")), p(We.move, at), p(We.end, ot))
          }
          function at(e) {
            ot(), "timer" === e && (w(it, Le, Ve), b && ut() && ((Fe.scrollTop += 1), (Fe.scrollTop -= 1)))
          }
          function ot() {
            clearTimeout(Pe), m(We.move, at), m(We.end, ot)
          }
          function it(e) {
            var t
            if (!ht(e)) return
          ...
          function st(e) {
            ...
            ;(Te.style.transform = `translate(${n - Ye}px, ${l - Ae}px)`), (dt(l) || o) && (Xe = {})
          }
          function rt() {
            m(We.move, st),
              m(We.end, rt),
          ...
          const Yn = ["data-editing"],
            ...
            _l = {
              ...
              setup(e) {
                const t = e,
                  ...
                  C = (e) => {
                    try {
                      return JSON.stringify(JSON.parse(e), null, Z)
                    } catch (t) {
                      return e
                    }
                  },
                  ...
                  (0, ce.dl)(() => {
                    ...
                    w(p, l, "focusin", k),
                      ...
                      (0, D.gj)("GetValueStore", a, void 0, (M = { tab: { id: Math.random() - 2 }, [S]: 0 })).then(
                        (e) => {
                          const t = !h.value
                          L(e) && t && U.value.length && E(!0), (c.value = !1)
                        }
                      ),
                      (I = [
                        () => w(m, l, "focusin", k),
                        ...
                        (0, ye.Z)("valueEditor", (e) => {
                          if (((j = e), (Z = " ".repeat((null == e ? void 0 : e.tabSize) || 2)), H && e))
                                  ...
                                  (t) => (
                                    ...
                                    (0, ce.iD)(
                                      ...
                                      [
                                        ...
                                        (0, ce._)(
                                          "div",
                                          { class: "ellipsis flex-auto", textContent: (0, ue.zw)(Y(t, !0)) },
                                          null,
                                          8,
                                          ll
                                        ),
                                        (0, ce._)("pre", { textContent: (0, ue.zw)(P(t)) }, null, 8, al),
                                        e.readOnly
                                          ? (0, ce.kq)("", !0)
                                          : ((0, ce.wg)(),
                                            (0, ce.iD)(
            ...
            Ml = ["textContent"],
            Ol = ["textContent"],
            Zl = { key: 1, class: "edit-hint text-right ellipsis" },
            El = ["href", "textContent"],
            Vl = { class: "mr-1" },
            Pl = ["textContent", "disabled", "title"],
            Yl = ["textContent", "disabled"],
            Al = ["textContent"],
            ...
            ca = {
              ...
              setup(t, { emit: n }) {
                ...
                const m = (0, R.iH)(),
                  ...
                  O = (0, ce.Fl)(() => (Y.title = (0, D.pV)(x.value)))
                ;(0, ce.YP)(
                  h,
                  async (e) => {
                  ...
                  (0, ce.dl)(() => {
                    document.body.classList.add("edit-open"),
                      (i = [
                        ...
                        we.$J.register(ae.replace(/(?:Ctrl|Cmd)-/i, "ctrlcmd-"), Z),
                        we.$J.register("escape", E),
                        we.$J.register("f1", () => {
                          h.value = "help"
                        }),
                      ]),
            ...
            Ma = ["textContent"],
            Oa = ["textContent"],
            Za = ["data-columns", "data-show-order", "data-table"],
            Ea = "edit",
            Va = "remove",
            Pa = "restore",
            Ya = "toggle",
            ...
            Ba = {
              ...
              setup(e) {
                ...
                const a = `${Fa} && inputFocus`,
                  ...
                  f = { [Ea]: "e", [Ya]: "space", [La]: "r", [Pa]: "r", [Va]: "x" },
                ...
                const U = (0, R.iH)(),
                  ...
                  H = (0, R.qj)({
                    ...
                    menuNew: !1,
                    showHotkeys: !1,
                    search: (Y.search = { value: "", error: null, ...E("") }),
                    sortedScripts: [],
                    filteredScripts: [],
                    script: null,
                    code: "",
                  ...
                  M = (0, ce.Fl)(() => Y.route.paths[0] === k),
                  O = (0, ce.Fl)(() => !M.value && "exec" === l.sort),
                  Z = (0, ce.Fl)(() => W.T && O.value),
                  V = (0, ce.Fl)(() => {
                    var e
                  ...
                  K = {
                    ...
                    [Va]: {
                      icon: "trash",
                      async fn(e, t, n) {
                        await d.all(e.map((e) => ie(e, !n))), n || (Y.scripts = [])
                      },
                    },
                  },
                  J = (0, ce.Fl)(() => {
                  ...
                  G = (0, D.Ds)(() => {
                    try {
                      ;(H.search = Y.search = { ...H.search, ...E(H.search.value) }), (H.search.error = null)
                    } catch (e) {
                ...
                async function re() {
                  ...
                  if (
                    (t && (0, T.pV)(e, !0),
                    Y.canRenderScripts || ((Y.canRenderScripts = !0), lr()),
                    de(),
                    (H.script = null),
                    !b)
                  ) {
              ...
              setup(e) {
                ...
                function i() {
                  const e = ["lastModified", "lastUpdate", "sync"],
                    t = w(xe.Xw, Po.ZP, null, (t, n) => !e.includes(t) && !(0, xe.vZ)(n, j.Z.get(t)) && t)
                  return (
                    ...
                    (0, ce.Wm)(
                      ...
                      { content: (0, R.SU)(D.ag)("hintVacuum") },
                      {
                        default: (0, ce.w5)(() => [
                          (0, ce._)(
                            "button",
                            { onClick: s, disabled: (0, R.SU)(Y).batch, textContent: (0, ue.zw)(t.value) },
                            null,
                            8,
                            hi
                          ),
          ...
          const Li = {
            ...
            vs = ["textContent"],
            hs = ["textContent"],
            fs = { class: "flex flex-wrap" },
            ws = { key: 0, class: "text-red" },
            bs = ["textContent"],
            ys = {
              components: { SettingText: Pn.Z },
              data: () => ({ errors: null }),
              async mounted() {
                this.errors = await (0, D.gj)("Storage", ["base", "getOne", Nt.BZ])
              },
            },
            xs = (0, At.Z)(ys, [
              [
                "render",
                (e, t, n, l, a, o) => {
                  const i = (0, ce.up)("setting-text")
                  return (
                    (0, ce.wg)(),
                    (0, ce.iD)("section", null, [
                      (0, ce._)("h3", { textContent: (0, ue.zw)(e.i18n("labelBlacklist")) }, null, 8, vs),
                      (0, ce._)("p", null, [
                        (0, ce.Uk)((0, ue.zw)(e.i18n("descBlacklist")) + " ", 1),
                        (0, ce._)(
                          "a",
                          {
                            ...
                            (0, ce.iD)("ol", ws, [
                              ...
                              (0, ce.iD)(
                                ...
                                (0, ce.Ko)(
                                  a.errors,
                                  (e) => (
                                    (0, ce.wg)(), (0, ce.iD)("li", { key: e, textContent: (0, ue.zw)(e) }, null, 8, bs)
                                  )
                                ),
                                128
                              )),
            ...
            Cs = { badgeColor: (0, D.ag)("titleBadgeColor"), badgeColorBlocked: (0, D.ag)("titleBadgeColorBlocked") },
            _s = u.keys(Cs),
            ks = { enum: Cs, normalize: (e, t) => (/^#[0-9a-f]{6}$/i.test(e) ? e : Po.ZP[t]) },
            Ss = {
            ...
            Us = (e, t) => (f(Ss[t].enum, e) ? e : u.keys(Ss[t].enum)[0]),
            zs = (e, t) =>
              (0, D.Ds)((n, l) => {
            ...
            $s = {
              ...
              activated() {
                ;(0, W.wO)(this.$el),
                  ...
                  w(xe.LI, Ss, ([e, { normalize: t = Us }]) => {
                    this.revokers.push(
                      (0, ye.Z)(e, (n) => {
                        Ds[e] = t(n, e)
                      })
                    ),
                      this.$watch(() => Ds[e], zs(e, t))
                  }),
                            ...
                            (t, n) => (
                              ...
                              (0, ce.iD)(
                                ...
                                [
                                  ...
                                  (0, ce.Wm)(f),
                                  (0, ce._)("section", null, [
                                    (0, ce._)("h3", { textContent: (0, ue.zw)(e.i18n("labelCustomCSS")) }, null, 8, Eo),
            ...
            Ls = {
              ...
              setup(e) {
                ...
                return (e, l) => (
                  ...
                  (0, ce.iD)("div", js, [
                    (0, ce._)("h1", Ws, [
                      (0, ce._)("span", { textContent: (0, ue.zw)((0, R.SU)(t)) }, null, 8, Is),
                      (0, ce._)("small", { textContent: (0, ue.zw)(`v${(0, R.SU)("2.20.0")}`) }, null, 8, Rs),
                    ]),
                    (0, ce._)("p", { textContent: (0, ue.zw)(e.i18n("extDescription")) }, null, 8, Ts),
                    (0, ce._)("div", null, [
                      (0, ce._)("label", { textContent: (0, ue.zw)(e.i18n("labelRelated")) }, null, 8, Ms),
                      (0, ce._)("ul", null, [
                        (0, ce._)("li", null, [
                          (0, ce._)(
                            "a",
                    ...
                    (0, ce._)("div", null, [
                      ...
                      (0, ce._)("span", { class: "current", textContent: (0, ue.zw)((0, R.SU)(n)) }, null, 8, Ys),
                      (0, ce.Uk)(" | "),
                      (0, ce._)(
                        "a",
                        {
            ...
            Fs = [
              ...
              { name: C, comp: Hs, label: (0, D.ag)("sideMenuSettings") },
              { name: _, comp: Ls, label: (0, D.ag)("sideMenuAbout") },
            ...
            Bs = (0, ce.Fl)(() => {
              ...
              return Fs.find((t) => t.name === e) || Fs[0]
            }),
            Ks = (0, ce.Fl)(() => ({ [o]: Y.scripts.length, [k]: Y.removedScripts.length }))
          function Js() {
            const e = Bs.value.name === o,
              { paths: t } = Y.route
            we.$J.setContext("editScript", e && t[1]),
              we.$J.setContext("tabScripts", e && !t[1]),
              we.$J.setContext("showRecycle", Bs.value.name === k)
          }
          function Gs(e) {
            const n = Fs.indexOf(Bs.value),
              l = Fs[(n + e + Fs.length) % Fs.length]
          ...
          const Xs = {
              setup() {
                ...
                return (
                  ...
                  (0, ce.bv)(() => {
                    const e = [
                      we.$J.register("a-pageup", () => Gs(-1), { condition: Ns }),
                      we.$J.register("a-pagedown", () => Gs(1), { condition: Ns }),
                    ]
                    return (
                      we.$J.enable(),
                      Js(),
                  ...
                  { tabs: Fs, current: Bs, numbers: Ks, canRenderAside: n }
                )
              },
            },
            Qs = (0, At.Z)(Xs, [
          ...
          async function ar(e) {
            ...
            const i = [],
              s = []
            n.forEach((e, t) => {
              nr(e, l[t]), (e.config.removed ? s : i).push(e)
            }),
              (Y.scripts = i),
              (Y.removedScripts = s),
              (Y.loading = !1)
          ...
          ;(Y.loading = !0),
            ...
            u.assign($.Z, {
              ...
              async UpdateScript({ update: e, where: t, code: n } = {}) {
                var l
                if (!e) return
                ;(tr || ((tr = Y.batch) && (tr = d.race([tr, (0, D.dL)(500)])))) && (await tr, (tr = null))
