{
  ...
  ;(() => {
    ...
    const { userAgent: Pn, userAgentData: Nn } = navigator,
      ...
      Wn = "fullVersionList",
      Fn = {},
      Bn = P ? void 0 : parseFloat(Hn) || 1
    let Vn = P ? parseFloat(Hn) || 1 : void 0
    function Gn(e) {
      ;(e.vivExtData || e.extData) && Kn("Vivaldi")
    }
    function Kn(e) {
      Fn.browserName = e
    }
    Fa({ UA: () => Fn }),
      Va.deps.push(
        M.all([
          ...
          null == Nn ? void 0 : Nn.getHighEntropyValues([Wn]),
          P ? [] : fa.getAll(),
        ]).then(([{ os: e, arch: a }, { name: t, version: n } = {}, { [Wn]: o, mobile: i } = {}, [s]]) => {
          !n &&
            null != o &&
            o[0] &&
            ([t, n] = o
            ...
            (Fn.os = e),
            Kn(t || "chrome"),
            (Fn.browserVersion = n || Hn),
            (Fn[Wn] = o),
            (Fn.mobile = i),
            Vn ? (Vn = parseFloat(n)) : s ? Gn(s) : E(ne, fa.onCreated, Gn)
        })
      )
    const Jn = ((e, a, t, n, o) => {
      const i = {},
    ...
    Fa({
      async Request({ url: e, ...a }) {
        const t = Yn(e),
          n = ua(t) && !ra.test(t) ? Jn : ma,
          o = await n(t, a)
        return "blob" === a[b] && (o.data = await Oa(o)), o
      },
    })
    const Xn = {},
      Zn = !P || !(!a.AbortSignal || !fa),
      Qn = B + N + "/",
      eo = /^(about:(home|newtab)|(chrome|edge):\/\/(newtab\/|startpageshared\/|vivaldi-webui\/startpage))$/,
      ao = (e, a, t) => (2 === e && a) || t,
      to = (e) => (2 === e[v] && e[J]) || e[Y],
      no = (e) => (+e >= 0 ? { [Y]: +e } : { [J]: e }),
      oo = (e) => e.pendingUrl || e.url || "",
      io = browser.tabs.onUpdated,
      so = browser.tabs.onRemoved
    let ro,
      lo,
      co = /^(https?|file|ftps?):/
    try {
      io.addListener(Be, { properties: ["status"] }), io.removeListener(Be)
    } catch (e) {
      io.addListener = new Proxy(io.addListener, { apply: (e, a, t) => E(e, a, t[0]) })
    }
    async function uo(e) {
    ...
    async function ho(e) {
      ...
      if (co.test(a) && Dn(a, e)) return browser.tabs.reload(t)
    }
    Fa({
      GetTabDomain(e) {
      ...
      async OpenEditor(e, a) {
        var t
        return mo(`${h}/${e || `_new/${(null == a || null == (t = a.tab) ? void 0 : t.id) || (await Ra()).id}`}`, a)
      },
      OpenDashboard: mo,
    }),
      Wa({
        async TabOpen({ url: e, active: a = !0, container: t, insert: n = !0, pinned: o }, i = {}) {
          ...
          if (
            (p &&
              !u &&
              (lo || (lo = (await browser.cookies.getAllCookieStores())[0].id.split("-")[0]),
              c || 0 === t ? (p = lo + "-default") : t > 0 && (p = `${lo}-container-${t}`)),
            p && (p = { cookieStoreId: p }),
            /^[-\w]+:/.test(e) || (e = c ? browser.runtime.getURL(e) : Yn(e, l)),
            c && e.startsWith(Qn) && fa && qt("editorWindow") && (!p || Vn >= 64))
          ) {
            const t = {
                url: e,
                incognito: m && u,
          ...
          } else c && m && eo.test(oo(r)) && (g = await browser.tabs.update(r.id, { url: e, ...h }).catch(Be))
          for (let a = 0; !g && a < 2; a++)
            try {
      ...
      so.addListener((e) => {
        const a = Xn[e]
        a >= 0 && (za(a, "TabClosed", e), delete Xn[e])
      }),
      (async () => {
        const e = P || (await new M((e) => D.extension.isAllowedFileSchemeAccess(e)))
        ;(ro = Vn < 68 || (!P && e)),
          (P && [].at) || Bn >= 88 ? (co = e ? /^(https?|file):/ : /^https?:/) : e || (co = /^(ht|f)tps?:/)
      })(),
      Fa({
        async NewScript(e) {
          const a = ((e >= 0 && (await browser.tabs.get(e).catch(Be))) || {}).url,
            t = co.test(a) && `${a.split(/[#?]/)[0]}*`,
            { host: n = "example.org", domain: o } = t ? Ha.GetTabDomain(t) : {}
          return $o({ url: t || `*://${n}/*`, name: o || "" })
        },
      })
    const go = (e) => !/^\s*</.test(e) && ce.exec(e),
      po = { default: () => [], transform: (e, a) => (e.push(a), e) },
      fo = { default: () => !1, transform: () => !0 },
      ko = { default: () => null, transform: (e, a) => (null == e ? a : e) },
      bo = {
        include: po,
        exclude: po,
        match: po,
      ...
      yo = { antifeature: po, compatible: po, connect: po, noframes: fo, [xe]: fo, [ze]: fo },
      vo = /(?:^|\n)(.*?)\/\/([\x20\t]*)(@\S+)(.*)/g,
      wo = 'Unexpected text before "//" in ',
      xo = 'Expected a single space after "//" in '
    function zo(e, a, t) {
      const n = E(De, bo, (e) => e.default()),
        o = go(e)
      if (!o) return !1
      let i
      for (t && jo(o, 1, t); (i = vo.exec(o[4])); ) {
        const [e, a] = i[3].slice(1).split(":"),
          ...
          l = bo[s] || yo[s] || ko
        let c = n[s]
        void 0 === c && (c = l.default()), t && jo(i, 0, t), (n[s] = l.transform(c, r))
      }
      return t && jo(o, 5, t), (n.resources = n.resource), delete n.resource, a && (n[ve] = o[0]), n
    }
    function jo(e, a, t) {
      let n
      e[a + 1].match(/\S/) && t.push(wo + (n = So(e[a], 50))), " " !== e[a + 2] && t.push(xo + (n || So(e[a], 50)))
    }
    function So(e, a) {
    ...
    function Co(e) {
      if (!e || L(e, se)) return
      let a, t
      !(a = qa(e)) && (a = Io(e)) && ((t || (t = {}))[re] = a),
        !Ia(e) && (a = Mo(e, a)) && ((t || (t = {}))[le] = a),
        (e[se] = t)
    }
    const Uo = {}
    let Do,
    ...
    function To(e, a) {
      null == e && (_o = {}),
        E(_e, Uo, ([t, n]) => {
          const o = n[e]
          o && (a ? (delete o[a], ta(o) && delete n[e]) : delete n[e]), (null == e || ta(n)) && delete Uo[t]
        })
    }
    async function Ro(e, a, t) {
      const n = +e[0] && (await mt[lt].getMulti(e))
      for (let o = 0; o < e.length; o++) {
        const i = e[o],
          s = n ? i : i.id,
          r = n ? n[s] || null : i[g]
        r ? Ce(Uo, [s, a, t], I.assign({}, r)) : delete Uo[s]
      }
    }
    function Ao(e, a) {
    ...
    function Lo(e, a) {
      var t
      ;(a || mt[lt]).set(e, !!a), (Do = (null == (t = Do) ? void 0 : t.catch(console.warn).then(Eo)) || Eo())
    }
    async function Eo() {
      const e = {}
      let a = 0
      ...
      for (let t = 0, n = I.entries(e); t < n.length; t++) {
        ...
        for (let t = 0, n = I.entries(o); t < n.length; t++) {
          const [o, i] = n[t]
          ta(i) || (za(+e, "UpdatedValues", i, no(o)), ++a % 20 || (await Aa()))
        }
      }
      Do = null
    }
    ...
    Fa({
      ...
      SetValueStores(e) {
        ...
        E(_e, e, ([e, t = {}]) => {
          var n
          ;(e = null == (n = zi({ id: +e, uri: e })) ? void 0 : n.props.id) && ((a[ct + e] = t), (_o[e] = t))
        }),
          Lo(a, Zo)
      },
    }),
            ...
            !(e =
              null == (a = e)
                ...
                : a.filter((e) => {
                    const a = Bo.get(e),
                      n = void 0 !== a
                    return n && (t[e] = Ae(a)), !n && 0 !== Vo.get(e)
                  })) || e.length)
          ) {
            var n
            let a
            e || (a = 5e3),
              E(_e, await Go.get(e), ([e, n]) => {
                ;(t[e] = n), Vo.put(e, 1), Bo.put(e, Ae(n), a), bi(e, n)
              }),
              null == (n = e) || n.forEach((e) => Vo.put(e, +L(t, e)))
          }
          return ei(!1), t
        },
        async set(e, a) {
          ...
          ei(!0),
            E(_e, e, ([e, o]) => {
              const i = Ee(o, Bo.get(e))
              if (void 0 !== i) {
                if ((Bo.put(e, i), Vo.put(e, 1), n.push(e), Po)) return void (t[e] = o)
                !a && e.startsWith(ct)
                  ? (No[e] = i)
                  : ((t[e] = o), bi(e, o) && o[se] && delete (t[e] = { ...o })[se], ai(e, o))
              }
            }),
            ei(!1),
            ta(t) || (await Go.set(t)),
            Po || (n.length && Jo(n, e), ni())
        },
        async remove(e) {
          const a = e.filter((e) => {
            let a = 0 !== Vo.get(e)
            if (a) {
              if ((Bo.del(e), Vo.put(e, 0), Po)) return a
              mt[lt].toId(e) ? ((No[e] = null), (a = !1)) : (bi(e), ai(e))
            }
            return a
          })
          a.length && (await Go.remove(a)), Po || (e.length && Jo(e), ni())
        },
      })
    function Qo(e, a, t = !0) {
      t && !Ho && (Ho = {}),
        E(_e, a, ([a, n]) => {
          ...
          for (let a = 0, i = na(n); a < i.length; a++) {
            const n = o + i[a],
              s = Ho[n] || (t && (Ho[n] = [])),
              r = s ? s.indexOf(e) : -1
            r >= 0 && !t ? (s.splice(r, 1), s.length || delete Ho[n]) : r < 0 && t && s.push(e)
          }
        }),
        ta(Ho) && (Ho = null)
    }
    function ei(e) {
      Bo.batch(e), Vo.batch(e)
    }
    async function ai(e, a) {
      const t = hi.exec(e)
      t && t[0] !== rt && 2 === (li[e] = Ne(a)) && t[0] === ct && (li[e] = 0)
    }
    async function ti() {
      const e = I.keys(No),
        a = [],
      ...
      ;(No = {}),
        ...
        e.forEach((e) => {
          const n = t[e]
          n || (delete t[e], a.push(e)), ai(e, n)
        }),
        ta(t) || (await Go.set(t)),
        a.length && (await Go.remove(a)),
        Ho && setTimeout(oi, 0, t, a)
    }
    function ni() {
      Wo || ta(No) || (Wo = setTimeout(ti, Math.min(1e3, 100 * Math.max(1, Ne(No) / 1e6))))
    }
    function oi(e, a) {
      const t = new Map()
      let n, o
      for (const i in Ho)
        if ((n = e[i]) || a.includes(i))
          for (let e = 0, a = Ho[i]; e < a.length; e++) {
            const s = a[e]
    ...
    ;(a[me] = (e) => {
      ...
      browser.runtime.onConnect.addListener((e) => {
        if ("undoImport" === e.name) return ii(e)
        if (!e.name.startsWith(me)) return
        const { id: a, cfg: t, tabId: n } = JSON.parse(e.name.slice(12)),
          o = a ? Fo[a] : e.postMessage.bind(e)
        Qo(o, t),
          e.onDisconnect.addListener(() => {
            To(n), Qo(o, t, !1), delete Fo[a]
          })
      })
    let si = 0,
      ri = 0,
      ...
      if (t) {
        if (a) {
          const e = ci[t],
            n = ui.indexOf(e),
            o = di.indexOf(e)
          n >= 0 && (ui[n] = a), o >= 0 && (di[o] = a), (ci[t] = a)
        } else delete ci[t]
        return !0
      }
    }
    async function yi() {
      const e = ui.reduce((e, a, t) => {
        const { props: n } = a,
          o = t + 1
        return n.position !== o && ((n.position = o), ((e || (e = {}))[n.id] = a)), e
      }, null)
      return (ri = ui.length), e && (await mt[st].set(e), It("lastModified", Date.now())), !!e
    }
    async function vi() {
      ui.sort((e, a) => fi(e.props.position) - fi(a.props.position))
      const e = await yi()
    ...
    function xi(e) {
      var a
      return null != (a = null == e ? void 0 : e.map(wi)) ? a : [...ui, ...di]
    }
    function zi({ id: e, uri: a, meta: t, removed: n }) {
      let o
      return (
        e
          ? (o = wi(e))
          : (a || (a = qo({ meta: t, props: { id: "@@should-have-name" } })),
            (o = (n ? di : ui).find(({ props: e }) => a === e.uri))),
        o
      )
    }
    function ji() {
    ...
    Wa({
      ...
      Fa({
        ...
        RemoveScripts: Wi,
        GetData: Ei,
        GetMoreIds: ({ url: e, [v]: a, [r]: t }) => Ti(e, a, null, t),
        GetScript: zi,
        GetSizes: Pi,
        ...
        async MarkRemoved({ id: e, removed: a }) {
          if (!a && zi({ meta: wi(e).meta })) throw We("msgNamespaceConflictRestore")
          await Vi(e, { config: { removed: a ? 1 : 0 }, props: { lastModified: Date.now() } })
          const t = a ? ui : di,
        ...
        Move({ id: e, offset: a }) {
          const t = wi(e),
            n = ui.indexOf(t)
          return ui.splice(n, 1), ui.splice(n + a, 0, t), yi()
        },
        ParseMeta: Gi,
        ParseMetaErrors: (e) => Gi(e).errors,
        ParseScript: Ki,
        UpdateScriptInfo: ({ id: e, config: a, custom: t }) =>
          Vi(e, { config: a, custom: t, props: { lastModified: Date.now() } }),
        Vacuum: as,
      }),
      (async () => {
        ...
        E(_e, o, ([e, a]) => {
          ...
          if (t && a) {
            ...
            ;(a.props = { ...a.props, id: t, uri: e }),
              ...
              (si = Math.max(si, t)),
              (ri = Math.max(ri, fi(a.props.position))),
              (a.config.removed ? di : ui).push(a)
    ...
    const Si = "cacheKeys",
      ...
      Ii = "promise",
      Mi = () => ({ depsMap: {}, [m]: {}, [h]: [] }),
      Ci = /^GM[_.](listValues|([gs]et|delete)Values?)$/,
      Ui = { [Qa]: Si, [at]: r, [ot]: $i, [lt]: qi },
      Di = I.entries(Ui),
      _i = new Set()
    function Ti(e, a, t, n) {
      if (yn(e)) return
      ...
      for (let t = 0; t < ui.length; t++) {
        ...
        const { pathMap: b = Ji(i) } = p,
          y = Ca(i),
          v = "start" === y || "body" === y ? s : l,
          { depsMap: w } = v
        if ((v[r].push(k), (v[m][k] = y), f.grant.some(Ci.test, Ci) && v[qi].push(k), !c))
      ...
      return (
        ...
        n
          ...
          : s
            ? i
              ? ((l[Ii] = Ri(l)), l)
              : (s[r].length && (s[Ii] = Ri(s)),
                l[r].length && (l[Ii] = Aa().then(Ri.bind(null, l))),
    ...
    function Ai(e) {
      ...
      let n,
        ...
        i = o
      e.forEach((e) => {
        ;(n = `\n#${e}: ${Ma(wi(e))}`), (o += n), _i.has(e) || (_i.add(e), a.push(e), (i += n))
      }),
        console.error(`${t} ${o}`),
        a.length && Li(t, i, a)
    }
    ...
    async function Ei({ id: e, ids: a, sizes: t }) {
      e && (a = [e])
      const n = {},
        o = a ? xi(a).filter($) : xi()
      return (
    ...
    async function Oi(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        let { custom: o, meta: i } = e[n],
          s = o.icon || i.icon
        ca(s) && ((s = o.pathMap[s] || s), a.push(s), Xo(et + s) || t.push(s))
      }
      t.length && (await mt[Qa].getMulti(t))
      for (let e, t, o = 0; o < a.length; o++) (t = a[o]), (e = us(t)), (!j(e) || (!o && (e = await e))) && (n[t] = e)
      return n
    }
    function Pi(e) {
      const a = xi(e)
      return a.map(({ meta: e, custom: { pathMap: t = {} }, props: { id: n } }, o) => [
        ...
        Ne(a[o]),
        li[ct + n] || 0,
        e.require.reduce(Ni, { len: 0, pathMap: t }).len,
        I.values(e.resources).reduce(Hi, { len: 0, pathMap: t }).len,
      ])
    }
    function Ni(e, a) {
      return (e.len += (li[it + (e.pathMap[a] || a)] || 0) + a.length), e
    }
    function Hi(e, a) {
      return (e.len += (li[et + (e.pathMap[a] || a)] || 0) + a.length), e
    }
    async function Wi(e) {
      const a = [],
        t =
          ...
          di.reduce((t, n, o) => {
            const i = ki(n)
            return e.includes(i) ? (a.push(tt + i, rt + i, ct + i), delete ci[i]) : ++t < o && (di[t] = n), t
          }, -1)
      if (di.length !== t) return (di.length = t), await mt.base.remove(a), xa("RemoveScripts", e)
    }
    function Fi({ force: e } = {}) {
      const a = Date.now(),
        t = di
          .filter((t) => {
            ...
            return t.config.removed && (e || a - fi(n) > 6048e5)
          })
          .map((e) => e.props.id)
      return Wi(t)
    }
    const Bi = crypto.randomUUID
    ...
    async function Ki(e) {
      var a
      const { meta: t, errors: n } = e.meta ? e : Gi(e)
      ...
      const { config: m, props: h } = c,
        g = qo({ meta: t, props: { id: u } })
      if (d) {
        if (e.isNew || (u && ui.some(({ props: e }) => g === e.uri && u !== e.id))) throw We("msgNamespaceConflict")
        delete c[se]
      }
      ;(h.lastModified = l), (h.uuid = h.uuid || Bi())
      ...
      const p = +e.position
      p ? ((h.position = p), (ri = Math.max(ri, p))) : d || (ri++, (h.position = ri)),
        (m.enabled = fi(m.enabled)),
        (m.removed = 0),
        (m.shouldUpdate = fi(m.shouldUpdate)),
        (c.meta = t),
        (h.uri = qo(c)),
        ...
        ([e, t, n] = r[s]),
          (i = gi[e][t]) ||
            (t &&
              ...
              (i = a[e]) && null != (i = i[t])
                ? (mt[e].setOne(t, i), (i = ""))
                : ((i = Xi(a, e, t)), n && (i = M.race([i, Aa(n)])), (gi[e][t] = i)))),
          (r[s] = i)
      const l = await M.all(r),
        c = E(La, l.map(Qi), "\n")
      if (c) {
        const a = We("msgErrorFetchingResource")
        return xa("UpdateScript", { update: { error: c, message: a }, where: { id: ki(e) } }), `${a}\n${c}`
      }
    }
    async function Xi(e, a, t) {
        ...
        E(_e, r, ([e, a]) => {
          if (a < 0) s.push(e)
            ...
            const n = mt.forKey(e),
              ...
              r = n.name === at ? u[o] : o
            t
              ? t.push(r || (+o && Ua(wi(o))) || e)
              : r && n.fetch && (s.push(nt + r), i.push(n.fetch(r).catch((e) => `${Ma(wi(+o || a - 2))}: ${Qi(e)}`)))
          }
        }),
    ...
    const ts = {},
      ns = (e) => "SetPopup" + e
    async function os(e, a, t) {
      e[u] = !0
      const n = e[r],
        o = Ti(a.url, a[v], null, n)
      if ((I.assign(n, o), I.assign(e, await Ei({ [r]: I.keys(n) })), (e = [e, a]), !t)) return e
      ;(Dt.get(t) || Dt.put(t, {}))[a[Y]] = e
    }
    async function is(e, a) {
      return (
    ...
    Fa({
      async InitPopup() {
        ...
        let i = _s(a, o, ""),
          ...
          l = Dt.pop(ns(t))
        return (
          s && (l ? !l[0] : (l = {})) && (l[0] = await os({ [r]: {}, menus: {} }, { tab: e, url: a, [Y]: 0, [v]: 1 })),
          i[0] ||
            null != o[X] ||
            ((await is(t, o))
    ...
    const rs = [16, 32],
      ...
      gs = "showBadge",
      ps = "badgeColor",
      fs = "badgeColorBlocked",
      ks = We("failureReasonBlacklisted"),
      bs = F[K].default_title,
      ys = F[K].default_icon[16].match(/\d+(\w*)\./)[1],
      vs = We("menuScriptDisabled"),
      ws = We("failureReasonNoninjectable"),
      xs = We("skipScriptsMsg")
    let zs, js, Ss, $s
    function qs(e, a) {
      var t
      const n = He(hs, e)
      return (
        ...
        (n[Y] = void 0),
        (n[X] = a),
        a || null == (t = ts[e]) || t.postMessage(null),
        n
      )
    }
    function Is(e, a, { tab: t, [Y]: n, [v]: o }) {
      const i = t.id,
        s = e === x || "off" === e ? e : !!e,
        l = (!(a && o) && hs[i]) || qs(i, s)
      if (Array.isArray(e)) {
      ...
      o && (l[X] = s), Cs(t, l), Us(t, l)
    }
    function Ms({ id: e }, a = hs[e]) {
      a && ds.setBadgeText({ text: `${a[js] || ""}`, tabId: e })
    }
    function Cs({ id: e }, a = hs[e]) {
      a && ds.setBadgeBackgroundColor({ color: a[X] ? Ss : $s, tabId: e })
    }
    function Us(e, a, t) {
      const n = e.id
      a || (a = hs[n] || qs(n)), t || ([t] = _s(oo(e), a)), ds.setTitle({ tabId: n, title: t }), Ds(e, a), Ms(e, a)
    }
    async function Ds({ id: e } = {}, a = hs[e] || {}) {
      const t = zs ? (!0 !== a[X] ? "b" : "") : "w"
      if (a.icon === t) return
      a.icon = t
      const n = {},
        o = {}
      for (let e = 0; e < rs.length; e++) {
        const a = rs[e],
          i = `${V}${a}${t}.png`
        ;(n[a] = i), (o[a] = cs[i] || ((await (ls[i] || (ls[i] = Rs(i)))) && cs[i]))
      }
      ds.setIcon({ tabId: e, path: n, imageData: o })
    }
    function _s(e, a, t = bs) {
      return co.test(e)
        ? (e = yn(e))
          ? [ks, "blacklisted", e]
          : zs && "off" !== (null == a ? void 0 : a[X])
            ? a
              ? a[X] === x
                ? [xs, x]
                : [t]
    ...
    function Ts(e, a) {
      ...
      else if ("dashboard" === e) mo("")
      else if ("newScript" === e) Ha.OpenEditor()
      else if ("updateScripts" === e) Ha.CheckUpdate()
      else if ("updateScriptsInTab" === e) {
        var t
        ;(e = null == (t = hs[a.id]) ? void 0 : t[r]) && Ha.CheckUpdate([...e])
      } else e.startsWith(gs) && It(gs, e.slice(10))
    }
    async function Rs(e) {
      const a = new Image(),
        t = e.startsWith(V)
      let n
      ;(a.src = t ? e.slice(W.length) : e.startsWith("data:") ? e : Ea("i" === e[0] ? e : await As(e)) || e),
        await new M((e) => {
          ;(a.onload = e), (a.onerror = e)
        })
      let o = !t && 76,
        { width: i, height: s } = a
      if (!i || !s) return (ls[e] = e), e
      o && (i > o || s > o) && ((o /= i > s ? i : s), (i = Math.round(i * o)), (s = Math.round(s * o)))
      const r = document.createElement("canvas"),
        l = r.getContext("2d")
      ;(r.width = i), (r.height = s), l.drawImage(a, 0, 0, i, s)
      try {
        ;(n = r.toDataURL()), t && (cs[e] = l.getImageData(0, 0, i, s))
      } catch (a) {
        n = e
      }
      return (ls[e] = n), n
    ...
    Fa({ GetImageData: us }),
      xt((e) => {
        let a
        const t = []
        null != (a = e[O]) && ((zs = a), Ds(), t.push(Ds)),
          null != (a = e[gs]) && ((js = a), t.push(Ms), null == ms || ms.update(gs + ":" + js, { checked: !0 })),
          (((a = e[ps]) && (Ss = a)) || ((a = e[fs]) && ($s = a))) && t.push(Cs),
          pe in e && t.push(Us),
          t.length && uo((e) => t.forEach((a) => a(e)))
      }),
      Va.then(async () => {
        if (((zs = qt(O)), (js = qt(gs)), (Ss = qt(ps)), ($s = qt(fs)), uo(Us), zs || Ds(), ms)) {
          const e = (e, a, t) => new M((n) => ms.create({ contexts: [K], id: e, title: a, ...t }, n)).then(pa),
            a = { parentId: gs, type: "radio" }
          await e(x, We("skipScripts"))
          for (
            let t = 0,
              n = [
                [gs, We("labelBadge")],
                [`${gs}:`, We("labelBadgeNone"), a],
                [`${gs}:unique`, We("labelBadgeUnique"), a],
                [`${gs}:total`, We("labelBadgeTotal"), a],
              ];
            t < n.length;
            t++
          ) {
          ...
          ms.update(gs + ":" + js, { checked: !0 }), P && (await e(G, We("labelSettings")))
        }
      }),
      null == ms ||
        ms.onClicked.addListener(({ menuItemId: e }, a) => {
          Ts(e, a)
        }),
      so.addListener((e) => delete hs[e]),
      io.addListener(
        (e, { url: a }, t) => {
          if (a) {
            const [n] = _s(a)
        ...
        ;(a.code = t.code),
          2 === t.version
            ...
            : 1 === t.version &&
              ...
              (a.config = er({ enabled: t.more.enabled, shouldUpdate: t.more.update })),
              (a.props = er({ lastUpdated: t.more.lastUpdated })))
      } catch (t) {
        a.code = e
      }
      return a
    ...
    function ar(e) {
      ...
      return (a.prototype = e), (a.extend = tr), a
    }
    function tr(e) {
      return ar(I.assign(I.create(this.prototype), e))
    }
    const nr = Fe(() => {
        xa("UpdateSync", Xs())
      }),
      or = ar({
        ...
        initialize() {
          ;(this.progress = { finished: 0, total: 0 }),
            (this.config = Js(this.name)),
            (this.authState = Ys(
              ["idle", "no-auth", "initializing", "authorizing", "authorized", "unauthorized", "error"],
              null,
              nr
            )),
            (this.syncState = Ys(["idle", "ready", "syncing", "error"], null, nr)),
        ...
        syncFactory() {
          let e, a
          const t = () => this.authState.is("authorized") && sr() === this.name,
            n = () => {
        ...
        loadData(e) {
          ...
          return (
            ...
            n
              ...
              .then(({ data: e, error: t }) => ((a.finished += 1), nr(), t ? M.reject(t) : e))
          )
        },
        getLocalData: () => Es.list(),
        getSyncData() {
                ...
                const b = [
                  ...
                  ...g.map(
                    ({ local: e, remote: a }) => (
                      ...
                      Es.get(e.props.id).then((t) => {
                        const o = Zs(e, 1, { code: t })
                        return (
                  ...
                  ...f.map(({ local: e }) => (this.log("Remove local script:", e.props.uri), Es.remove(e.props.id))),
                  ...k.map(({ local: e, info: a }) => {
                    const t = {}
                    return a.position && (t.props = { position: a.position }), Vi(e.props.id, t)
                  }),
                ]
                return (
                  b.push(
    ...
    function cr() {
      const e = rr()
      return e && M.resolve(lr(e)).then(Hs)
    }
    let ur
    async function dr(e, a) {
      null == ur || ur()
      const t = (await browser.tabs.create({ url: e })).id,
        n = (e) => {
          var a, n
          if (null != (a = (n = rr()).checkAuth) && a.call(n, e.url))
            return browser.tabs.remove(t), setTimeout(ur, 0), { cancel: !0 }
        }
      ;(ur = () => {
    ...
    async function hr(e) {
      ...
      return btoa(Ke(t)).replace(/[+/=]/g, (e) => mr[e] || "")
    }
    function gr() {
      return Ve(43, 128)
    }
    async function pr(e) {
      return { code_challenge: await hr(e), code_challenge_method: "S256" }
    }
    const fr = { client_id: "f0q12zup2uys5w8", redirect_uri: Se + "auth_dropbox.html" },
      kr = /[\u007f-\uffff]/g,
      br = (e) => `\\u${(e.charCodeAt(0) + 65536).toString(16).slice(1)}`
    function yr(e) {
      return JSON.stringify(e).replace(kr, br)
    }
    function vr(e) {
      return { name: e.name, size: e.size, uri: Gs(e.name) }
    }
    ir(
      or.extend({
        name: "dropbox",
        ...
        list() {
          return this.loadData({
            ...
            body: { path: "" },
            responseType: "json",
          }).then((e) => e.entries.filter((e) => "file" === e[".tag"] && Vs(e.name)).map(vr))
        },
        get(e) {
          const a = Bs(e)
          return this.loadData({
            ...
            headers: { "Dropbox-API-Arg": yr({ path: `/${a}` }) },
          })
        },
        put(e, a) {
          const t = Bs(e)
          return this.loadData({
            ...
            headers: {
              "Dropbox-API-Arg": yr({ path: `/${t}`, mode: "overwrite" }),
        ...
        async authorize() {
          ;(this.session = { state: Ge(), codeVerifier: gr() }),
            dr(
              `https://www.dropbox.com/oauth2/authorize?${Na({ response_type: "code", token_access_type: "offline", client_id: fr.client_id, redirect_uri: fr.redirect_uri, state: this.session.state, ...(await pr(this.session.codeVerifier)) })}`,
              fr.redirect_uri
            )
        },
        async authorized(e) {
          ...
          const a = await this.loadData({
            ...
            body: Na({ client_id: fr.client_id, ...e }),
            responseType: "json",
          })
      ...
      or.extend({
        ...
        list() {
          return this.loadData({ url: "/drive/special/approot/children", responseType: "json" }).then((e) =>
            e.value.filter((e) => e.file && Vs(e.name)).map(xr)
          )
        },
        get(e) {
          const a = Bs(e)
        ...
        authorize() {
          dr(
            `https://login.live.com/oauth20_authorize.srf?${Na({ client_id: wr.client_id, scope: "onedrive.appfolder wl.offline_access", response_type: "code", redirect_uri: wr.redirect_uri })}`,
            wr.redirect_uri
          )
        },
        checkAuth(e) {
          const a = `${wr.redirect_uri}?code=`
          if (e.startsWith(a))
            ...
            body: Na(
              I.assign(
                {},
                {
                  ...
                  client_secret: wr.client_secret,
                  redirect_uri: wr.redirect_uri,
                  grant_type: "authorization_code",
                },
                e
              )
    ...
    const zr = "590447512361-fa9j9vrskafqi75q2p2o2mkirdo9lavo.ap"+"ps.googleus"+"ercontent.com"/* apps.googleusercontent.com */,
      jr = "http://127.0.0.1:45678/",
      Sr = "https://www.googleapis.com/auth/drive.appdata",
      $r = { status: "UNAUTHORIZED" }
    function qr(e) {
      return { id: e.id, name: e.name, size: +e.size, uri: Gs(e.name) }
    }
    ir(
      or.extend({
        name: "googledrive",
        ...
        user() {
          ...
          return e()
            .then((e) => {
              if (e.scope !== Sr) return M.reject($r)
            })
            .catch((a) =>
              a === $r || (400 === a.status && "Invalid Value" === Me(a, "data.error_description"))
        ...
        getSyncData() {
          return this.loadData({
            ...
            let a
            const t = e
                .filter((e) => !!Vs(e.name) || (a || e.name !== this.metaFile ? this.remove(e) : (a = e), !1))
                .map(qr)
        ...
        async authorize() {
          ...
          const e = {
            ...
            ...(await pr(this.session.codeVerifier)),
          }
          this.config.get("refresh_token") || (e.prompt = "consent"),
            dr(`https://accounts.google.com/o/oauth2/v2/auth?${Na(e)}`, jr)
        },
        checkAuth(e) {
          const a = `${jr}?`
          if (!e.startsWith(a)) return
        ...
        authorized(e) {
          return this.loadData({
            ...
            prefix: "",
            headers: { "Content-Type": ie },
            body: Na(I.assign({}, { client_id: zr, client_secret: "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" }, e)),
            responseType: "json",
          }).then((e) => {
            if (!e.access_token) throw e
            {
    ...
    class Mr {
      ...
      children() {
        if (!this[Ir]) {
          const { node: e, nsMap: a } = this
          this[Ir] = [...e.children].map((e) => new Mr(e, a))
        }
        return this[Ir]
      }
      map(e) {
    ...
    const Cr = { serverUrl: "", anonymous: !1, username: "", password: "" },
      Ur = or.extend({
        ...
        loadData(e) {
          return or.prototype.loadData.call(this, I.assign({ credentials: "omit" }, e))
        },
        handleMetaError(e) {
                  ...
                  .map((e) => {
                    ...
                    if ("file" == (a.find("DAV:resourcetype").find("DAV:collection") ? "directory" : "file")) {
                      ...
                      if (Vs(n)) {
                        ...
                        return { name: (t = { name: n, size: e ? +e.text() : 0 }).name, size: t.size, uri: Gs(t.name) }
                      }
                    }
                    var t
                    return null
    ...
    ir(Ur)
    const Dr = new RegExp(`^(?:${[rt, tt].join("|")})`)
    let _r
    function Tr({ keys: e }) {
    ...
    const Rr = document.createElement("textarea")
    let Ar
    Wa({
      SetClipboard(e) {
        ;(Ar = e), Rr.focus(), document.execCommand("copy", !1, null)
      },
    }),
      document.body.appendChild(Rr),
      C("copy", (e) => {
        e.preventDefault()
        const { type: a, data: t } = Ar
    ...
    function Hr(e, a, t) {
      for (const n in Lr) {
        ...
        !j(o) ||
          ...
          (a && o[Y] !== a) ||
          o[Er] ||
          (o[Or] ? ((o[Er] = setTimeout(Fr, o[Or], n)), o[Pr] || (Lr[n] = o[Er]), t && (o._removed = !0)) : Fr(n))
      }
    }
    function Wr(e) {
      e > 0 && clearTimeout(e)
    ...
    function Fr(e) {
      return delete Lr[e], browser.notifications.clear(e)
    }
    Wa({
      async Notification({ image: e, text: a, tag: t, title: n, silent: o, onclick: i, [Pr]: s, [Or]: r }, l) {
        t && Wr(Lr[t])
        ...
        return z(i) ? (Lr[c] = i) : l && ((Lr[c] = l), +r > 0 && (l[Or] = +r), null != s && (l[Pr] = Yn(s, l.url))), c
      },
    ...
    let Br,
      Vr = M.resolve()
    function Gr(e, a, t) {
      if (!t) return void (Vr = Vr.then(() => (Gr(e, a, !0), Aa(150))))
    ...
    const Kr = Ge("VM-Verify"),
      ...
      Zr = { urls: ["<all_urls>"], types: ["xmlhttprequest"] },
      Qr = [browser.webRequest.OnBeforeSendHeadersOptions.EXTRA_HEADERS].filter($),
      el = {},
      al = (e) => e.name === Kr,
      tl = "cookie",
      nl = "set-cookie",
      ol = /^\s*(?:__(Secure|Host)-)?([^=\s]+)\s*=\s*(")?([!#-+\--:<-[\]-~]*)\3(.*)/,
      il = /\s*;?\s*(\w+)(?:=(")?([!#-+\--:<-[\]-~]*)\2)?/y,
      sl = { strict: "strict", lax: "lax", none: "no_restriction" },
      rl = "requestHeaders",
      ll = {
        onBeforeSendHeaders: [
          ({ [rl]: e, requestId: a, url: t }) => {
            var n
            const o = Yr[a] || (null == (n = e.find(al)) ? void 0 : n.value),
              i = Jr[o]
            if (i) {
              ;(Yr[a] = o), (i.coreId = a), (i.url = t)
              const n = {},
                s = el[o],
                r = s && {}
              let l,
              ...
              for (let a = 0; a < e.length; a++) {
                ...
                ;(l = t.name) === Kr ||
                  ...
                  (l === tl && !i[tl]) ||
                  (!c && l === tl && (c = s[l]) ? (r[l] = { name: l, value: t.value + "; " + c.value }) : (n[l] = t))
              }
              return { [rl]: I.values(I.assign(n, s, r)) }
            }
          },
          rl,
          "blocking",
          ...
          ({ [f]: e, requestId: a, url: t }) => {
            ...
            if (n) {
              ...
              if (!n[nl] || a)
                return (
                  (e = e.filter((e) => {
                    if (e.name.toLowerCase() !== nl) return !0
                    a && dl(e.value, a, t)
                  })),
                  { [f]: e }
                )
    ...
    function cl(e, a) {
      a
        ? (ta(el) &&
            E(_e, ll, ([e, [a, ...t]]) => {
              browser.webRequest[e].addListener(a, Zr, t)
            }),
          (el[e] = a))
        : e in el &&
          (delete el[e],
    ...
    function ul({ name: e, value: a, binaryValue: t }) {
      return `${ml(e)}: ${t ? Ke(t) : ml(a)}\r\n`
    }
    function dl(e, a, t) {
      let n = ol.exec(e)
      if (n) {
        ...
        const [, e, i, , s, r] = n,
          l = {},
          c = "Host" === e
        for (il.lastIndex = 0; (n = il.exec(r)); ) l[n[1].toLowerCase()] = n[3]
    ...
    function ml(e) {
      return /[\u0080-\uFFFF]/.test(e) ? (Br || (Br = new TextEncoder()), Ke(Br.encode(e))) : e
    }
    Bn >= 74 && Bn <= 91 && browser.webRequest.onBeforeSendHeaders.addListener(Be, Zr, Qr),
      Wa({
        HttpRequest(e, a) {
          const t = a.tab.id,
            n = to(a),
            { id: o, events: i } = e,
            s = (Jr[o] = { id: o, tabId: t, [Y]: n, frame: no(n), xhr: new XMLHttpRequest() }),
            r = (e) => Jr[o] && za(t, "HttpRequested", e, s.frame)
          return $l(e, i, a, r).catch(
    ...
    const hl = 1e6,
      gl = P ? 256e6 : 1e7,
      pl = 6e4,
      fl = ["readyState", "status", "statusText"],
      kl = ["lengthComputable", "loaded", "total"],
      bl = (e) => `"${e.replace(/[\\"]/g, "\\$&")}"`,
      yl = "sec-ch-ua",
      vl = {
        __proto__: null,
        "user-agent": (e) => e,
        [yl]: (e) => e.map((e) => `${bl(e.brand)};v="${e.version}"`).join(", "),
        [yl + "-mobile"]: (e) => "?" + (e ? 1 : 0),
        [yl + "-platform"]: bl,
      },
      wl = I.keys(vl)
    ...
    function zl(e) {
      ...
      return Dt.put(`xhrBlob:${a}`, setTimeout(URL.revokeObjectURL, pl, a), pl), a
    }
    function jl(e, a, t) {
      return e.substr(a * t, t)
    }
    function Sl(e, a, t, n, o) {
      let i,
        s,
        r,
        l,
        ...
        z = async () => {
          ...
          i || (i = w.getResponseHeader("Content-Type") || ""),
            k !== w[p] &&
              ...
              c &&
                ((m = c.length - y)
                  ? ((n = m > gl), (r = gl), (s = m), (l = jl), (c = y ? c.slice(y) : c), (y += s))
                  : ((r = hl), (s = c.size), (l = t ? zl : xl)),
    ...
    async function $l(e, a, t, n) {
      ...
      if (
        ...
        m.setRequestHeader(Kr, r),
        y && m.setRequestHeader("Content-Type", y),
        E(_e, e.headers, ([e, a]) => {
          const t = e.toLowerCase(),
            n = wl.indexOf(t)
          ;(n >= 0 && (x[n] = !0)) || Xr.test(e) ? Ul(h, e, a, t) : m.setRequestHeader(e, a)
        }),
        e.ua.forEach((e, a) => {
        ...
        const e = Date.now() / 1e3,
          a = (
            await browser.cookies.getAll({ url: u, storeId: d.storeId, ...(Vn >= 59 && { firstPartyDomain: null }) })
          ).filter((a) => a.session || a.expirationDate > e)
        a.length && Ul(h, tl, a.map((e) => `${e.name}=${e.value};`).join(" "))
      }
      cl(r, h)
      const z = Sl(d, a, f, p, "json" === e[b])
      a.forEach((e) => {
        m[`on${e}`] = z
      }),
        (m.onloadend = z),
    ...
    function ql({ id: e, coreId: a }) {
      delete Yr[a], delete Jr[e], cl(e, !1)
    }
    function Il(e, a) {
      E(Re, Jr, (t) => {
    ...
    let Dl,
      ...
      Rl = !1
    const Al = Ge(),
      Ll = browser.webRequest.onHeadersReceived,
      El = { urls: ["*://*/*"], types: ["main_frame", "sub_frame"] },
      Ol = ["blocking", f, browser.webRequest.OnHeadersReceivedOptions.EXTRA_HEADERS].filter($),
      Pl = (e) => "content-security-policy" === e.name.toLowerCase(),
      Nl = /(?:^|[;,])\s*(?:script-src(-elem)?|(d)efault-src)(\s+[^;,]+)/g,
      Hl = /'nonce-([-+/=\w]+)'/,
      Wl = /^\s*(?:\/\*[\s\S]*?\*\/|\/\/.*[\r\n]+|\s+)*/u,
      Fl = (e) => 45 === (e = e.charCodeAt(e.match(Wl)[0].length)) || 43 === e || 91 === e || 40 === e,
      Bl = "'unsafe-inline'",
      Vl = { [X]: {}, [Si]: [] },
      Gl = { ...Vl, [X]: { [i]: !0, [y]: Al } },
      Kl = "csReg",
      Jl = browser.contentScripts,
      Yl = Ct({
        lifetime: 3e5,
        onDispose(e) {
          var a
          null == (a = e[Kl]) || a.then((e) => e.unregister()), Yl.del(e[u])
        },
      }),
      Xl = "{GM,GM_info,unsafeWindow,cloneInto,createObjectIn,exportFunction}",
      Zl = ["description", "name", "namespace", [m], "version"],
      Ql = [[re, "homepage"]],
      ec = /^(?:(m|excludeM)atch|(ex|in)clude)$/,
      ac = (e, a) => e + (a ? "es" : "s"),
      tc = (e) => e.replace(ec, ac),
      nc = { [et]: Si, [tt]: !0, [it]: $i, [rt]: !0, [ct]: qi },
      oc = {},
      ic = `(${(e, a) => {
      ...
      lc = (e, a) => rc(e[c] || a[c]),
      cc = (e, a) => e === o || (e === n && a),
      uc = (e) => "outermost_frame" === e.frameType || !e[Y],
      dc = {},
      mc = {
        [pe]: Yl.destroy,
        defaultInjectInto(e) {
          ;(e = rc(e)),
            Yl.destroy(),
            _l && (e === o ? Ll.removeListener(fc) : Dl && P && !Rl && Ll.addListener(fc, El, Ol)),
            (_l = e)
        },
        xhrInject: (e) => {
          e && (e = _l !== o),
            Rl !== e && ((Rl = e), Yl.destroy(), Ll.removeListener(fc), e && Ll.addListener(fc, El, Ol))
        },
        [O]: (e) => {
          Dl = e
          const a = (e ? "add" : "remove") + "Listener",
            t = e ? El : void 0
          browser.webRequest.onSendHeaders[a](pc, t),
            (!Dl || (P && !Rl && _l !== o)) && Ll[a](fc, t, t && Ol),
            so[a](Mc),
            browser.tabs.onReplaced[a](Cc),
            e || (Yl.destroy(), Uc(), Bo.destroy(), Vo.destroy())
        },
        [i](e) {
          E(_e, e, ([e, a]) => {
            oc[decodeURIComponent(e)] = a
          })
        },
      }
    function hc(e, a) {
      if (e[Si])
        for (let n = 0; n < this.length; n++) {
          var t
          const [o, i, s] = this[n]
          if (null != (t = e[nc[o]]) && t.includes(+i || i)) {
            if (o === it) e.depsMap[i].forEach((e) => Yl.del(rt + e))
            else if (o === ct && (e[lt] && (e[lt][i] = s), gc(e, +i, s), !e[Kl])) continue
            Yl.del(a)
          }
        }
    }
    ...
    function pc(e) {
      const { url: a, tabId: t } = e,
        n = uc(e),
        o = sc(a, n)
      Yl.has(o) || dc[t] || bc(o, a, n)
    }
    function fc(e) {
      var a
      const t = sc(e.url, uc(e)),
        n = Yl.get(t)
      if (n && !n[s] && null != (a = n[X]) && a[h] && !dc[e.tabId]) {
        const a = P && e.url.startsWith("https:") && qc(e, n),
          t = Rl && kc(e, n)
        return a ? a.then(t && (() => t)) : t
      }
    }
    function kc({ [f]: e, [Y]: a, tabId: t }, n) {
      xc(n[X][h], n[s], t, a, n)
      const o = URL.createObjectURL(new Blob([JSON.stringify(n[X])]))
      return (
        e.push({ name: nl, value: `"**VMInitInjection**"=${o.split("/").pop()}; SameSite=Lax` }),
        setTimeout(URL.revokeObjectURL, 6e4, o),
        { [f]: e }
      )
    }
    function bc(e, a, t) {
      const n = t && a.startsWith("https://") ? oc[a.split("/", 3)[2]] : null,
        o = null != n ? Gl : Vl
      if (((Gl[X][i] = n), !Dl)) return o
      const s = [],
        r = Ti(a, t, s)
      return r && (r[Ii] = yc(e, a, t, r, null != n ? { [i]: n } : {}, s)), Yl.put(e, r || o)
    }
    async function yc(e, a, t, n, o, i) {
      n[Ii] && (await n[Ii]), Yl.batch(!0)
      const s = { [X]: o },
        { allIds: l, [u]: m } = n,
      ...
      return (
        ...
        (s[u] = m),
        Tl && Jl && !Rl && t && ((o[d] = n[d] || zc(m)), (s[Kl] = Sc(o, a))),
        g && (Yl.put(g, m), (m[u] = e)),
        Yl.put(e, s),
        Yl.batch(!1),
        s
    ...
    function vc(e) {
      ...
      for (let t, n, i, s = 0; s < a.length; s++)
        (t = a[s]),
          (i = t.id),
          t[ve] || ((i = t.props.id), (n = rt + i), (t = Yl.get(n) || Yl.put(n, wc(t, e))), (a[s] = t)),
          t[c] !== o && (e[d] = !0),
          (t[g] = e[lt][i] || null)
      return a
    }
    function wc(e, a) {
      ...
      for (let e = 0, a = n[ot]; e < a.length; e++) {
        const t = a[e],
          n = s[p[t] || t]
        ;/\S/.test(n) && (z.push(...[I && Fl(n) && ";", n, !de.test(n) && "\n"].filter($)), (I = !0))
      }
      return (
        I && Fl(l) && z.push(";"),
        (q = z.length),
    ...
    function xc(e, a, t, n, o) {
      ...
      o && (o[X][d] = s || zc(o[u])), r[0] && setTimeout(jc, 0, r, t, n)
    }
    function zc(e, a) {
      return null == e ? void 0 : e[h].some(Ic, a || null)
    }
    function jc(e, a, t) {
      for (let n = 0; n < e.length; n++) {
        const [o, i] = e[n],
    ...
    function Sc(e, a) {
      ...
      return Jl.register({
        js: [{ code: `${ic}(this,${JSON.stringify(e)})` }],
        matches: a.split("#", 1),
        [m]: "document_start",
      })
    }
    function $c(e) {
      const a = e[Kl]
      if (a) return delete e[Kl], a.then((e) => e.unregister())
    }
    function qc(e, a) {
      const t = e[f].find(Pl)
      if (!t) return
      let n,
        ...
        r,
        l = ""
      for (; (n = Nl.exec(t.value)); ) l += n[2] ? (r = n[3]) : n[1] ? (i = n[3]) : (o = n[3])
      if (l) {
        if (((l = l.match(Hl)), l)) a[X].nonce = l[1]
        else {
          if (!((o && !o.includes(Bl)) || (i && !i.includes(Bl)) || (!o && !i && r && !r.includes(Bl)))) return
          a[s] = a[X][s] = !0
        }
        return (n = $c(a)), n && !l ? M.all([n, (a[Kl] = Sc(a[X], e.url))]) : void 0
      }
    }
    function Ic(e) {
      return !cc(e[c] || lc(e.custom, e.meta), this)
    }
    function Mc(e) {
      Uc(e, 0, !0), delete dc[e]
    }
    function Cc(e, a) {
      Mc(a)
    }
    function Uc(e, a, t) {
      Il(e, a), To(e, a), Hr(e, a, t)
    }
    function Dc(e, a) {
      setTimeout(za, 0, e, "PopupShown", !0, no(a))
    }
    Jl &&
      (mc.ffInject = (e) => {
        ;(Tl = e),
      ...
      Fa({
        [x]: async (e) => {
          ...
          const a = e.id,
            t = Yl.get(sc(e.url, !0)),
            n = t && $c(t)
          ;(dc[a] = 1), n && (await n), Uc(a), await browser.tabs.reload(a)
        },
      }),
      Wa({
        async GetInjected({ url: e, [s]: a, done: t }, n) {
          const { tab: o, [Y]: i, [v]: r } = n,
            l = ao(r, n[J], i),
            u = o.id
          e || (e = n.url || o.url), Uc(u, l)
          let d = dc[u]
          if (d > 0) return r && (dc[u] = -1), ts[u] && Dc(u, l), { [c]: x }
          d && delete dc[u]
          const m = sc(e, r),
            g = Yl.get(m) || bc(m, e, r),
            p = g[X] ? g : await g[Ii],
            f = p[X],
            k = f[h]
          return k && (xc(k, p[s] || a, u, i, p), Ro(k, u, l)), ts[u] && Dc(u, l), Dl ? !t && f : { [c]: "off", ...f }
        },
        async InjectionFeedback({ [s]: e, [o]: a, [u]: t, url: n }, i) {
          const { tab: r, [Y]: l } = i,
            c = i[v],
            d = r.id
          if ((jc(a, d, l), !t)) return
          n || (n = i.url || r.url)
          const m = Yl.get(t) || Yl.put(t, Ti(n, c)) || { [h]: [] },
            g = (m[Ii] ? await m[Ii] : m)[Qa],
            p = vc(m)
          return xc(p, e, d, l), Ro(p, d, ao(c, i[J], l)), { [h]: p, [Qa]: g }
        },
        Run({ [r]: e, reset: a }, t) {
          const {
              [J]: n,
            ...
            s = +(null == e ? void 0 : e[0])
          Is(e, a, t), 3 === o && (s && Ao(e, n), Ml(i, n), Hr(i)), "bfcache" === a && s && Ro(e, i, ao(o, n, t[Y]))
        },
      }),
      $t(function e(a) {
        for (const e in mc) e in a && mc[e](a[e])
      ...
      Yo((e, a) => {
        ...
        for (let n = 0; n < e.length; n++) {
          const o = e[n],
            ...
            s = o.slice(0, i),
            r = o.slice(i)
          if (!0 === nc[s]) return void Yl.destroy()
          let l, c
          s === ct && ((c = null == a ? void 0 : a[o]), (l = Yl.get(rt + r)) && (l[g] = c = Ae(c) || (l[g] && {}))),
            s && t.push([s, r, c])
        }
        t.length && Yl.some(hc, t)
      })
    const _c = {},
      Tc = { ...ye, headers: { Accept: "text/x-userscript-meta,*/*" } },
      Rc = "checking"
    async function Ac(e, a, t, n) {
      let o, i, s
      try {
        const { update: s } = await Ki({ id: e, code: await Lc(a, t, n), bumpDate: !0, update: { [Rc]: !1 }, ...n })
        ;(i = We("msgScriptUpdated", [Ma(s)])), (o = !0)
      } catch (e) {
        s = e.error || (!e[Rc] && (await Yi(a, n)))
      } finally {
        Ec(a) && (i || s) && (o = { script: a, text: E(La, [i, s], "\n"), err: !!s }), delete _c[e]
      }
      return o
    }
    async function Lc(e, a, t) {
      ...
      try {
        const { data: e } = (await Hc(r, { ...Tc, ...t })) || {},
          { version: a, [ve]: i } = e ? zo(e, !0) : {}
        if (ea(o.version, a) >= 0) u(We("msgNoUpdate"), { [Rc]: !1 })
        else {
          if (s)
            return s === r && null != e && e.replace(ce, "").trim()
              ...
              : (u(We("msgUpdating")),
                ...
                s === r && i.trim() !== e.trim() ? e : (await Hc(s, { ...ye, ...t })).data)
          u(We("msgNewVersion"), { [Rc]: !1 })
        }
      } catch (e) {
        u(n || We("msgErrorFetchingUpdateInfo"), { error: e })
      }
      throw l
      function u(e, { error: a, [Rc]: t = !a } = {}) {
        I.assign(l, { message: e, [Rc]: t, error: a ? `${We("genericError")} ${a.status}, ${a.url}` : null }),
          xa("UpdateScript", c)
      }
    }
    function Ec(e) {
    ...
    function Oc() {
      ...
      a >= e && (setTimeout(Ha.CheckUpdate, 2e4, n), (a = 0)),
        ...
        (Oc.timer = setTimeout(Oc, Math.min(2147483647, e - a)))
    }
    function Pc() {
    ...
    async function Hc(e, a) {
      ...
      const s = !ua(e)
      if (
        (!s && a && (t = a[Z]) && j((o = await mt.mod.getOne(e))) && ([o, i] = o), !(t === n && i > Date.now() - Pc()))
      )
        for (let n = 0, i = t ? [0, 1] : [1]; n < i.length; n++) {
          const t = i[n]
          if (o || t) {
            const n = await (s || ra.test(e) ? ma : Jn)(e, t ? a : { ...a, ...ye, method: "HEAD" }),
              { headers: i } = n,
    ...
    Va.then(Oc),
      xt((e) => "autoUpdate" in e && Oc()),
      Fa({
        async CheckUpdate(e) {
          const a = e === n,
            t = a || !e,
            o = t ? ji() : na(e).map(wi).filter($),
      ...
      (mt.cache.fetch = Nc({ init: (e) => ({ ...e, [b]: "blob" }), transform: (e) => Oa(e) })),
      (mt.require.fetch = Nc({
        transform: ({ data: e }, a) =>
          /^\s*</.test(e)
            ? M.reject(
    ...
    Wa({
      ...
      async ConfirmInstall({ code: e, from: a, url: t, fs: n, parsed: o }, { tab: i = {} }) {
        ...
        const s = Ge(),
          ...
          u = (!c || P) && (t === a || Dt.has(`autoclose:${l}`) || eo.test(a))
        Dt.put(`confirm-${s}`, { incognito: c, url: t, from: a, tabId: l, fs: n, ff: Vn })
        const d = Wc + s,
          { [Q]: m } = u
    ...
    const Fc =
      ...
      Bc = /^https?:\/\/((gist\.)?github\.com|((greas|sleaz)yfork|openuserjs)\.org)\//i,
      Vc = (e) => `${B}${N}/${+e.split("#")[1]}`,
      Gc = P && new RegExp(`^(view-source:)?(${H.replace("://", "$&)?")}[^/]*\\.user\\.js#\\d+`),
      Kc =
        Gc &&
        ((e, a) => {
          Gc.test(a) && browser.tabs.update(e, { url: Vc(a) })
        })
    async function Jc(e, a) {
      const n = (e >= 0 && (await browser.tabs.get(e))) || {},
        { data: o } = (await ma(a).catch(Be)) || {}
      if (o && zo(o).name) Ha.ConfirmInstall({ code: o, url: a, from: n.url, parsed: !0 }, { tab: n })
      else {
    ...
    var Yc
    function Xc({ cmd: e, data: a, url: t, [v]: n } = {}, o) {
      if (Va) return Va.then(Xc.bind(this, ...arguments))
      const i = L(Ha, e) && Ha[e]
      if (i) {
        if (o) {
          let a = o.origin
    ...
    Gc && io.addListener((e, { url: a }) => a && Kc(e, a), Vn && { properties: [Vn >= 88 ? "url" : "status"] }),
      browser.tabs.onCreated.addListener((e) => {
        const { id: a, title: t } = e,
          n = oo(e),
          o = n.startsWith("file:"),
          i = /\.user\.js([?#]|$)/.test(n)
        i && (!o || Vn < 68) && Dt.put(`autoclose:${a}`, !0, 1e4),
          Gc && "about:blank" === n && Kc(a, t),
          i && o && !ro && !P && qt("helpForLocalFile") && Ha.ConfirmInstall({ url: n, fs: !0 }, { tab: e })
      }),
      browser.webRequest.onBeforeRequest.addListener(
        (e) => {
          ...
          if ("GET" === a)
            return n.startsWith(H)
              ? { redirectUrl: Vc(n) }
              : Dt.has(`bypass:${n}`) || (Bc.test(n) && !Fc.test(n))
                ? void 0
                : (Jc(t, n), P ? { cancel: !0 } : { redirectUrl: "javascript:void 0" })
        },
        {
      ...
      (e.handleCommandMessage = Xc),
      (e.deepCopy = Ae),
      browser.runtime.onMessage.addListener(Xc),
      null == (Yc = browser.commands) ||
        Yc.onCommand.addListener(async (e) => {
          Ts(e, await Ra())
        })
  })()
}
