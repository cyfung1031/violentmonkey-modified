{
  const e = this,
    ...
    O = "isApplied",
    P = "contextualIdentities" in U || "activityLog" in U,
    N = "#" + h,
    W = U.runtime.getURL("/"),
    H = W.slice(0, -1),
  ...
  ;(() => {
    ...
    let $e
    function Ie(e) {
      return null == e ? [] : Array.isArray(e) ? e : `${e}`.split(".").filter(q)
    }
    function Me(e, a) {
    ...
    function Ee(e, a) {
      if (e !== a)
        return e && "object" == typeof e
          ? a && "object" == typeof a
            ? (($e = !1), (e = (Array.isArray(e) ? Oe : Pe)(e, a)), $e ? e : void 0)
            : Ae(e)
          : e
    }
    function Oe(e, a) {
      const t = []
      e.length !== a.length && ($e = !0)
    ...
    function Ma(e, a) {
      ...
      let o = 0,
        i = 0
      for (; o < t.length && i < n.length; ) t[o] === n[i] && (i += 1), (o += 1)
      return i === n.length
    }
    function Da(e, a, t = navigator.languages) {
      const n = I.keys(e)
        .filter((e) => e.startsWith(a + ":"))
        .map((e) => e.slice(a.length + 1))
        .sort((e, a) => a.length - e.length)
      let o
      for (let e = 0; e < t.length; e++) {
        const a = t[e]
        if (((o = n.find((e) => Ma(a, e))), o)) break
      }
      return e[o ? `${a}:${o}` : a] || ""
    }
    function Ca(e) {
    ...
    function _a(e) {
      var a
      return e.custom.name || Da(e.meta, "name") || `#${null != (a = e.props.id) ? a : He("labelNoName")}`
    }
    function Ta(e) {
      var a
    ...
    function Ra(e, a) {
      return `${W}${a && P ? "%20" : ""}${encodeURIComponent((a || _a(e)).replace(va, wa))}.user.js#${e.props.id}`
    }
    function Aa(e, { all: a, allowedOnly: t, enabledOnly: n } = {}) {
    ...
    const Va = {},
      Ga = (e) => I.assign(Va, e),
      Ka = (e) => {
        for (const a in e) (Va[a] = e[a]).isOwn = !0
      }
    let Ja,
      Ya = new M((e) => {
        Ja = () => M.all(Ya.deps).then(e)
      })
    ;(Ya.deps = []), Ya.then(() => (Ya = null))
    const Xa = "scriptTemplate",
      Za = "updateEnabledScriptsOnly",
      Qa = {
      ...
      et = { killTrailingSpaceOnSave: !0, showTrailingSpace: !0, ...Qa },
      at = {
        [O]: !0,
        [pe]: qe,
        [fe]: qe,
    ...
    let tt = browser.storage.local
    class nt {
      constructor(e, a) {
        ;(ft[a] = this), (this.name = e), (this.prefix = a)
      }
      toKey(e) {
      ...
      async remove(e) {
        const a = na(e).filter(q).map(this.toKey, this)
        a.length && (await tt.remove(a))
      }
      async setOne(e, a) {
        if (e) return this.set({ [e]: a })
      }
      async set(e) {
        return await tt.set(this.prefix ? E(Ue, e, null, this.toKey, this) : e), e
      }
    }
    const ot = tt.getKeys,
      it = "cache",
      ...
      bt = kt
    let yt
    Ka({ Storage: ([e, a, ...t]) => kt[e][a](...t) }),
      Ka({
        GetAllOptions: () => I.assign({}, at, vt),
        SetOptions(e) {
          for (const a in e) _t(a, e[a], !0)
          Dt()
        },
      })
    const vt = {},
      ...
      zt = za(),
      jt = Fe(Dt, 100),
      St = Fe(() => bt.base.setOne(wt, vt), 100),
      qt = new Proxy(at, { get: (e, a) => Ut(a) }),
      $t = zt.hook
    function It(e) {
      ;(e = e[wt] || {}),
        I.assign(vt, e),
        ...
        "// ==UserScript==\n// @name New Script\n// @namespace Violentmonkey Scripts\n// @match {{url}}\n// @grant none\n// ==/UserScript==\n" ===
          vt[Xa] && (vt[Xa] = at[Xa]),
        I.keys(vt).map(Tt).some(q) && (delete vt[`${Xa}Edited`], St())
    }
    function Mt(e, a, t) {
      yt ? delete yt[e] : (yt = {}), (yt[e] = a), t || jt()
    }
    function Dt() {
      if (!yt) return
      const e = yt
    ...
    function Ct(e) {
      return Ya ? Ya.then(() => e(qt, !0)) : e(qt, !0), $t(e)
    }
    function Ut(e) {
      var a
      let t = vt[e]
      ...
      const n = Ie(e),
        o = n[0],
        i = null != (a = vt[o]) ? a : Ae(at[o])
      return n.length > 1 ? Me(i, n.slice(1)) : i
    }
    function _t(e, a, t) {
      if (Ya) return Ya.then(_t.bind(null, ...arguments))
      const n = Ie(e),
        o = n[0]
      if (((e = n.join(".")), !L(at, o))) return
      const i = n.length > 1 && n.slice(1),
        s = Ut([o])
      Le(a, i ? Me(s, i) : s) || ((vt[o] = i ? De(s, i, a) : a), Tt(o), St(), Mt(e, a, t))
    }
    function Tt(e) {
      return Le(vt[e], at[e]) && delete vt[e]
    }
    function Rt({ lifetime: e = 3e3, onDispose: a } = {}) {
      let t,
        n,
        o,
        i = I.create(null),
    ...
    $t((e) => ja("UpdateOptions", e))
    const At = Rt({ lifetime: 3e5 })
    Ka({
      CacheLoad: (e) => At.get(e) || null,
      CacheHit(e) {
        At.hit(e.key, e.lifetime)
      },
      CachePop: (e) => At.pop(e) || null,
    })
    const Lt = At,
      Et = new (class {
        constructor(e) {
        ...
        checkType(e) {
          if (this.allowed && !this.allowed.includes(e)) throw new $(`Unknown event type: ${e}`)
        }
        on(e, a) {
          this.checkType(e)
          const { events: t } = this
      ...
      Ot = (e) => `${e < 10 ? "0" : ""}${e}`,
      Pt = (e) => e.getFullYear(),
      Nt = (e) => Math.floor((e - new Date(Pt(e), 0, 1)) / 864e5) + 1,
      Wt = (e) => Math.floor((e - new Date(Pt(e), 0, 1)) / 6048e5) + 1,
      Ht = (e, a) => e.toLocaleString([navigator.language], a),
      Ft = {
        M: (e) => e.getMonth() + 1,
        MM: (e) => Ot(e.getMonth() + 1),
        MMM: (e) => Ht(e, { month: "short" }),
        MMMM: (e) => Ht(e, { month: "long" }),
        Q: (e) => Math.floor(e.getMonth() / 3) + 1,
        D: (e) => e.getDate(),
        DD: (e) => Ot(e.getDate()),
        DDD: Nt,
        DDDD: (e) => {
          return `${((a = Nt(e)) < 10 ? "00" : a < 100 && "0") || ""}${a}`
          var a
        },
        d: (e) => e.getDay(),
        dd: (e) => Ht(e, { weekday: "short" }).slice(0, 2),
        ddd: (e) => Ht(e, { weekday: "short" }),
        dddd: (e) => Ht(e, { weekday: "long" }),
        w: Wt,
        ww: (e) => Ot(Wt(e)),
        Y: Pt,
        YY: (e) => Ot(Pt(e) % 100),
        ...
        HH: (e) => Ot(e.getHours()),
        m: (e) => e.getMinutes(),
        mm: (e) => Ot(e.getMinutes()),
        s: (e) => e.getSeconds(),
        ss: (e) => Ot(e.getSeconds()),
        S: (e) => ("" + +e).slice(-3, -2),
        SS: (e) => ("" + +e).slice(-3, -1),
        SSS: (e) => ("" + +e).slice(-3),
        ZZ: (e) => {
          const a = e.getTimezoneOffset(),
            t = Math.abs(a)
          return `${a < 0 ? "-" : "+"}${Ot(Math.floor(t / 60))}${Ot(Math.floor(t % 60))}`
        },
      }
    let Bt
    function Vt(e, a = new Date()) {
      return (
        Bt ||
          (Bt = new RegExp(
            `${/\[([^[\]]*)]/.source}|${I.keys(Ft)
        ...
        e.replace(Bt, (e, t) => (L(Ft, e) ? Ft[e](a) : null != t ? t : e))
      )
    }
    function Gt(e, a, t) {
    ...
    function Zt(e) {
      ...
      if (!Xt(e.charCodeAt(0)) && 46 !== e.charCodeAt(0) && 95 !== e.charCodeAt(0)) return !1
      let a = -1,
        t = -1
      const n = e.length
      for (let o = 0; o < n; o += 1) {
        ...
        if (46 === n) {
          ...
          a = o
        } else if (!Xt(n) && 45 !== n && 95 !== n) return !1
        t = n
      }
    ...
    function an(e, a, t, n, o) {
      ...
      return "string" != typeof e
        ...
        : (i.extractHostname
            ? i.mixedInputs
              ? (o.hostname = Kt(e, Zt(e)))
              : (o.hostname = Kt(e, !1))
            : (o.hostname = e),
          0 === a || null === o.hostname || (i.detectIp && ((o.isIp = Yt((s = o.hostname)) || Jt(s)), o.isIp))
            ? o
            : i.validateHostname && i.extractHostname && !Zt(o.hostname)
              ? ((o.hostname = null), o)
              : (t(o.hostname, i, o),
                2 === a ||
                  null === o.publicSuffix ||
                  ((o.domain = Gt(o.publicSuffix, o.hostname, i)),
                  3 === a ||
                    null === o.domain ||
                    ((o.subdomain = en(o.hostname, o.domain)),
                    4 === a ||
          ...
          0,
          {
            ...
            io: [
              1,
              {
                ...
                edugit: a,
                telebit: a,
                thingdust: [0, { dev: D, disrec: D, prod: C, testing: D }],
                tickets: a,
                upli: a,
                wedeploy: a,
                editorx: a,
    ...
    function un(e, a = {}) {
      ...
      return (
        ...
        (t.publicSuffix = null),
        (t.subdomain = null),
        an(e, 3, rn, a, ln).domain
      )
    }
    const dn = { allowPrivateDomains: !0 },
      mn = (e) => un(e, dn),
      hn = (e) => cn(e, dn),
      gn = { test: () => 1 },
      pn = Rt({ lifetime: 36e5 }),
      ...
      kn = Rt({ lifetime: 6e4 }),
      bn = Rt({ lifetime: 6e4 }),
      yn = /^(\*|http([s*])?|file|ftp|urn):\/\/([^/]*)\/(.*)/,
      vn = /^(\*|http([s*])?|file|ftp|urn|([^:]*?)(?=:))(:(?:\/(?:\/)?)?)?([^/]*)(?:\/(.*))?/,
      wn = /^([^:]*):\/\/([^/]*)\/(.*)/,
      xn = { [pe]: Fn(), [fe]: Fn() },
      { reset: zn, test: jn } = xn[pe],
      Sn = xn[fe].test
    let qn, $n, In, Mn, Dn, Cn, Un
    Ct((e) => {
      for (const a in xn)
        if (a in e) {
          const t = xn[a].reset(e[a] || []),
            n = t.length ? t : null
          if ((bt.base.setOne(a + "Errors", n), n)) throw n
        }
    })
    class _n {
      constructor(e, a, t, n, o) {
        ...
        ;(this.scheme = i ? "http" : a),
          ...
          (this.host = "*" === n ? null : Wn(n)),
          (this.path = "*" === o ? null : Hn(o))
      }
      test() {
        var e, a
        return (
          (this.scheme === In || this.scheme2 === In) &&
          !1 !== (null == (e = this.host) ? void 0 : e.test(Mn)) &&
          !1 !== (null == (a = this.path) ? void 0 : a.test(Dn))
        )
      }
      static try(e) {
        let a = e.match(yn)
        if (a) return new _n(...a)
        if ("<all_urls>" === e) return gn
        throw (
          ((a = e.match(vn)),
          (a = a
            ? (
    ...
    function Rn(e) {
      pn.batch(e), fn.batch(e), kn.batch(e), bn.batch(e), (qn = Array.isArray(e) && e)
    }
    function An(e) {
      ;($n = e),
        ([, In, Mn, Dn] = e ? e.match(wn) : ["", "", "", ""]),
        (Cn = e ? kn.get(e) || kn.put(e, {}) : null),
        (Un = e ? bn.get(e) || bn.put(e, {}) : null)
    }
    function Ln(e, a) {
      let t, n, o, i
      ...
      return (
        ...
        !(
          (t = (s.origExcludeMatch && r.excludeMatch) || "").length +
            ...
            (i = s.exclude || "").length && En(e, a, t, n, o, i)
        )
      )
    }
    function En(e, a, ...t) {
      ...
      for (let n, o, i, s, r, l, c, u, d = 0; d < 4; d += 1) {
        if ((o = t[d]).length) {
          s || (d < 2 ? ((i = _n.try), (s = pn), (r = Cn)) : ((i = Pn), (s = fn), (r = Un)))
          for (let t = 0, d = o; t < d.length; t++) {
            ...
            if (null == l) {
              ...
              if ((c = n.err)) qn && ((c = c.message || c), (c = e ? `${c} - ${u || (u = Ra(a))}` : c), qn.push(c))
    ...
    function Wn(e) {
      ...
      else if (!a && (t = Tn.try(e, !0))) return t
      a && ((o = o.slice(0, -4)), (i = "(|(?:\\.[-\\w]+)+)"))
      const s = RegExp(`^${n}${On(o)}${i}$`, "i")
      return a && (s.test = Nn), s
    }
    function Hn(e) {
      const a = e.indexOf("?"),
        t = e.indexOf("#", a + 1) >= 0
      return (t && Tn.try(e)) || RegExp(`^${On(e)}${t ? "$" : `($|${a >= 0 ? "#" : "[?#]"})`}`)
    }
    function Fn() {
      let e = {},
        a = 0,
          ...
          for (let e = 0, a = Array.isArray(o) ? o : (o || "").split("\n"); e < a.length; e++) {
            ...
            try {
              ...
              const e = o.startsWith("@") && o.split(/\s/, 1)[0],
                ...
                i = "@include" === e,
                s =
                  ((i || "@exclude" === e) && n(fn, a, Pn)) ||
                  (!e && !a.includes("/") && n(pn, `*://${a}/*`, _n.try)) ||
                  n(pn, a, _n.try)
    ...
    const { userAgent: Bn, userAgentData: Vn } = navigator,
      Gn = Bn.match(/\s(?:Chrom(?:e|ium)|Firefox)\/(\d+[.0-9]*)|$/i)[1],
      Kn = "fullVersionList",
      Jn = { mobile: Vn ? Vn.mobile : Bn.includes("Android") },
      Yn = P ? void 0 : parseFloat(Gn) || 1
    let Xn = P ? parseFloat(Gn) || 1 : void 0
    function Zn(e) {
      ;(e.vivExtData || e.extData) && Qn("Vivaldi")
    }
    function Qn(e) {
      Jn.browserName = e
    }
    Ka({ UA: () => Jn }),
      Ya.deps.push(
        M.all([
          ...
          null == Vn ? void 0 : Vn.getHighEntropyValues([Kn]),
          P ? [] : ba.getAll(),
        ]).then(([{ os: e, arch: a }, { name: t, version: n } = {}, { [Kn]: o } = {}, [i]]) => {
          !n &&
            null != o &&
            o[0] &&
            ([t, n] = o
            ...
            (Jn.os = e),
            Qn(t || "chrome"),
            (Jn.browserVersion = n || Gn),
            (Jn[Kn] = o),
            Xn ? (Xn = parseFloat(n)) : i ? Zn(i) : E(ne, ba.onCreated, Zn)
        })
      )
    const eo = ((e, a, t, n, o) => {
      const i = {},
    ...
    function ao(e, a = Se, t) {
      let n, o
      if (ua(e)) n = e
      else if (((n = ha(e, a)), (o = n ? (n.startsWith(W) || Sn(n)) && "Blacklisted" : "Invalid"), o)) {
    ...
    Ka({
      async Request({ url: e, vet: a, ...t }) {
        const n = a ? ao(e) : e,
          o = ma(n) && !ca.test(n) ? eo : ga,
          i = await o(n, t)
        return "blob" === t[b] && (i.data = await Ha(i)), i
      },
    })
    const to = {},
      no = !P || !(!a.AbortSignal || !ba),
      oo = B + N + "/",
      io = /^(about:(home|newtab)|(chrome|edge):\/\/(newtab\/|startpageshared\/|vivaldi-webui\/startpage))$/,
      so = (e, a, t) => (2 === e && a) || t,
      ro = (e) => (2 === e[v] && e[J]) || e[Y],
      lo = (e) => (+e >= 0 ? { [Y]: +e } : { [J]: e }),
      co = (e) => e.pendingUrl || e.url || "",
      uo = browser.tabs.onUpdated,
      mo = browser.tabs.onRemoved
    let ho,
      go,
      po = /^(https?|file|ftps?):/
    try {
      uo.addListener(Be, { properties: ["status"] }), uo.removeListener(Be)
    } catch (e) {
      uo.addListener = new Proxy(uo.addListener, { apply: (e, a, t) => E(e, a, t[0]) })
    }
    async function fo(e) {
    ...
    async function ko(e, a) {
      ...
      return Va.TabOpen({ url: t }, a)
    }
    async function bo(e) {
      const { url: a, id: t } = await Oa()
      if (po.test(a) && Ln(a, e)) return browser.tabs.reload(t)
    }
    Ka({
      GetTabDomain(e) {
        const a = e && new URL(e).hostname
        return { host: a, domain: (a && mn(a)) || a }
      },
      async OpenEditor(e, a) {
        var t
        return ko(`${h}/${e || `_new/${(null == a || null == (t = a.tab) ? void 0 : t.id) || (await Oa()).id}`}`, a)
      },
      OpenDashboard: ko,
    }),
      Ga({
        async TabOpen({ url: e, active: a = !0, container: t, insert: n = !0, pinned: o }, i = {}) {
          const s = i._removed,
            r = (!s && i.tab) || (await Oa(s && i.tab[Q])) || {},
            l = i.url,
            c = !l || l.startsWith(W),
            { incognito: u } = r,
            d = !u || P || !/^(chrome[-\w]*):/.test(e),
            m = { active: !!a, pinned: !!o }
          let h,
            g = r[Q],
            p = r.cookieStoreId
          if (
            (p &&
              !u &&
              (go || (go = (await browser.cookies.getAllCookieStores())[0].id.split("-")[0]),
              c || 0 === t ? (p = go + "-default") : t > 0 && (p = `${go}-container-${t}`)),
            p && (p = { cookieStoreId: p }),
            /^[-\w]+:/.test(e) || (e = c ? browser.runtime.getURL(e) : ao(e, l)),
            c && e.startsWith(oo) && ba && Ut("editorWindow") && (!p || Xn >= 64))
          ) {
            const t = {
                url: e,
                incognito: d && u,
                ...(Ut("editorWindowSimple") && { type: "popup" }),
                ...(!P && { focused: !!a }),
                ...p,
              },
              n = Ut("editorWindowPos"),
              o = n && "top" in n
            h = ((await ba.create({ ...t, ...n }).catch(o && Be)) || (o && (await ba.create(t)))).tabs[0]
          } else c && d && io.test(co(r)) && (h = await browser.tabs.update(r.id, { url: e, ...m }).catch(Be))
          for (let a = 0; !h && a < 2; a++)
            try {
              ...
              const a = e.message
              if (a.startsWith("Illegal to set private")) p = null
              else if (a.startsWith("No tab")) r.id = null
              else if (a.startsWith("No window")) g = null
              else {
                if (!a.startsWith("Tabs cannot be edited")) throw e
                await Pa(100)
              }
            }
          return (
            a && h[Q] !== g && (await (null == ba ? void 0 : ba.update(h[Q], { focused: !0 }))),
            c || null == r.id || (to[h.id] = r.id),
            c ? h : { id: h.id }
          )
        },
        TabClose({ id: e } = {}, a) {
      ...
      mo.addListener((e) => {
        const a = to[e]
        a >= 0 && (Sa(a, "TabClosed", e), delete to[e])
      }),
      (async () => {
        const e = P || (await new M((e) => U.extension.isAllowedFileSchemeAccess(e)))
        ;(ho = Xn < 68 || (!P && e)),
          (P && [].at) || Yn >= 88 ? (po = e ? /^(https?|file):/ : /^https?:/) : e || (po = /^(ht|f)tps?:/)
      })(),
      Ka({
        async NewScript(e) {
          const a = ((e >= 0 && (await browser.tabs.get(e).catch(Be))) || {}).url,
            t = po.test(a) && `${a.split(/[#?]/)[0]}*`,
            { host: n = "example.org", domain: o } = t ? Va.GetTabDomain(t) : {}
          return Co({ url: t || `*://${n}/*`, name: o || "" })
        },
      }),
      Ct((e, a) => {
        if (!a && Xa in e) {
          const a = [],
            t = e[Xa]
          if ((!t || Io(t, { errors: a }) || a.unshift(He("msgInvalidScript")), a.length)) throw a
        }
      })
    const yo = (e) => !/^\s*</.test(e) && ce.exec(e),
      vo = { default: () => [], transform: (e, a) => (e.push(a), e) },
      wo = { default: () => !1, transform: () => !0 },
      xo = { default: () => null, transform: (e, a) => (null == e ? a : e) },
      zo = {
        include: vo,
        exclude: vo,
        match: vo,
      ...
      jo = { antifeature: vo, compatible: vo, connect: vo, noframes: wo, [xe]: wo, [ze]: wo },
      So = /(?:^|\n)(.*?)\/\/([\x20\t]*)(@\S+)(.*)/g,
      qo = 'Unexpected text before "//" in ',
      $o = 'Expected a single space after "//" in '
    function Io(e, { errors: a, retDefault: t, retMetaStr: n } = {}) {
      const o = E(Ue, zo, (e) => e.default()),
        i = yo(e)
      if (!i) return !!t && o
      let s
      for (a && Mo(i, 1, a); (s = So.exec(i[4])); ) {
        const [e, t] = s[3].slice(1).split(":"),
          ...
          l = zo[i] || jo[i] || xo
        let c = o[i]
        void 0 === c && (c = l.default()), a && Mo(s, 0, a), (o[i] = l.transform(c, r))
      }
      return a && Mo(i, 5, a), (o.resources = o.resource), delete o.resource, n && (o[ve] = i[0]), o
    }
    function Mo(e, a, t) {
      let n
      e[a + 1].match(/\S/) && t.push(qo + (n = Do(e[a], 50))), " " !== e[a + 2] && t.push($o + (n || Do(e[a], 50)))
    }
    function Do(e, a) {
    ...
    function Co(e) {
      const a = { url: "*://*/*", name: "", ...e },
        t = (Ut(Xa) || at[Xa]).replace(/{{(\w+)(?::(.+?))?}}/g, (e, t, n) => {
          var o
          return null != (o = a[t]) ? o : "date" !== t ? e : n ? Vt(n) : new Date().toLocaleString()
        })
      return {
        script: {
          custom: { origInclude: !0, origExclude: !0, origMatch: !0, origExcludeMatch: !0 },
          config: { enabled: 1, shouldUpdate: 1 },
          meta: Io(t, { retDefault: !0 }),
          props: {},
        },
        code: t,
      }
      ...
      return (
        a ||
          ...
          (a =
            ...
            La(a).replace(/^https?(:\/\/userscripts)(\.org\/users\/\w)/, "https$1-mirror$2"))),
        a
      )
    }
    function To(e, a = Ca(e)) {
      let t =
        a &&
        a.match(
    ...
    function Ro(e) {
      if (!e || L(e, se)) return
      let a, t
      !(a = Ca(e)) && (a = _o(e)) && ((t || (t = {}))[re] = a),
        !Ua(e) && (a = To(e, a)) && ((t || (t = {}))[le] = a),
        (e[se] = t)
    }
    const Ao = {}
    let Lo,
    ...
    function Oo(e, a) {
      null == e && (Eo = {}),
        E(_e, Ao, ([t, n]) => {
          const o = n[e]
          o && (a ? (delete o[a], ta(o) && delete n[e]) : delete n[e]), (null == e || ta(n)) && delete Ao[t]
        })
    }
    async function Po(e, a, t) {
      const n = +e[0] && (await bt[gt].getMulti(e))
      for (let o = 0; o < e.length; o++) {
        const i = e[o],
          s = n ? i : i.id,
          r = n ? n[s] || null : i[g]
        r ? De(Ao, [s, a, t], I.assign({}, r)) : delete Ao[s]
      }
    }
    function No(e, a) {
    ...
    function Wo(e, a) {
      var t
      ;(a || bt[gt]).set(e, !!a), (Lo = (null == (t = Lo) ? void 0 : t.catch(console.warn).then(Ho)) || Ho())
    }
    async function Ho() {
      const e = {}
      let a = 0
      ...
      for (let t = 0, n = I.entries(e); t < n.length; t++) {
        ...
        for (let t = 0, n = I.entries(o); t < n.length; t++) {
          const [o, i] = n[t]
          ta(i) || (Sa(+e, "UpdatedValues", i, lo(o)), ++a % 20 || (await Pa()))
        }
      }
      Lo = null
    }
    ...
    Ka({
      async GetValueStore(e, { tab: a }) {
        const t = We(We(Ao, e), a.id)
        return t[0] || (t[0] = await bt[gt].getOne(e))
      },
      SetValueStores(e) {
        const a = {}
        E(_e, e, ([e, t = {}]) => {
          var n
          ;(e = null == (n = $i({ id: +e, uri: e })) ? void 0 : n.props.id) && ((a[pt + e] = t), (Eo[e] = t))
        }),
          Wo(a, ni)
      },
    }),
            ...
            !(e =
              null == (a = e)
                ...
                : a.filter((e) => {
                    const a = Yo.get(e),
                      n = void 0 !== a
                    return n && (t[e] = Ae(a)), !n && 0 !== Xo.get(e)
                  })) || e.length)
          ) {
            var n
            let a
            e || (a = 5e3),
              E(_e, await Zo.get(e), ([e, n]) => {
                ;(t[e] = n), Xo.set(e, 1), Yo.put(e, Ae(n), a), xi(e, n)
              }),
              null == (n = e) || n.forEach((e) => Xo.set(e, +L(t, e)))
          }
          return Yo.batch(!1), t
        },
        async set(e, a) {
          ...
          Yo.batch(!0),
            E(_e, e, ([e, o]) => {
              const i = Ee(o, Yo.get(e))
              if (void 0 !== i) {
                if ((Yo.put(e, i), Xo.set(e, 1), n.push(e), Bo)) return void (t[e] = o)
                !a && e.startsWith(pt)
                  ? (Vo[e] = i)
                  : ((t[e] = o), xi(e, o) && o[se] && delete (t[e] = { ...o })[se], ii(e, o))
              }
            }),
            Yo.batch(!1),
            ta(t) || (await Zo.set(t)),
            Bo || (n.length && ei(n, e), ri())
        },
        async remove(e) {
          const a = e.filter((e) => {
            let a = 0 !== Xo.get(e)
            if (a) {
              if ((Yo.del(e), Xo.set(e, 0), Bo)) return a
              bt[gt].toId(e) ? ((Vo[e] = null), (a = !1)) : (xi(e), ii(e))
            }
            return a
          })
          a.length && (await Zo.remove(a)), Bo || (e.length && ei(e), ri())
        },
      })
    function oi(e, a, t = !0) {
      t && !Go && (Go = {}),
        E(_e, a, ([a, n]) => {
          ...
          for (let a = 0, i = na(n); a < i.length; a++) {
            const n = o + i[a],
              s = Go[n] || (t && (Go[n] = [])),
              r = s ? s.indexOf(e) : -1
            r >= 0 && !t ? (s.splice(r, 1), s.length || delete Go[n]) : r < 0 && t && s.push(e)
          }
        }),
        ta(Go) && (Go = null)
    }
    async function ii(e, a) {
      const t = ki.exec(e)
      t && t[0] !== ht && 2 === (mi[e] = Ne(a)) && t[0] === pt && (mi[e] = 0)
    }
    async function si() {
      const e = I.keys(Vo),
        a = [],
      ...
      ;(Vo = {}),
        ...
        e.forEach((e) => {
          const n = t[e]
          n || (delete t[e], a.push(e)), ii(e, n)
        }),
        ta(t) || (await Zo.set(t)),
        a.length && (await Zo.remove(a)),
        Go && setTimeout(li, 0, t, a)
    }
    function ri() {
      Ko || ta(Vo) || (Ko = setTimeout(si, Math.min(1e3, 100 * Math.max(1, Ne(Vo) / 1e6))))
    }
    function li(e, a) {
      const t = new Map()
      let n, o
      for (const i in Go)
        if ((n = e[i]) || a.includes(i))
          for (let e = 0, a = Go[i]; e < a.length; e++) {
            const s = a[e]
    ...
    setInterval(() => {
      ...
      browser.runtime.onConnect.addListener((e) => {
        if ("undoImport" === e.name) return ci(e)
        if (!e.name.startsWith(me)) return
        const { id: a, cfg: t, tabId: n } = JSON.parse(e.name.slice(12)),
          o = a ? Jo[a] : e.postMessage.bind(e)
        oi(o, t),
          e.onDisconnect.addListener(() => {
            Oo(n), oi(o, t, !1), delete Jo[a]
          })
      })
    let ui = 0,
      di = 0,
    ...
    function xi(e, a) {
      const t = +bt[mt].toId(e)
      if (t) {
        if (a) {
          const e = hi[t],
            n = gi.indexOf(e),
            o = pi.indexOf(e)
          n >= 0 && (gi[n] = a), o >= 0 && (pi[o] = a), (hi[t] = a)
        } else delete hi[t]
        return !0
      }
    }
    async function zi() {
      const e = gi.reduce((e, a, t) => {
        const { props: n } = a,
          o = t + 1
        return n.position !== o && ((n.position = o), ((e || (e = {}))[n.id] = a)), e
      }, null)
      return (di = gi.length), e && (await bt[mt].set(e), _t("lastModified", Date.now())), !!e
    }
    async function ji() {
      gi.sort((e, a) => vi(e.props.position) - vi(a.props.position))
      const e = await zi()
    ...
    function qi(e) {
      var a
      return null != (a = null == e ? void 0 : e.map(Si)) ? a : [...gi, ...pi]
    }
    function $i({ id: e, uri: a, meta: t, removed: n }) {
      let o
      return (
        e
          ? (o = Si(e))
          : (a || (a = Uo({ meta: t, props: { id: "@@should-have-name" } })),
            (o = (n ? pi : gi).find(({ props: e }) => a === e.uri))),
        o
      )
    }
    function Ii() {
    ...
    Ga({
      ...
      Ka({
        ...
        RemoveScripts: Gi,
        GetData: Wi,
        GetMoreIds: ({ url: e, [v]: a, [r]: t }) => Ei(e, a, null, t),
        GetScript: $i,
        GetSizes: Fi,
        async ExportZip({ values: e }) {
          const a = Ii(),
            t = a.map(wi),
            n = await bt[rt].getMulti(t)
          return {
            items: a.map((e) => ({ script: e, code: n[e.props.id] })),
            values: e ? await bt[gt].getMulti(t) : void 0,
          }
        },
        GetScriptCode: (e) => bt[rt][Array.isArray(e) ? "getMulti" : "getOne"](e),
        async MarkRemoved({ id: e, removed: a }) {
          if (!a && $i({ meta: Si(e).meta })) throw He("msgNamespaceConflictRestore")
          await Yi(e, { config: { removed: a ? 1 : 0 }, props: { lastModified: Date.now() } })
          const t = a ? gi : pi,
        ...
        Move({ id: e, offset: a }) {
          const t = Si(e),
            n = gi.indexOf(t)
          return gi.splice(n, 1), gi.splice(n + a, 0, t), zi()
        },
        ParseMeta: Xi,
        ParseMetaErrors: (e) => Xi(e).errors,
        ParseScript: Zi,
        UpdateScriptInfo: ({ id: e, config: a, custom: t }) =>
          Yi(e, { config: a, custom: t, props: { lastModified: Date.now() } }),
        Vacuum: is,
      }),
      (async () => {
        let e, a
        ot && ((e = await ot()), (a = e.filter((e) => (Xo.set(e, 1), e.startsWith(ht)))), a.push(wt))
        const o = (!ot || Xo.has(xt)) && (await bt.base.getOne(xt)),
          i = "2.31.0"
        o ||
          (await new M((e, a) => {
            const n = { origInclude: !0, origExclude: !0, origMatch: !0, origExcludeMatch: !0 }
            function o(t) {
              const n = t.transaction([h, ut, it, g]),
                o = {}
              let s = 3
              const r = () => {
                  ;(s -= 1), s || e(bt.base.set(o))
                },
                l = (e, t) => {
              ...
              l(h, (e) => {
                ...
                e.forEach((e) => {
                  ...
                  ;(o[bt[mt].toKey(n)] = i(e)), (o[bt[rt].toKey(n)] = t), (a[s] = n)
                }),
                  l(g, (e) => {
                    e.forEach(({ uri: e, [g]: t }) => {
                      const n = a[e]
          ...
          i !== o && bt.base.set({ [xt]: i })
        const s = await bt.base.getMulti(a),
          r = {},
        ...
        E(_e, s, ([e, a]) => {
          ...
          if (t && a) {
            const e = Uo(a)
            if (!a.config.removed) {
              if (hi[t] && hi[t] !== a) return
              if (r[e]) return
              r[e] = a
            }
            a.props = { ...a.props, id: t, uri: e }
            const { pathMap: n } = (a.custom = I.assign({}, l, a.custom))
            if (n) for (const e in n) ua(e) && delete n[e]
            ;(ui = Math.max(ui, t)), (di = Math.max(di, vi(a.props.position))), (a.config.removed ? pi : gi).push(a)
            const { meta: o = (a.meta = {}) } = a
            o.require || (o.require = []),
              o.resources || (o.resources = {}),
              xe in o && (o[xe] = !0),
              (o.grant = [...new Set(o.grant || [])])
          }
        }),
          It(s),
          i !== o && P && Ut("defaultInjectInto") === d && ea(o, "2.12.7") <= 0 && _t("defaultInjectInto", n),
          ji(),
          setTimeout(async () => {
            var t
            if (null != (t = e) && t.length) {
              const t = new Set(a),
                n = await bt.base.getMulti(e.filter((e) => !t.has(e)))
              I.assign(s, n)
            }
            is(s)
          }, 100),
    ...
    const Mi = "cacheKeys",
      ...
      Ui = "promise",
      _i = () => ({ depsMap: {}, [m]: {}, [h]: [] }),
      Ti = /^GM[_.](listValues|([gs]et|delete)Values?)$/,
      Ri = { [it]: Mi, [rt]: r, [ut]: Di, [gt]: Ci },
      Ai = I.entries(Ri),
      Li = new Set()
    function Ei(e, a, t, n) {
      if (jn(e)) return
      ...
      for (let t = 0; t < gi.length; t++) {
        ...
        if ((n ? k in n : !g) || (!a && (null != (d = p.noframes) ? d : f.noframes)) || !Ln(e, i)) continue
        if (n) {
          o[k] = g ? u : 0
          continue
        }
        ...
        const { pathMap: b = Qi(i) } = p,
          y = Ta(i),
          v = "start" === y || "body" === y ? s : l,
          { depsMap: w } = v
        if ((v[r].push(k), (v[m][k] = y), f.grant.some(Ti.test, Ti) && v[Ci].push(k), !c))
      ...
      return (
        ...
        n
          ...
          : s
            ? i
              ? ((l[Ui] = Oi(l)), l)
              : (s[r].length && (s[Ui] = Oi(s)),
                l[r].length && (l[Ui] = Pa().then(Oi.bind(null, l))),
    ...
    async function Oi(e) {
      ...
      const t = await bt.base.getMulti(a),
        n = new Set()
      for (let a = 0; a < Ai.length; a++) {
        const [i, s] = Ai[a]
        for (let a = 0, r = e[s]; a < r.length; a++) {
          const s = r[a]
          let l = t[bt[i].toKey(s)]
          var o
          l || i !== gt || (l = {}),
            (e[i][s] = l),
            null == l && (i === rt ? n.add(s) : null == (o = e.depsMap[s]) || o.forEach((e) => n.add(e)))
        }
      }
      return n.size && Pi(n), e
    }
    function Pi(e) {
      const a = [],
        t = He("msgMissingResources")
      let n,
        o = He("msgReinstallScripts"),
        i = o
      e.forEach((e) => {
        ;(n = `\n#${e}: ${_a(Si(e))}`), (o += n), Li.has(e) || (Li.add(e), a.push(e), (i += n))
      }),
        console.error(`${t} ${o}`),
        a.length && Ni(t, i, a)
    }
    function Ni(e, a, t) {
      Va.Notification({
        ...
        text: a,
        onclick() {
          t.forEach((e) => Va.OpenEditor(e))
        },
      })
    }
    async function Wi({ id: e, ids: a, sizes: t }) {
      e && (a = [e])
      const n = {},
        o = a ? qi(a).filter(q) : qi()
      return (
        o.forEach(Ro),
        (n[h] = o),
        t && (n.sizes = Fi(a)),
        e || (n.cache = await Hi(o)),
        !e && t && (n.sync = Va.SyncGetStates()),
        n
      )
    }
    async function Hi(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        let { custom: o, meta: i } = e[n],
          s = o.icon || i.icon
        da(s) && ((s = o.pathMap[s] || s), a.push(s), ti(st + s) || t.push(s))
      }
      t.length && (await bt[it].getMulti(t))
      for (let e, t, o = 0; o < a.length; o++) (t = a[o]), (e = gs(t)), (!j(e) || (!o && (e = await e))) && (n[t] = e)
      return n
    }
    function Fi(e) {
      const a = qi(e)
      return a.map(({ meta: e, custom: { pathMap: t = {} }, props: { id: n } }, o) => [
        ...
        Ne(a[o]),
        mi[pt + n] || 0,
        e.require.reduce(Bi, { len: 0, pathMap: t }).len,
        I.values(e.resources).reduce(Vi, { len: 0, pathMap: t }).len,
      ])
    }
    function Bi(e, a) {
      return (e.len += (mi[dt + (e.pathMap[a] || a)] || 0) + a.length), e
    }
    function Vi(e, a) {
      return (e.len += (mi[st + (e.pathMap[a] || a)] || 0) + a.length), e
    }
    async function Gi(e) {
      const a = [],
        t =
          ...
          pi.reduce((t, n, o) => {
            const i = wi(n)
            return e.includes(i) ? (a.push(lt + i, ht + i, pt + i), delete hi[i]) : ++t < o && (pi[t] = n), t
          }, -1)
      if (pi.length !== t) return (pi.length = t), await bt.base.remove(a), ja("RemoveScripts", e)
    }
    function Ki({ force: e } = {}) {
      const a = Date.now(),
        t = pi
          .filter((t) => {
            ...
            return t.config.removed && (e || a - vi(n) > 6048e5)
          })
          .map((e) => e.props.id)
      return Gi(t)
    }
    const Ji = crypto.randomUUID
    ...
    function Xi(e) {
      const a = j(e),
        ...
        n = [],
        o = Io(a ? e.code : e, { errors: n })
      return (
        o ? (Rn(n), Ln("", { meta: o, custom: t }), Rn()) : n.push(He("labelNoName")),
        { meta: o, errors: n.length ? n : null }
      )
    }
    async function Zi(e) {
      var a
      const { meta: t, errors: n } = e.meta ? e : Xi(e)
      if (!t.name) throw `${He("msgInvalidScript")}\n${He("labelNoName")}`
      const o = { message: null == e.message ? He("msgUpdated") : e.message || "" },
        i = { errors: n, update: o },
        { [rt]: s, update: r } = e,
        l = Date.now()
      let c,
      ...
      d
        ...
        : (({ script: c } = Co()),
          ...
          (u = c.props.id = ui),
          (i.isNew = !0),
          (o.message = He("msgInstalled")),
          gi.push(c))
      const { config: m, custom: h, props: g } = c,
        p = Uo({ meta: t, props: { id: u } })
      if (d) {
        if (e.isNew || (u && gi.some(({ props: e }) => p === e.uri && u !== e.id))) throw He("msgNamespaceConflict")
        delete c[se]
      }
      ;(g.lastModified = l), (g.uuid = g.uuid || Ji())
      ...
      const f = +e.position
      f ? ((g.position = f), (di = Math.max(di, f))) : d || (di++, (g.position = di)),
        (m.enabled = vi(m.enabled)),
        (m.removed = 0),
        (m.shouldUpdate = vi(m.shouldUpdate)),
        (c.meta = t),
        (g.uri = Uo(c)),
        delete h.from,
        !Ca(c) && ma(e.from) && (h.from = e.from),
        da(e.url) && (h.lastInstallURL = e.url),
        (h.tags = null == (a = h.tags) ? void 0 : a.split(/\s+/).map(pa).filter(q).join(" ").toLowerCase()),
        r || bt.mod.remove(Aa(c, { all: !0 }) || []),
        Qi(c, e.url)
      const k = es(c, e),
        b = !d || s !== (await bt[rt].getOne(u))
      return (
        b && e.bumpDate && (g.lastUpdated = l),
        e.cache && (await k),
        await bt.base.set({ [ht + u]: c, ...(b && { [lt + u]: s }) }),
        I.assign(o, c, r),
        (i.where = { id: u }),
        (i[rt] = e[rt]),
        ja("UpdateScript", i),
        Et.emit("scriptChanged", i),
        e.reloadTab && bo(c),
        i
      )
    }
    ...
    async function es(e, a) {
      ...
      for (const e in i) r.push([it, i[e]])
      ma(s) && r.push([it, s, fi])
        ...
        ([e, t, n] = r[s]),
          (i = bi[e][t]) ||
            (t &&
              ...
              (i = a[e]) && null != (i = i[t])
                ? (bt[e].setOne(t, i), (i = ""))
                : ((i = as(a, e, t)), n && (i = M.race([i, Pa(n)])), (bi[e][t] = i)))),
          (r[s] = i)
      const l = await M.all(r),
        c = E(Na, l.map(ns), "\n")
      if (c) {
        const a = He("msgErrorFetchingResource")
        return ja("UpdateScript", { update: { error: c, message: a }, where: { id: wi(e) } }), `${a}\n${c}`
      }
    }
    async function as(e, a, t) {
      if ((!e.reuseDeps && !ma(t)) || e.update || null == (await bt[a].getOne(t))) {
        const { portId: n } = e
        n && ts(yi, n, [t])
        try {
          await bt[a].fetch(t, e[je])
        } catch (e) {
          return e
        } finally {
          n && ts(yi, n, [t, !0]), delete bi[a][t]
        }
      }
    }
    function ts(e, a, t) {
    ...
    function ns(e) {
      return (e && E(Na, [e.status && `HTTP${e.status}`, e.url], " ")) || e
    }
    let os
    async function is(e) {
      if (os) return os
          ...
          l < 0
            ? ((r[s] = 1),
              ...
              a === pt
                ...
                : a !== ct && (n[s] = Ne(e[s]) + s.length))
            : l || c.includes(a) || (r[s] = 2 + o)
        }
      return (
        e || (e = await bt.base.getMulti()),
        E(Te, e, (e) => {
          l.test(e) && (r[e] = -1)
        }),
        (mi = n),
        qi().forEach((e) => {
          const { meta: a, props: t } = e,
            ...
            { id: o } = t,
            i = e.custom.pathMap || Qi(e),
            s = Aa(e, { all: !0 })
          s && (s.forEach((e) => d(ct, e, o)), (u[o] = s[0])),
            d(lt, o, o),
            d(pt, o, o),
            a.require.forEach((e) => d(dt, e, o, i)),
            E(Re, a.resources, (e) => d(st, e, o, i)),
            ma(n) && d(st, n, o, i)
        }),
        E(_e, r, ([e, a]) => {
          if (a < 0) s.push(e)
            ...
            const n = bt.forKey(e),
              ...
              r = n.name === rt ? u[o] : o
            t
              ? t.push(r || (+o && Ra(Si(o))) || e)
              : r && n.fetch && (s.push(ct + r), i.push(n.fetch(r).catch((e) => `${_a(Si(+o || a - 2))}: ${ns(e)}`)))
          }
        }),
        s.length && (await bt.base.remove(s), (o.errors = (await M.all(i)).filter(q))),
    ...
    const ss = {},
      rs = (e) => "SetPopup" + e
    async function ls(e, a, t) {
      e[u] = !0
      const n = e[r],
        o = Ei(a.url, a[v], null, n)
      if ((I.assign(n, o), I.assign(e, await Wi({ [r]: I.keys(n) })), (e = [e, a]), !t)) return e
      ;(Lt.get(t) || Lt.put(t, {}))[a[Y]] = e
    }
    ...
    Ka({
      async InitPopup() {
        ...
        let i = Ls(a, o, ""),
          ...
          l = Lt.pop(rs(t))
        return (
          s && (l ? !l[0] : (l = {})) && (l[0] = await ls({ [r]: {}, menus: {} }, { tab: e, url: a, [Y]: 0, [v]: 1 })),
          i[0] ||
            null != o[X] ||
            ((await cs(t, o))
              ? s && (s = l[0][0])[h].length && ((i = [He("failureReasonRestarted"), O]), (s[c] = "off"))
              : (i = Ls(""))),
          (n.tab = e),
          [l, n, i]
        )
      ...
      browser.webRequest.onBeforeRequest.addListener(
        () => {
          Oa().then((e) => e && us(e.id, !0))
        },
        { urls: [U.runtime.getURL(F[K].default_popup)], types: ["main_frame"] }
      )
    const ds = Xn ? (Jn.mobile ? [32, 38, 48] : [16, 32, 48, 64]) : [16, 32],
      ms = {},
      hs = {},
      gs = (e) => ms[e] || (ms[e] = Os(e)),
      ps = (() => {
        ...
        return Ce(e, ["setIcon", "setBadgeText", "setBadgeBackgroundColor", "setTitle"], (e) => (e ? a(e) : Be))
      })(),
      fs = U.contextMenus,
      ks = {},
      bs = "showBadge",
      ys = "badgeColor",
      vs = "badgeColorBlocked",
      ws = He("failureReasonBlacklisted"),
      xs = F[K].default_title,
      zs = F[K].default_icon[16].match(/\d+(\w*)\./)[1],
      js = He("menuScriptDisabled"),
      Ss = He("failureReasonNoninjectable"),
      qs = He("skipScriptsMsg")
    let $s, Is, Ms, Ds
    function Cs(e, a) {
      var t
      const n = We(ks, e)
      return (
        ...
        (n[Y] = void 0),
        (n[X] = a),
        a || null == (t = ss[e]) || t.postMessage(null),
        n
      )
    }
    function Us(e, a, { tab: t, [Y]: n, [v]: o }) {
      const i = t.id,
        s = e === x || "off" === e ? e : !!e,
        l = (!(a && o) && ks[i]) || Cs(i, s)
      if (Array.isArray(e)) {
      ...
      o && (l[X] = s), Ts(t, l), Rs(t, l)
    }
    function _s({ id: e }, a = ks[e]) {
      a && ps.setBadgeText({ text: `${a[Is] || ""}`, tabId: e })
    }
    function Ts({ id: e }, a = ks[e]) {
      a && ps.setBadgeBackgroundColor({ color: a[X] ? Ms : Ds, tabId: e })
    }
    function Rs(e, a, t) {
      const n = e.id
      a || (a = ks[n] || Cs(n)), t || ([t] = Ls(co(e), a)), ps.setTitle({ tabId: n, title: t }), As(e, a), _s(e, a)
    }
    async function As({ id: e } = {}, a = ks[e] || {}) {
      const t = $s ? (!0 !== a[X] ? "b" : "") : "w"
      if (a.icon === t) return
      a.icon = t
      const n = {},
      ...
      for (let e = 0; e < ds.length; e++) {
        const a = ds[e],
          i = `${V}${a}${t}.png`
        ;(n[a] = i), (o[a] = hs[i] || ((await (ms[i] || (ms[i] = Os(i)))) && hs[i]))
      }
      ps.setIcon({ tabId: e, path: n, imageData: o })
    }
    function Ls(e, a, t = xs) {
      return po.test(e)
        ? (e = jn(e))
          ? [ws, "blacklisted", e]
          : $s && "off" !== (null == a ? void 0 : a[X])
            ? a
              ? a[X] === x
                ? [qs, x]
                : [t]
    ...
    function Es(e, a) {
      ...
      else if ("dashboard" === e) ko("")
      else if ("newScript" === e) Va.OpenEditor()
      else if ("toggleInjection" === e) _t(O, !$s)
      else if ("updateScripts" === e) Va.CheckUpdate()
      else if ("updateScriptsInTab" === e) {
        var t
        ;(e = null == (t = ks[a.id]) ? void 0 : t[r]) && Va.CheckUpdate([...e])
      } else e.startsWith(bs) && _t(bs, e.slice(10))
    }
    async function Os(e) {
      const a = new Image(),
        t = e.startsWith(V)
      let n
      ;(a.src = t ? e.slice(H.length) : e.startsWith("data:") ? e : Wa("i" === e[0] ? e : await Ps(e)) || e),
        await new M((e) => {
          ;(a.onload = e), (a.onerror = e)
        })
      let o = !t && 76,
        { width: i, height: s } = a
      if (!i || !s) return (ms[e] = e), e
      o && (i > o || s > o) && ((o /= i > s ? i : s), (i = Math.round(i * o)), (s = Math.round(s * o)))
      const r = document.createElement("canvas"),
        l = r.getContext("2d")
      ;(r.width = i), (r.height = s), l.drawImage(a, 0, 0, i, s)
      try {
        ;(n = r.toDataURL()), t && (hs[e] = l.getImageData(0, 0, i, s))
      } catch (a) {
        n = e
      }
      return (ms[e] = n), n
    ...
    async function Ps(e) {
      var a
      return null != (a = await bt[it].getOne(e)) ? a : await bt[it].fetch(e, "res").catch(console.warn)
    }
    function Ns() {
      const e = {}
      return {
    ...
    Ka({ GetImageData: gs }),
      $t((e) => {
        let a
        const t = []
        null != (a = e[O]) && (($s = a), As(), t.push(As)),
          null != (a = e[bs]) && ((Is = a), t.push(_s), null == fs || fs.update(bs + ":" + Is, { checked: !0 })),
          (((a = e[ys]) && (Ms = a)) || ((a = e[vs]) && (Ds = a))) && t.push(Ts),
          pe in e && t.push(Rs),
          t.length && fo((e) => t.forEach((a) => a(e)))
      }),
      Ya.then(async () => {
        if ((($s = Ut(O)), (Is = Ut(bs)), (Ms = Ut(ys)), (Ds = Ut(vs)), fo(Rs), $s || As(), fs)) {
          const e = (e, a, t) => new M((n) => fs.create({ contexts: [K], id: e, title: a, ...t }, n)).then(ka),
            a = { parentId: bs, type: "radio" }
          await e(x, He("skipScripts"))
          for (
            let t = 0,
              n = [
                [bs, He("labelBadge")],
                [`${bs}:`, He("labelBadgeNone"), a],
                [`${bs}:unique`, He("labelBadgeUnique"), a],
                [`${bs}:total`, He("labelBadgeTotal"), a],
              ];
            t < n.length;
            t++
          ) {
          ...
          fs.update(bs + ":" + Is, { checked: !0 }), P && (await e(G, He("labelSettings")))
        }
      }),
      null == fs ||
        fs.onClicked.addListener(({ menuItemId: e }, a) => {
          Es(e, a)
        }),
      mo.addListener((e) => delete ks[e]),
      uo.addListener(
        (e, { url: a }, t) => {
          if (a) {
            const [n] = Ls(a)
        ...
        Xn && { properties: ["status"] }
      )
    const Ws = {
        update: Zi,
        list: async () => Ii(),
        get: Va.GetScriptCode,
        remove: (e) => Va.MarkRemoved({ id: e, removed: !0 }),
      },
      Hs = [],
      Fs = [],
      Bs = {},
      ...
      return (
        ...
        })(),
        {
          get: (e, a) => {
            var t
            const n = Ie(e)
            return n.unshift("sync"), null != (t = Ut(n)) ? t : a
          },
          set: e,
        }
      )
    ...
    function tr(e, a, t) {
      ...
      return (
        2 === a
          ? (n = { version: a, custom: e.custom, config: e.config, props: Ce(e.props, ["lastUpdated"]) })
          : 1 === a &&
            (n = {
              version: a,
              more: {
        ...
        ;(a.code = t.code),
          2 === t.version
            ...
            : 1 === t.version &&
              ...
              (a.config = or({ enabled: t.more.enabled, shouldUpdate: t.more.update })),
              (a.props = or({ lastUpdated: t.more.lastUpdated })))
      } catch (t) {
        a.code = e
      }
      return a
    ...
    function ir(e) {
      ...
      return (a.prototype = e), (a.extend = sr), a
    }
    function sr(e) {
      return ir(I.assign(I.create(this.prototype), e))
    }
    const rr = Fe(() => {
        ja("UpdateSync", ar())
      }),
      lr = ir({
        ...
        initialize() {
          ;(this.progress = { finished: 0, total: 0 }),
            (this.config = Qs(this.name)),
            (this.authState = er(
              ["idle", "no-auth", "initializing", "authorizing", "authorized", "unauthorized", "error"],
              null,
              rr
            )),
            (this.syncState = er(["idle", "ready", "syncing", "error"], null, rr)),
        ...
        syncFactory() {
          let e, a
          const t = () => this.authState.is("authorized") && ur() === this.name,
            n = () => {
        ...
        loadData(e) {
          ...
          return (
            t &&
              ((n = this.lastFetch.then((e) => Pa(t - (Date.now() - e))).then(() => Date.now())), (this.lastFetch = n)),
            (a.total += 1),
            rr(),
            n
              .then(() => {
                var a
                ;(e = I.assign({}, ye, e)).headers = I.assign({}, this.headers, e.headers)
                let { url: t } = e
              ...
              .then(({ data: e, error: t }) => ((a.finished += 1), rr(), t ? M.reject(t) : e))
          )
        },
        getLocalData: () => Ws.list(),
        getSyncData() {
                ...
                const b = [
                  ...h.map(
                    ({ remote: e, info: a }) => (
                      ...
                      this.get(e).then((e) => {
                        const t = nr(e)
                        if (!t.code) return
                        a.modified && De(t, "props.lastModified", a.modified)
                        const n = +a.position
                        return (
                          n && (t.position = n),
                          !Ut("syncScriptStatus") && t.config && delete t.config.enabled,
                          Ws.update(t)
                        )
                      })
                    )
                  ...
                  ...g.map(
                    ({ local: e, remote: a }) => (
                      ...
                      Ws.get(e.props.id).then((t) => {
                        const o = tr(e, 1, { code: t })
                        return (
                  ...
                  ...f.map(({ local: e }) => (this.log("Remove local script:", e.props.uri), Ws.remove(e.props.id))),
                  ...k.map(({ local: e, info: a }) => {
                    const t = {}
                    return a.position && (t.props = { position: a.position }), Yi(e.props.id, t)
                  }),
                ]
                return (
                  b.push(
    ...
    function hr() {
      const e = dr()
      return e && M.resolve(mr(e)).then(Vs)
    }
    let gr
    async function pr(e, a) {
      ...
      const t = (await browser.tabs.create({ url: e })).id,
        n = (e) => {
          var a, n
          if (null != (a = (n = dr()).checkAuth) && a.call(n, e.url))
            return browser.tabs.remove(t), setTimeout(gr, 0), { cancel: !0 }
        }
      ;(gr = () => {
    ...
    async function kr(e) {
      ...
      return btoa(Ke(t)).replace(/[+/=]/g, (e) => fr[e] || "")
    }
    function br() {
      return Ve(43, 128)
    }
    async function yr(e) {
      return { code_challenge: await kr(e), code_challenge_method: "S256" }
    }
    const vr = { client_id: "f0q12zup2uys5w8", redirect_uri: Se + "auth_dropbox.html" },
      wr = /[\u007f-\uffff]/g,
      xr = (e) => `\\u${(e.charCodeAt(0) + 65536).toString(16).slice(1)}`
    function zr(e) {
      return JSON.stringify(e).replace(wr, xr)
    }
    function jr(e) {
      return { name: e.name, size: e.size, uri: Xs(e.name) }
    }
    cr(
      lr.extend({
        name: "dropbox",
        ...
        list() {
          return this.loadData({
            ...
            body: { path: "" },
            responseType: "json",
          }).then((e) => e.entries.filter((e) => "file" === e[".tag"] && Ys(e.name)).map(jr))
        },
        get(e) {
          const a = Js(e)
          return this.loadData({
            ...
            headers: { "Dropbox-API-Arg": zr({ path: `/${a}` }) },
          })
        },
        put(e, a) {
          const t = Js(e)
          return this.loadData({
            ...
            headers: {
              "Dropbox-API-Arg": zr({ path: `/${t}`, mode: "overwrite" }),
        ...
        async authorize() {
          ;(this.session = { state: Ge(), codeVerifier: br() }),
            pr(
              `https://www.dropbox.com/oauth2/authorize?${Ba({ response_type: "code", token_access_type: "offline", client_id: vr.client_id, redirect_uri: vr.redirect_uri, state: this.session.state, ...(await yr(this.session.codeVerifier)) })}`,
              vr.redirect_uri
            )
        },
        async authorized(e) {
          ...
          const a = await this.loadData({
            ...
            body: Ba({ client_id: vr.client_id, ...e }),
            responseType: "json",
          })
        ...
        checkAuth(e) {
          const a = `${vr.redirect_uri}?`
          if (!e.startsWith(a)) return
          const t = Fa(e.slice(a.length)),
      ...
      lr.extend({
        ...
        list() {
          return this.loadData({ url: "/drive/special/approot/children", responseType: "json" }).then((e) =>
            e.value.filter((e) => e.file && Ys(e.name)).map(qr)
          )
        },
        get(e) {
          const a = Js(e)
        ...
        authorize() {
          pr(
            `https://login.live.com/oauth20_authorize.srf?${Ba({ client_id: Sr.client_id, scope: "onedrive.appfolder wl.offline_access", response_type: "code", redirect_uri: Sr.redirect_uri })}`,
            Sr.redirect_uri
          )
        },
        checkAuth(e) {
          const a = `${Sr.redirect_uri}?code=`
          if (e.startsWith(a))
    ...
    const $r = "590447512361-fa9j9vrskafqi75q2p2o2mkirdo9lavo.ap"+"ps.googleus"+"ercontent.com"/* apps.googleusercontent.com */,
      Ir = "http://127.0.0.1:45678/",
      Mr = "https://www.googleapis.com/auth/drive.appdata",
      Dr = { status: "UNAUTHORIZED" }
    function Cr(e) {
      return { id: e.id, name: e.name, size: +e.size, uri: Xs(e.name) }
    }
    cr(
      lr.extend({
        name: "googledrive",
        ...
        user() {
          const e = () =>
            this.loadData({
              url: `https://www.googleapis.com/oauth2/v3/tokeninfo?${Ba({ access_token: this.config.get("token") })}`,
              responseType: "json",
            })
          return e()
            .then((e) => {
              if (e.scope !== Mr) return M.reject(Dr)
            })
            .catch((a) =>
              a === Dr || (400 === a.status && "Invalid Value" === Me(a, "data.error_description"))
        ...
        getSyncData() {
          return this.loadData({
            url: `/files?${Ba({ spaces: "appDataFolder", fields: "files(id,name,size)" })}`,
            responseType: "json",
          }).then(({ files: e }) => {
            let a
            const t = e
                .filter((e) => !!Ys(e.name) || (a || e.name !== this.metaFile ? this.remove(e) : (a = e), !1))
                .map(Cr)
        ...
        async authorize() {
          ...
          const e = {
            ...
            ...(await yr(this.session.codeVerifier)),
          }
          this.config.get("refresh_token") || (e.prompt = "consent"),
            pr(`https://accounts.google.com/o/oauth2/v2/auth?${Ba(e)}`, Ir)
        },
        checkAuth(e) {
          const a = `${Ir}?`
          if (!e.startsWith(a)) return
        ...
        authorized(e) {
          return this.loadData({
            ...
            prefix: "",
            headers: { "Content-Type": ie },
            body: Ba(I.assign({}, { client_id: $r, client_secret: "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" }, e)),
            responseType: "json",
          }).then((e) => {
            if (!e.access_token) throw e
            {
    ...
    class _r {
      ...
      parseName() {
        ...
        if (1 === e.nodeType) {
          ...
          if (t.includes(":")) {
            let e
            if ((([e, t] = t.split(":")), (n = a[e]), !n)) throw new $(`Unknown namespace: ${e}`)
          }
          this.name = n + t
        }
      }
      ...
      children() {
        if (!this[Ur]) {
          const { node: e, nsMap: a } = this
          this[Ur] = [...e.children].map((e) => new _r(e, a))
        }
        return this[Ur]
      }
      map(e) {
    ...
    const Tr = { serverUrl: "", anonymous: !1, username: "", password: "" },
      Rr = lr.extend({
        name: "webdav",
        displayName: "WebDAV",
        properties: { authType: "password", serverUrl: null },
        getUserConfig() {
          return this.userConfig || (this.userConfig = { ...Tr, ...this.config.get("userConfig") }), this.userConfig
        },
        setUserConfig(e) {
        ...
        loadData(e) {
          return lr.prototype.loadData.call(this, I.assign({ credentials: "omit" }, e))
        },
        handleMetaError(e) {
                  ...
                  .map((e) => {
                    ...
                    if ("file" == (a.find("DAV:resourcetype").find("DAV:collection") ? "directory" : "file")) {
                      ...
                      if (Ys(n)) {
                        ...
                        return { name: (t = { name: n, size: e ? +e.text() : 0 }).name, size: t.size, uri: Xs(t.name) }
                      }
                    }
                    var t
                    return null
    ...
    cr(Rr)
    const Ar = new RegExp(`^(?:${[ht, lt].join("|")})`)
    let Lr
    function Er({ keys: e }) {
    ...
    const Or = document.createElement("textarea")
    let Pr
    Ga({
      SetClipboard(e) {
        ;(Pr = e), Or.focus(), document.execCommand("copy", !1, null)
      },
    }),
      document.body.appendChild(Or),
      D("copy", (e) => {
        e.preventDefault()
        const { type: a, data: t } = Pr
    ...
    function Vr(e, a, t) {
      for (const n in Nr) {
        ...
        !j(o) ||
          ...
          (a && o[Y] !== a) ||
          o[Wr] ||
          (o[Hr] ? ((o[Wr] = setTimeout(Kr, o[Hr], n)), o[Fr] || (Nr[n] = o[Wr]), t && (o._removed = !0)) : Kr(n))
      }
    }
    function Gr(e) {
      e > 0 && clearTimeout(e)
    ...
    function Kr(e) {
      return delete Nr[e], browser.notifications.clear(e)
    }
    Ga({
      async Notification({ image: e, text: a, tag: t, title: n, silent: o, onclick: i, [Fr]: s, [Hr]: r }, l) {
        t && Gr(Nr[t])
        const c = await browser.notifications.create(t, {
          type: "basic",
          title: E(Na, [n, P && He("extName")], " - "),
          message: a,
          iconUrl: e || ya,
          ...(!P && { requireInteraction: !!i }),
          ...(Yn >= 70 && { silent: o }),
        })
        return z(i) ? (Nr[c] = i) : l && ((Nr[c] = l), +r > 0 && (l[Hr] = +r), null != s && (l[Fr] = ao(s, l.url))), c
      },
    ...
    let Jr,
      Yr = M.resolve()
    function Xr(e, a, t) {
      if (!t) return void (Yr = Yr.then(() => (Xr(e, a, !0), Pa(150))))
      const n = j(e) ? URL.createObjectURL(e) : e,
        o = document.createElement("a")
      ;(o.href = n), (o.download = a || ""), o.click(), j(e) && Pa(3e3).then(() => URL.revokeObjectURL(n))
    }
    Ga({
      DownloadBlob(e) {
        Xr(...e)
    ...
    const Zr = Ge("VM-Verify"),
      ...
      tl = { urls: ["<all_urls>"], types: ["xmlhttprequest"] },
      nl = [browser.webRequest.OnBeforeSendHeadersOptions.EXTRA_HEADERS].filter(q),
      ol = {},
      il = (e) => e.name === Zr,
      sl = "cookie",
      rl = "set-cookie",
      ll = /^\s*(?:__(Secure|Host)-)?([^=\s]+)\s*=\s*(")?([!#-+\--:<-[\]-~]*)\3(.*)/,
      cl = /\s*;?\s*(\w+)(?:=(")?([!#-+\--:<-[\]-~]*)\2)?/y,
      ul = { strict: "strict", lax: "lax", none: "no_restriction" },
      dl = "requestHeaders",
      ml = {
        onBeforeSendHeaders: [
          ({ [dl]: e, requestId: a, url: t }) => {
            var n
            const o = el[a] || (null == (n = e.find(il)) ? void 0 : n.value),
              i = Qr[o]
            if (i) {
              ;(el[a] = o), (i.coreId = a), (i.url = t)
              const n = {},
                s = ol[o],
                r = s && {}
              let l,
              ...
              for (let a = 0; a < e.length; a++) {
                const t = e[a]
                ;(l = t.name) === Zr ||
                  ("origin" === (l = l.toLowerCase()) && t.value === H) ||
                  (l === sl && !i[sl]) ||
                  (!c && l === sl && (c = s[l]) ? (r[l] = { name: l, value: t.value + "; " + c.value }) : (n[l] = t))
              }
              return { [dl]: I.values(I.assign(n, s, r)) }
            }
          },
          dl,
          "blocking",
          ...
          ({ [f]: e, requestId: a, url: t }) => {
            ...
            if (n) {
              ...
              if (!n[rl] || a)
                return (
                  (e = e.filter((e) => {
                    if (e.name.toLowerCase() !== rl) return !0
                    a && pl(e.value, a, t)
                  })),
                  { [f]: e }
                )
    ...
    function hl(e, a) {
      a
        ? (ta(ol) &&
            E(_e, ml, ([e, [a, ...t]]) => {
              browser.webRequest[e].addListener(a, tl, t)
            }),
          (ol[e] = a))
        : e in ol &&
          (delete ol[e],
    ...
    function gl({ name: e, value: a, binaryValue: t }) {
      return `${fl(e)}: ${t ? Ke(t) : fl(a)}\r\n`
    }
    function pl(e, a, t) {
      let n = ll.exec(e)
      if (n) {
        ...
        const [, e, i, , s, r] = n,
          l = {},
          c = "Host" === e
        for (cl.lastIndex = 0; (n = cl.exec(r)); ) l[n[1].toLowerCase()] = n[3]
    ...
    function fl(e) {
      return /[\u0080-\uFFFF]/.test(e) ? (Jr || (Jr = new TextEncoder()), Ke(Jr.encode(e))) : e
    }
    Yn >= 74 && Yn <= 91 && browser.webRequest.onBeforeSendHeaders.addListener(Be, tl, nl),
      Ga({
        HttpRequest(e, a) {
          const t = a.tab.id,
            n = ro(a),
            { id: o, events: i } = e,
            s = (Qr[o] = { id: o, tabId: t, [Y]: n, frame: lo(n), xhr: new XMLHttpRequest() }),
            r = (e) => Qr[o] && Sa(t, "HttpRequested", e, s.frame)
          return Dl(e, i, a, r).catch(
    ...
    const kl = 1e6,
      bl = P ? 256e6 : 1e7,
      yl = 6e4,
      vl = ["readyState", "status", "statusText"],
      wl = ["lengthComputable", "loaded", "total"],
      xl = (e) => `"${e.replace(/[\\"]/g, "\\$&")}"`,
      zl = "sec-ch-ua",
      jl = {
        __proto__: null,
        "user-agent": (e) => e,
        [zl]: (e) => e.map((e) => `${xl(e.brand)};v="${e.version}"`).join(", "),
        [zl + "-mobile"]: (e) => "?" + (e ? 1 : 0),
        [zl + "-platform"]: xl,
      },
      Sl = I.keys(jl)
    ...
    function $l(e) {
      ...
      return Lt.put(`xhrBlob:${a}`, setTimeout(URL.revokeObjectURL, yl, a), yl), a
    }
    function Il(e, a, t) {
      return e.substr(a * t, t)
    }
    function Ml(e, a, t, n, o) {
      let i,
        s,
        r,
        l,
        ...
        z = async () => {
          ...
          i || (i = w.getResponseHeader("Content-Type") || ""),
            k !== w[p] &&
              ...
              c &&
                ((m = c.length - y)
                  ? ((n = m > bl), (r = bl), (s = m), (l = Il), (c = y ? c.slice(y) : c), (y += s))
                  : ((r = kl), (s = c.size), (l = t ? $l : ql)),
    ...
    async function Dl(e, a, t, n) {
      ...
      if (
        ...
        m.setRequestHeader(Zr, r),
        y && m.setRequestHeader("Content-Type", y),
        E(_e, e.headers, ([e, a]) => {
          const t = e.toLowerCase(),
            n = Sl.indexOf(t)
          ;(n >= 0 && (x[n] = !0)) || al.test(e) ? Rl(h, e, a, t) : m.setRequestHeader(e, a)
        }),
        e.ua.forEach((e, a) => {
          if (!x[a] && !Le(e, a ? Vn[we[a]] : Bn)) {
            const t = Sl[a]
            Rl(h, t, jl[t](e), t)
          }
        }),
        ...
        const e = Date.now() / 1e3,
          a = (
            await browser.cookies.getAll({ url: u, storeId: d.storeId, ...(Xn >= 59 && { firstPartyDomain: null }) })
          ).filter((a) => a.session || a.expirationDate > e)
        a.length && Rl(h, sl, a.map((e) => `${e.name}=${e.value};`).join(" "))
      }
      hl(r, h)
      const z = Ml(d, a, f, p, "json" === e[b])
      a.forEach((e) => {
        m[`on${e}`] = z
      }),
        (m.onloadend = z),
    ...
    function Cl({ id: e, coreId: a }) {
      delete el[a], delete Qr[e], hl(e, !1)
    }
    function Ul(e, a) {
      E(Re, Qr, (t) => {
        ;(null != e && t.tabId !== e) || (a && t[Y] !== a) || Va.AbortRequest(t.id)
      })
    }
    function _l(e, a) {
      const t = lo(0)
    ...
    const Pl = Ge(),
      ...
      Hl = ["blocking", f, browser.webRequest.OnHeadersReceivedOptions.EXTRA_HEADERS].filter(q),
      Fl = (e) => "content-security-policy" === e.name.toLowerCase(),
      Bl = /(?:^|[;,])\s*(?:script-src(-elem)?|(d)efault-src)(\s+[^;,]+)/g,
      Vl = /'nonce-([-+/=\w]+)'/,
      Gl = /^\s*(?:\/\*[\s\S]*?\*\/|\/\/.*[\r\n]+|\s+)*/u,
      Kl = (e) => 45 === (e = e.charCodeAt(e.match(Gl)[0].length)) || 43 === e || 91 === e || 40 === e,
      Jl = "'unsafe-inline'",
      Yl = { [X]: {}, [Mi]: [] },
      Xl = { ...Yl, [X]: { [i]: !0, [y]: Pl } },
      Zl = "csReg",
      ...
      ac = "{GM,GM_info,unsafeWindow,cloneInto,createObjectIn,exportFunction}",
      tc = ["description", "name", "namespace", [m], "version"],
      nc = [[re, "homepage"]],
      oc = /^(?:(m|excludeM)atch|(ex|in)clude)$/,
      ic = (e, a) => e + (a ? "es" : "s"),
      sc = (e) => e.replace(oc, ic),
      rc = { [st]: Mi, [lt]: !0, [dt]: Di, [ht]: !0, [pt]: Ci },
      lc = {},
      cc = `(${(e, a) => {
      ...
      mc = (e, a) => dc(e[c] || a[c]),
      hc = (e, a) => e === o || (e === n && a),
      gc = (e) => "outermost_frame" === e.frameType || !e[Y],
      pc = {},
      fc = {
        [pe]: ec.destroy,
        defaultInjectInto(e) {
          ;(e = dc(e)),
            ec.destroy(),
            Ll && (e === o ? Nl.removeListener(vc) : Al && P && !Ol && Nl.addListener(vc, Wl, Hl)),
            (Ll = e)
        },
        xhrInject: (e) => {
          e && (e = Ll !== o),
            Ol !== e && ((Ol = e), ec.destroy(), Nl.removeListener(vc), e && Nl.addListener(vc, Wl, Hl))
        },
        [O]: (e) => {
          Al = e
          const a = (e ? "add" : "remove") + "Listener",
            t = e ? Wl : void 0
          browser.webRequest.onSendHeaders[a](yc, t),
            (!Al || (P && !Ol && Ll !== o)) && Nl[a](vc, t, t && Hl),
            mo[a](_c),
            browser.tabs.onReplaced[a](Tc),
            e || (ec.destroy(), Rc(), Yo.destroy(), Xo.clear())
        },
        [i](e) {
          E(_e, e, ([e, a]) => {
            lc[decodeURIComponent(e)] = a
          })
        },
      }
    function kc(e, a) {
      if (e[Mi])
        for (let n = 0; n < this.length; n++) {
          var t
          const [o, i, s] = this[n]
          if (null != (t = e[rc[o]]) && t.includes(+i || i)) {
            if (o === dt) e.depsMap[i].forEach((e) => ec.del(ht + e))
            else if (o === pt && (e[gt] && (e[gt][i] = s), bc(e, +i, s), !e[Zl])) continue
            ec.del(a)
          }
        }
    }
    ...
    function yc(e) {
      const { url: a, tabId: t } = e,
        n = gc(e),
        o = uc(a, n)
      ec.has(o) || pc[t] || xc(o, a, n)
    }
    function vc(e) {
      var a
      const t = uc(e.url, gc(e)),
        n = ec.get(t)
      if (n && !n[s] && null != (a = n[X]) && a[h] && !pc[e.tabId]) {
        const a = P && e.url.startsWith("https:") && Cc(e, n),
          t = Ol && wc(e, n)
        return a ? a.then(t && (() => t)) : t
      }
    }
    function wc({ [f]: e, [Y]: a, tabId: t }, n) {
      qc(n[X][h], n[s], t, a, n)
      const o = URL.createObjectURL(new Blob([JSON.stringify(n[X])]))
      return (
        e.push({ name: rl, value: `"**VMInitInjection**"=${o.split("/").pop()}; SameSite=Lax` }),
        setTimeout(URL.revokeObjectURL, 6e4, o),
        { [f]: e }
      )
    }
    function xc(e, a, t) {
      const n = t && a.startsWith("https://") ? lc[a.split("/", 3)[2]] : null,
        o = null != n ? Xl : Yl
      if (((Xl[X][i] = n), !Al)) return o
      const s = [],
        r = Ei(a, t, s),
        l = r || o
      return ec.put(e, l), r && (r[Ui] = zc(e, a, t, r, null != n ? { [i]: n } : {}, s)), l
    }
    async function zc(e, a, t, n, o, i) {
      if ((n[Ui] && (await n[Ui]), !Al)) return
      ec.batch(!0)
      const s = { [X]: o },
        { allIds: l, [u]: m } = n,
      ...
      return (
        ...
        (s[u] = m),
        El && Ql && !Ol && t && ((o[d] = n[d] || $c(m)), (s[Zl] = Mc(o, a))),
        g && (ec.put(g, m), (m[u] = e)),
        ec.put(e, s),
        ec.batch(!1),
        s
    ...
    function jc(e) {
      ...
      for (let t, n, i, s = 0; s < a.length; s++)
        (t = a[s]),
          (i = t.id),
          t[ve] || ((i = t.props.id), (n = ht + i), (t = ec.get(n) || ec.put(n, Sc(t, e))), (a[s] = t)),
          t[c] !== o && (e[d] = !0),
          (t[g] = e[gt][i] || null)
      return a
    }
    function Sc(e, a) {
      ...
      f &&
        ...
        (I = !1)
      for (let e = 0, a = n[ut]; e < a.length; e++) {
        const t = a[e],
          n = s[p[t] || t]
        ;/\S/.test(n) && (z.push(...[I && Kl(n) && ";", n, !de.test(n) && "\n"].filter(q)), (I = !0))
      }
      return (
        I && Kl(l) && z.push(";"),
        ($ = z.length),
        ...
        ),
        {
          ...
          [ve]: z,
          [c]: mc(t, n),
          [ue]: ["", $, (I = S && S.index + S[1].length), I + (null == S ? void 0 : S[4].length)],
          [m]: r[i],
        }
      )
    }
    function qc(e, a, t, n, o) {
      let i, s
      const r = []
      for (let t = 0; t < e.length; t++) {
        const n = e[t],
      ...
      o && (o[X][d] = s || $c(o[u])), r[0] && setTimeout(Ic, 0, r, t, n)
    }
    function $c(e, a) {
      return null == e ? void 0 : e[h].some(Uc, a || null)
    }
    function Ic(e, a, t) {
      for (let n = 0; n < e.length; n++) {
        const [o, i] = e[n],
    ...
    function Mc(e, a) {
      ...
      return Ql.register({
        js: [{ code: `${cc}(this,${JSON.stringify(e)})` }],
        matches: a.split("#", 1),
        [m]: "document_start",
      })
    }
    function Dc(e) {
      const a = e[Zl]
      if (a) return delete e[Zl], a.then((e) => e.unregister())
    }
    function Cc(e, a) {
      const t = e[f].find(Fl)
      if (!t) return
      let n,
        ...
        r,
        l = ""
      for (; (n = Bl.exec(t.value)); ) l += n[2] ? (r = n[3]) : n[1] ? (i = n[3]) : (o = n[3])
      if (l) {
        if (((l = l.match(Vl)), l)) a[X].nonce = l[1]
        else {
          if (!((o && !o.includes(Jl)) || (i && !i.includes(Jl)) || (!o && !i && r && !r.includes(Jl)))) return
          a[s] = a[X][s] = !0
        }
        return (n = Dc(a)), n && !l ? M.all([n, (a[Zl] = Mc(a[X], e.url))]) : void 0
      }
    }
    function Uc(e) {
      return !hc(e[c] || mc(e.custom, e.meta), this)
    }
    function _c(e) {
      Rc(e, 0, !0), delete pc[e]
    }
    function Tc(e, a) {
      _c(a)
    }
    function Rc(e, a, t) {
      Ul(e, a), Oo(e, a), Vr(e, a, t)
    }
    function Ac(e, a) {
      setTimeout(Sa, 0, e, "PopupShown", !0, lo(a))
    }
    Ql &&
      (fc.ffInject = (e) => {
        ;(El = e),
      ...
      Ka({
        [x]: async (e) => {
          ...
          const a = e.id,
            t = ec.get(uc(e.url, !0)),
            n = P && t && Dc(t)
          ;(pc[a] = 1), n && (await n), Rc(a), await browser.tabs.reload(a)
        },
      }),
      Ga({
        async GetInjected({ url: e, [s]: a, done: t }, n) {
          const { tab: o, [Y]: i, [v]: r } = n,
            l = so(r, n[J], i),
            u = o.id
          e || (e = n.url || o.url), Rc(u, l)
          let d = pc[u]
          if (d > 0) return r && (pc[u] = -1), ss[u] && Ac(u, l), { [c]: x }
          d && delete pc[u]
          const m = uc(e, r),
            g = ec.get(m) || xc(m, e, r),
            p = g[X] ? g : await g[Ui],
            f = p[X],
            k = f[h]
          return k && (qc(k, p[s] || a, u, i, p), Po(k, u, l)), ss[u] && Ac(u, l), Al ? !t && f : { [c]: "off", ...f }
        },
        async InjectionFeedback({ [s]: e, [o]: a, [u]: t, url: n }, i) {
          ...
          const { tab: r, [Y]: l } = i,
            c = i[v],
            d = r.id
          if ((Ic(a, d, l), !t)) return
          n || (n = i.url || r.url)
          const m = ec.get(t) || ec.put(t, Ei(n, c)) || { [h]: [] },
            g = (m[Ui] ? await m[Ui] : m)[it],
            p = jc(m)
          return qc(p, e, d, l), Po(p, d, so(c, i[J], l)), { [h]: p, [it]: g }
        },
        Run({ [r]: e, reset: a }, t) {
          const {
              [J]: n,
            ...
            s = +(null == e ? void 0 : e[0])
          Us(e, a, t), 3 === o && (s && No(e, n), _l(i, n), Vr(i)), "bfcache" === a && s && Po(e, i, so(o, n, t[Y]))
        },
      }),
      Ct(function e(a) {
        for (const e in fc) e in a && fc[e](a[e])
        for (const t in a) t.includes(".") && e(De({}, t, a[t]))
      }),
      ai((e, a) => {
        const t = []
        for (let n = 0; n < e.length; n++) {
          const o = e[n],
            ...
            s = o.slice(0, i),
            r = o.slice(i)
          if (!0 === rc[s]) return void ec.destroy()
          let l, c
          s === pt && ((c = null == a ? void 0 : a[o]), (l = ec.get(ht + r)) && (l[g] = c = Ae(c) || (l[g] && {}))),
            s && t.push([s, r, c])
        }
        t.length && ec.some(kc, t)
      })
    const Lc = {},
      Ec = { ...ye, headers: { Accept: "text/x-userscript-meta,*/*" } },
      Oc = "checking"
    async function Pc(e, a, t, n) {
      let o, i, s
      try {
        const { update: s } = await Zi({ id: e, code: await Nc(a, t, n), bumpDate: !0, update: { [Oc]: !1 }, ...n })
        ;(i = He("msgScriptUpdated", [_a(s)])), (o = !0)
      } catch (e) {
        s = e.error || (!e[Oc] && (await es(a, n)))
      } finally {
        Wc(a) && (i || s) && (o = { script: a, text: E(Na, [i, s], "\n"), err: !!s }), delete Lc[e]
      }
      return o
    }
    async function Nc(e, a, t) {
      let n
      const {
          meta: o,
          props: { id: i },
      ...
      u(He("msgCheckingForUpdate"))
      try {
        const { data: e } = (await Vc(r, { ...Ec, ...t })) || {},
          { version: a, [ve]: i } = e ? Io(e, { retMetaStr: !0 }) : {}
        if (ea(o.version, a) >= 0) u(He("msgNoUpdate"), { [Oc]: !1 })
        else {
          if (s)
            return s === r && null != e && e.replace(ce, "").trim()
              ? (u(He("msgUpdated")), e)
              : (u(He("msgUpdating")),
                (n = He("msgErrorFetchingScript")),
                s === r && i.trim() !== e.trim() ? e : (await Vc(s, { ...ye, ...t })).data)
          u(He("msgNewVersion"), { [Oc]: !1 })
        }
      } catch (e) {
        u(n || He("msgErrorFetchingUpdateInfo"), { error: e })
      }
      throw l
      function u(e, { error: a, [Oc]: t = !a } = {}) {
        I.assign(l, { message: e, [Oc]: t, error: a ? `${He("genericError")} ${a.status}, ${a.url}` : null }),
          ja("UpdateScript", c)
      }
    }
    function Wc(e) {
      var a
      const t = Ut("notifyUpdates")
      return Ut("notifyUpdatesGlobal") ? t : null != (a = e.config.notifyUpdates) ? a : t
    }
    function Hc() {
      const e = Fc()
      if (!e) return
      let a = Date.now() - Ut("lastUpdate")
      a >= e && (setTimeout(Va.CheckUpdate, 2e4, n), (a = 0)),
        clearTimeout(Hc.timer),
        (Hc.timer = setTimeout(Hc, Math.min(2147483647, e - a)))
    }
    function Fc() {
      return (+Ut("autoUpdate") || 0) * ge
    }
    function Bc(e = {}) {
      const a = {},
    ...
    async function Vc(e, a) {
      if (ua(e)) return
      let t, o, i
      const s = !ma(e)
      if (
        (!s && a && (t = a[Z]) && j((o = await bt.mod.getOne(e))) && ([o, i] = o), !(t === n && i > Date.now() - Fc()))
      )
        for (let n = 0, i = t ? [0, 1] : [1]; n < i.length; n++) {
          const t = i[n]
          if (o || t) {
            const n = await (s || ca.test(e) ? ga : eo)(e, t ? a : { ...a, ...ye, method: "HEAD" }),
              { headers: i } = n,
              r = i.get("etag") || +new Date(i.get("last-modified")) || +new Date(i.get("date"))
            if (r && r === o) return
            if (t) return r ? bt.mod.setOne(e, [r, Date.now()]) : o && bt.mod.remove(e), n
          }
        }
    }
    async function Gc({ code: e, from: a, url: t, fs: n, parsed: o }, { tab: i = {} }) {
      if (!n) {
        if ((null != e || (e = o ? ga(t).then((e) => e.data) : (await ga(t)).data), !o && !yo(e)))
          throw `${He("msgInvalidScript")}\n\n${e
            .trim()
            .split(/[\r\n]+\s*/, 9)
            .join("\n")
            .slice(0, 500)}...`
      ...
      const s = Ge(),
        ...
        u = (!c || P) && (t === a || Lt.has(`autoclose:${l}`) || io.test(a))
      Lt.put(`confirm-${s}`, { incognito: c, url: t, from: a, tabId: l, fs: n, ff: Xn })
      const d = Kc + s,
        { [Q]: m } =
          (u && (await browser.tabs.update(l, { url: d }).catch(Be))) ||
          (await Va.TabOpen({ url: d, active: !!r }, { tab: i }))
      r && m !== i[Q] && (await (null == ba ? void 0 : ba.update(m, { focused: !0 })))
    }
    Ya.then(Hc),
      $t((e) => "autoUpdate" in e && Hc()),
      Ka({
        async CheckUpdate(e) {
          const a = e === n,
            t = a || !e,
            o = t ? Ii() : na(e).map(Si).filter(q),
            i = { all: !0, allowedOnly: t, enabledOnly: t && Ut(Za) },
            s = { [je]: { ...ye, [Z]: a ? n : t } },
            r = o
              .map((e) => {
                const a = e.props.id,
                  t = Aa(e, i)
                return t && (Lc[a] || (Lc[a] = Pc(a, e, t, s)))
              })
              .filter(q),
            l = await M.all(r),
          ...
          return (
            c.length &&
              Ni(
                c.some((e) => e.err) ? He("msgOpenUpdateErrors") : P ? He("optionUpdate") : "",
                c.map((e) => `* ${e.text}\n`).join(""),
                c.map((e) => e.script.props.id)
              ),
            t && _t("lastUpdate", Date.now()),
            l.reduce((e, a) => e + (!0 === a), 0)
          )
        },
      }),
      (bt.cache.fetch = Bc({ init: (e) => ({ ...e, [b]: "blob" }), transform: (e) => Ha(e) })),
      (bt.require.fetch = Bc({
        transform: ({ data: e }, a) =>
          /^\s*</.test(e)
            ? M.reject(
      ...
      Ga({
        async CheckInstallerTab(e, a) {
          ...
          return t && co(t).startsWith(Kc)
        },
        ConfirmInstall: Gc,
      })
    const Kc = `${W}confirm/index.html#`,
      Jc =
        /^https:\/\/((greas|sleaz)yfork\.org\/scripts\/[^/]*\/code|update\.(greas|sleaz)yfork\.org\/scripts|openuserjs\.org\/install\/[^/]*|github\.com\/[^/]*\/[^/]*\/(raw\/[^/]*|releases\/(download\/[^/]*|latest\/download))|raw\.githubusercontent\.com(\/[^/]*){3}|gist\.github\.com\/.*?)\/[^/]*?\.user\.js([?#]|$)/i,
      Yc = /^https?:\/\/((gist\.)?github\.com|((greas|sleaz)yfork|openuserjs)\.org)\//i,
      Xc = (e) => `${B}${N}/${+e.split("#")[1]}`,
      Zc = P && new RegExp(`^(view-source:)?(${W.replace("://", "$&)?")}[^/]*\\.user\\.js#\\d+`),
      Qc =
        Zc &&
        ((e, a) => {
          Zc.test(a) && browser.tabs.update(e, { url: Xc(a) })
        })
    async function eu(e, a, n) {
      const o = (e >= 0 && (await browser.tabs.get(e))) || {},
        { data: i } = (!n && (await ga(a).catch(Be))) || {}
      if (n || (i && Io(i).name)) Gc({ code: i, url: a, from: o.url, parsed: !0 }, { tab: o })
      else {
        Lt.put(`bypass:${a}`, !0, 1e4)
        const n = `${t} installer skipped ${a}.\nEither not a userscript or the metablock comment is malformed:\n${(null == i ? void 0 : i.length) > 1e6 ? i.slice(0, 1e6) + "..." : i}`
        e < 0
          ? console.warn(n)
    ...
    var au
    function tu({ cmd: e, data: a, url: t, [v]: n } = {}, o) {
      if (Ya) return Ya.then(tu.bind(this, ...arguments))
      const i = L(Va, e) && Va[e]
      if (i) {
        if (o) {
          let a = o.origin
          if ((t && (o.url = t), (a = a ? a === H : `${t || o.url}`.startsWith(W)), !a && i.isOwn && !o.fake))
    ...
    Zc && uo.addListener((e, { url: a }) => a && Qc(e, a), Xn && { properties: [Xn >= 88 ? "url" : "status"] }),
      browser.tabs.onCreated.addListener((e) => {
        const { id: a, title: t } = e,
          n = co(e),
          o = n.startsWith("file:"),
          i = /\.user\.js([?#]|$)/.test(n)
        i && (!o || Xn < 68) && Lt.put(`autoclose:${a}`, !0, 1e4),
          Zc && "about:blank" === n && Qc(a, t),
          i && o && !ho && !P && Ut("helpForLocalFile") && Gc({ url: n, fs: !0 }, { tab: e })
      }),
      browser.webRequest.onBeforeRequest.addListener(
        (e) => {
          const { method: a, tabId: t, url: n } = e
          if ("GET" !== a) return
          if (n.startsWith(W)) return { redirectUrl: Xc(n) }
          let o
          return Lt.has(`bypass:${n}`) || (!(o = Jc.test(n)) && Yc.test(n))
            ? void 0
            : (eu(t, n, o), P ? { cancel: !0 } : { redirectUrl: "javascript:void 0" })
        },
        {
          urls: ["*://*/*.user.js", "*://*/*.user.js?*", `${qe}.user.js`, `${qe}.user.js?*`, `${W}*.user.js`],
          types: ["main_frame"],
        },
        ["blocking"]
      ),
      Ga({ SetTimeout: (e) => e > 0 && Pa(e) }),
      (e.handleCommandMessage = tu),
      (e.deepCopy = Ae),
      browser.runtime.onMessage.addListener(tu),
      null == (au = browser.commands) ||
        au.onCommand.addListener(async (e) => {
          Es(e, await Oa())
        })
  })()
}
