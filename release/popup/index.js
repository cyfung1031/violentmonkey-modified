{
  const e = this,
    ...
    E = "isApplied",
    I = "contextualIdentities" in k,
    L = (k.runtime.getURL("/").slice(0, -1), k.runtime.getManifest()),
    _ =
      (k.runtime.getURL(L.options_ui.page).split("#", 1)[0],
      k.runtime.getURL(L.icons[16].replace("16.png", "")),
      "settings"),
    w = "frameId"
  ;(() => {
    var e,
        ...
        5848: (e, f, g) => {
          ...
          const W = (0, K.Kh)({
            ...
            Ue = {
              ...
              setup(e) {
                let a, l
                const o = L.homepage_url.split("/")[2],
                  i = `${L.name} 2.26.2`,
                  ...
                  Te = (0, S.EW)(() => {
                    const e = R.value.data,
                      t = (0, C.wp)(e),
                      n = !t && (0, C.nS)(e)
                    return [t && [t, (0, C.Ru)("menuFeedback")], n && [n, (0, C.Ru)("buttonHome")]].filter(v)
                  }),
                  qe = (0, S.EW)(() => {
                        ...
                        return (
                          ...
                          (d = d
                            .map((a) => {
                              ...
                              return p && (m.upd = null), p && c && (s || (s = W.updatableScripts = {}), (s[o] = m)), m
                            })
                  ...
                  He = (0, S.EW)(
                    () =>
                      ("scripts-skipped" === W.failure || (E in W && W[E] !== f[E]) || b.values(r).some(v)) &&
                      (0, C.Ru)("reloadTab")
                  ),
                ...
                function ct(e) {
                  ;(e.excludes = null), vt(e)
                }
                async function pt(e, t) {
                  await (0, C.dr)("UpdateScriptInfo", {
                    id: e.data.props.id,
                    custom: {
                      excludeMatch: [...(e.data.custom.excludeMatch || []), ...[t || e.excludes[0].trim()].filter(v)],
                    },
                  }),
                    ct(e),
                    lt()
                  ...
                  (0, S.sV)(() => {
                    U.vW.enable(),
                      U.vW.register("escape", () => {
                        ...
                        n
                          ? ((R.value = Qe.value = null), vt(n))
                          : null != (e = (0, F.bq)()) && e.value
                            ? (0, F.bq)().blur()
                            : t.close()
                      }),
                      I && (U.vW.register("tab", () => (0, U.I1)(1)), U.vW.register("s-tab", () => (0, U.I1)(-1)))
                    for (let e = 0, t = ["up", "down", "left", "right"]; e < t.length; e++) {
                      const n = t[e]
                      U.vW.register(n, mt.bind(null, n[0]), { condition: "!inputFocus" })
                    }
                    U.vW.register(
                      "e",
                      () => {
          ...
          async function Pe(e, { [w]: n, url: p }) {
            const m = 0 === n
            e[u] || b.assign(e[l], await (0, C.dr)("GetMoreIds", { url: p, [c]: m, [l]: e[l] })),
              m ? (W[E] = "off" !== e[s]) : await We,
              (W.commands = b.assign(e.menus, !m && W.commands))
            const v = W.idMap,
              f = v[0] || (v[0] = {}),
              x = v[n] || (v[n] = {}),
            ...
            if (k.length) {
              ...
              const { frameScripts: t } = W,
                n = m ? W[d] : t
              ;(
                (null == (I = e[d]) ? void 0 : I.filter(({ props: { id: e } }) => k.includes(e))) ||
