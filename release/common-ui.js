  ...
  ;(self.webpackChunkviolentmonkey = self.webpackChunkviolentmonkey || []).push([
    [987],
    {
      ...
      641: (e, n, o) => {
        ...
        function P(e, t) {
          U("app:init", e, t, { Fragment: _n, Text: bn, Comment: xn, Static: wn })
        }
        function D(e) {
          U("app:unmount", e)
        }
        const F = K("component:added"),
        ...
        function ie(e) {
          if (de(e)) return ((e = Dn(e)).children = null), e
        }
        function le(e) {
          if (!de(e)) return e
        ...
        function ce(e, t = !1, n) {
          ...
          for (let s = 0; s < e.length; s++) {
            ...
            i.type === _n
              ...
              : (t || i.type !== xn) && o.push(null != l ? Dn(i, { key: l }) : i)
          }
              ...
              return (
                ...
                () => {
                  ...
                  const f = null == s.key ? a : s.key,
                    h = r.get(f)
                  return (
                    s.el && ((s = Dn(s)), 128 & o.shapeFlag && (o.ssContent = s)),
                    (v = f),
                    h
                      ? ((s.el = h.el),
        ...
        function Ve(e) {
          return (0, s.Kg)(e) ? Pe(Oe, e, !1) || e : e || Ue
        }
        function Pe(e, t, n = !0, o = !1) {
          ...
          if (r) {
            ...
            const i = De(r[e] || n[e], t) || De(r.appContext[e], t)
            return !i && o ? n : i
          }
        }
        function De(e, t) {
        ...
        function Ie(e, t, n = {}, o, r) {
          if (H.isCE || (H.parent && ue(H.parent) && H.parent.isCE))
            return "default" !== t && (n.name = t), Vn("slot", n, o && o())
          let s = e[t]
          s && s._c && (s._d = !1), kn()
          const i = s && qe(s(n)),
            l = An(
          ...
          return (n, o = null) => {
            ...
            const a = (r.app = {
              ...
              unmount() {
                l &&
                  (e(null, a._container),
                  __VUE_PROD_DEVTOOLS__ && ((a._instance = null), D(a)),
        ...
        const Lt = Symbol("_vte"),
          ...
          Ut = (e) => "function" == typeof MathMLElement && e instanceof MathMLElement,
          Vt = (e, t) => {
            const n = e && e.to
          ...
          process(e, t, n, o, r, s, i, l, a, c) {
            ...
            if (null == e) {
              const e = (t.el = m("")),
                c = (t.anchor = m(""))
              f(e, n, o), f(c, n, o)
              const d = (t.target = Vt(t.props, h)),
                p = It(d, t, m, f)
              d && ("svg" === i || Bt(d) ? (i = "svg") : ("mathml" === i || Ut(d)) && (i = "mathml"))
              const g = (e, t) => {
              ...
              const o = (t.anchor = e.anchor),
                ...
                y = m ? o : f
              if (
                ("svg" === i || Bt(u) ? (i = "svg") : ("mathml" === i || Ut(u)) && (i = "mathml"),
        ...
        function Kt(e, t) {
          ...
          const n = (0, s.We)()
          ;(n.__VUE__ = !0), __VUE_PROD_DEVTOOLS__ && V(n.__VUE_DEVTOOLS_GLOBAL_HOOK__, n)
          const {
              insert: o,
              remove: i,
              patchProp: l,
        ...
        function pn(e) {
          ...
          try {
            ...
            ;(Cn.length = 0), a(t, e, 1), (b = Vn(xn))
          }
          let w = b
          if (x && !1 !== y) {
            const e = p.keys(x),
              { shapeFlag: t } = w
            e.length && 7 & t && (i && e.some(s.CP) && (x = hn(x, i)), (w = Dn(w, x, !1, !0)))
          }
          return (
            n.dirs && ((w = Dn(w, null, !1, !0)), (w.dirs = w.dirs ? w.dirs.concat(n.dirs) : n.dirs)),
        ...
        function Mn(e, t, n, o, r, s) {
          return Rn(Un(e, t, n, o, r, s, !0))
        }
        function An(e, t, n, o, r) {
          return Rn(Vn(e, t, n, o, r, !0))
        }
        function Ln(e) {
        ...
        function Un(e, t = null, n = null, o = 0, r = null, i = e === _n ? 0 : 1, l = !1, a = !1) {
          const c = {
            __v_isVNode: !0,
            __v_skip: !0,
            type: e,
        ...
        const Vn = function (e, t = null, n = null, o = 0, i = null, l = !1) {
          if (((e && e !== Ue) || (e = xn), Ln(e))) {
            const o = Dn(e, t, !0)
            return (
              n && Kn(o, n),
        ...
        function Fn(e = " ", t = 0) {
          return Vn(bn, null, e, t)
        }
        function In(e = "", t = !1) {
          return t ? (kn(), An(xn, null, e)) : Vn(xn, null, e)
        }
        function qn(e) {
          ...
          return 2 === o
            ? (0, s.Gv)(t) && !(0, s.cy)(t)
              ? Ln(t)
                ...
                : Vn(e, t)
              : Vn(e, null, t)
            : (o > 3 ? (n = Array.prototype.slice.call(arguments, 2)) : 3 === o && Ln(n) && (n = [n]), Vn(e, t, n))
        }
        const go = "3.4.38"
      },
      3751: (e, n, o) => {
        ...
        function P(e, t, n) {
          ...
          if (n && !r) {
            if (t)
              ...
              else for (const e in t) null == n[e] && F(o, e, "")
            for (const e in n) "display" === e && (i = !0), F(o, e, n[e])
          } else if (r) {
            if (t !== n) {
              const e = o[U]
              e && (n += ";" + e), (o.cssText = n), (i = V.test(n))
            }
        ...
        function F(e, t, n) {
          if ((0, s.cy)(n)) n.forEach((n) => F(e, t, n))
            ...
            const o = N(e, t)
            D.test(n) ? e.setProperty((0, s.Tg)(o), n.replace(D, ""), "important") : (e[o] = n)
          }
        }
      ...
      4526: (n, o, r) => {
        ...
        const i = {},
          ...
          B = /-(\w)/g,
          U = O((e) => e.replace(B, (e, t) => (t ? t.toUpperCase() : ""))),
          V = /\B([A-Z])/g,
          P = O((e) => e.replace(V, "-$1").toLowerCase()),
          D = O((e) => e.charAt(0).toUpperCase() + e.slice(1)),
          F = O((e) => (e ? `on${D(e)}` : "")),
          I = (e, t) => !p.is(e, t),
          q = (e, ...t) => {
      ...
      6808: (e, n, o) => {
        ...
        h(
          "keydown",
          (e) => {
            "Escape" === e.key && C.length && !F(e) && (e.stopImmediatePropagation(), C.pop()())
          },
          !0
        )
        const E = {
        ...
        const V = (() => {
          ...
          F = (e) => e.shiftKey || e.ctrlKey || e.metaKey || e.altKey,
      ...
      4758: (e, t, n) => {
        ...
        const _ =
          ...
          w = (e) => /^data:/i.test(e),
          C = (e) => /^https?:\/\//i.test(e) && k(e),
          S = (e) => e && !_.test(decodeURI(e))
        function k(e) {
          try {
            if (e && new URL(e)) return e
          } catch (e) {}
        }
        const E = { __proto__: null, string: "s", number: "n", boolean: "b" }
        function T(e, t = JSON.stringify) {
          if (void 0 !== e) {
            const n = E[typeof e]
            return `${n || "o"}${n ? e : t(e)}`
          }
      ...
      5042: function (n) {
        ...
        ;(o = function () {
          ...
          var M,
            ...
            D = "__SVG_SPRITE__"
          t[D] ? (M = t[D]) : ((M = new U({ attrs: { id: P, "aria-hidden": "true" } })), (t[D] = M))
          var F = () => {
            var e = document.getElementById(P)
            e ? M.attach(e) : M.mount(document.body, !0)
          }
          return document.body ? F() : V(F), M
        }),
          (n.exports = o())
      },
      6262: (e, t) => {
          ...
          f().defineMode(
            ...
            (e) => {
              ...
              function q(e) {
                ...
                if (n[s]) return void (e.style = F(t, n))
              ...
              return (
                ...
                N({
                  css1: [
                    ...
                    { match: "(", type: "(" },
                    { type: "quasi", next: "css-in", mode: S, onMatch: U },
                    { match: V, id: "css-in", next: null, onMatch: P, onMiss: q },
                  ],
                  css2: [
                ...
                N({
                  html1: [{ match: V, id: "html-in", next: null, onMatch: P, onMiss: q }],
                  html2: [
                    { style: "comment", match: /^\/\*\s*(lang(uage)?\s*=\s*)?html\s*\*\/$/i },
                    { type: "quasi", next: "html-in", mode: k, onMatch: U },
                  ],
                  html3: [
                    {
                      match: /^['"]\s*<\/?[a-z\d]+(\s|\/?>)/i,
                  ...
                  html4: [
                    { match: /^`\s*<\/?[a-z\d]+(\s|\/?>)/i, type: "quasi", next: "html-in", mode: k, onMatch: U },
                  ],
                  html5: [
                    { match: /^`(\\)?\s*$/, type: "quasi" },
                    {
      ...
      3901: (e, t, n) => {
        ...
        const m = { class: "setting-text" },
          ...
          _ = ["textContent"],
          b = "m" === h.Dv.ctrlcmd ? "\u2318S" : "Ctrl-S",
          x = (e) => (Array.isArray(e) ? e.join("\n") : e || ""),
          w = (e) => JSON.stringify(e, null, "  "),
          C = {
            __name: "setting-text",
            props: { name: String, json: u, disabled: u, hasSave: { type: u, default: !0 }, hasReset: u, rows: Number },
            emits: ["bg-error", "save"],
            setup(e, { expose: t, emit: n }) {
              let u, h
              const C = e,
              ...
              function D() {
                d.A.set(C.name, (u = $.value)).then(I, I),
                  (h = L.value),
                  (M.value = E.value = !1),
                  (A.value = (0, l.Ru)("buttonSaved")),
                  S("save")
              }
              function F() {
                const e = k.value
                e.focus(),
                  C.hasSave
                    ? (e.select(), document.execCommand("insertText", !1, U) || ($.value = U))
                    : d.A.set(C.name, B).then(I, I)
              }
              function I(e) {
                S("bg-error", e && JSON.parse(e.message))
              }
              return (
                t({ defaultValue: B, text: L, value: $ }),
                (0, o.wB)(M, V),
                (0, o.wB)(L, (e) => {
                  let t, n, o, r, s
                  if (C.json) {
                  ...
                  (0, o.CE)("div", m, [
                    (0, o.bo)(
                      (0, o.Lk)(
                        "textarea",
                        {
                          ref_key: "$text",
                          ref: k,
                          class: (0, r.C4)(["monospace-font", { "has-error": R.value }]),
                          spellcheck: "false",
                          "onUpdate:modelValue": n[0] || (n[0] = (e) => (L.value = e)),
                          disabled: e.disabled,
                          placeholder: (0, s.R1)(U),
                    ...
                    e.hasSave
                      ? ((0, o.uX)(),
                        (0, o.CE)(
                          ...
                          {
                            key: 0,
                            textContent: (0, r.v_)(A.value || (0, s.R1)(l.Ru)("buttonSave")),
                            onClick: D,
                            title: (0, s.R1)(b),
                    ...
                    e.json
                      ? ((0, o.uX)(),
                        (0, o.CE)(
                          "span",
                          { key: 2, class: "error text-red sep", textContent: (0, r.v_)(R.value) },
                          null,
                          8,
                          _
                        ))
      ...
      9478: (e, t, n) => {
        ...
        const m = { class: "ml-2c flex flex-col" },
          ...
          U = { ...B, [f.gv]: (e, t) => (A.test(e) ? e : d.Ay[t]) },
          V = {
                    ...
                    (0, o.CE)(
                      ...
                      [
                        ...
                        (0, o.Lk)("div", m, [
                          (0, o.bF)(
                            a.A,
                            { name: "editorWindow", class: "mr-2", ref_key: "$EW", ref: A },
                            {
                              default: (0, o.k6)(() => [
                                (0, o.bF)(
                                  (0, r.R1)(l.A),
