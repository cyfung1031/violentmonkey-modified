  ...
  ;(self.webpackChunkviolentmonkey = self.webpackChunkviolentmonkey || []).push([
    [84],
    {
      ...
      2262: (e, t, n) => {
        ...
        function H(e = !1) {
          return (t, n, s, r) => {
            ...
            if (!e && (Se(s) || Ce(s) || ((i = Ee(i)), (s = Ee(s))), !(0, o.kJ)(t) && Ie(i) && !Ie(s)))
              return (i.value = s), !0
      ...
      6252: (e, n, o) => {
        ...
        const q = H("component:added"),
          F = H("component:updated"),
          N = H("component:removed"),
          B = (e) => {
        ...
        function ae(e, t, { immediate: n, deep: o, flush: a, onTrack: c, onTrigger: u } = r.kT) {
          ...
          t ? (n ? w() : (_ = x.run())) : "post" === a ? Ht(x.run.bind(x), p && p.suspense) : x.run()
          const k = () => {
        ...
        function Bt(e, t, n, o, l = !1) {
          if ((0, r.kJ)(e)) return void e.forEach((e, s) => Bt(e, t && ((0, r.kJ)(t) ? t[s] : t), n, o, l))
          if (Ce(o) && !l) return
          ...
          const {
            ...
            V = (e, t, n, o, s, r, i) => {
              ...
              if ((Se(e) && (l.ctx.renderer = re), zn(l), l.asyncDep)) {
                if ((s && s.registerDep(l, H), !e.el)) {
                  const e = (l.subTree = bn(sn))
                  w(null, e, t, n)
                }
              } else H(l, e, t, n, s, r, i)
            },
            N = (e, t, n) => {
                  ...
                  () => {
                    if (e.isMounted) {
                      ...
                      ;(e.subTree = p),
                        ...
                        null === d && oe(e, p.el),
                        s && Ht(s, i),
                        (t = n.props && n.props.onVnodeUpdated) && Ht(() => An(t, c, n, u), i),
                      ...
                      if ((d && Ht(d, i), !f && (s = c && c.onVnodeMounted))) {
                        const e = t
                        Ht(() => An(s, p, e), i)
                      }
                      ;(256 & t.shapeFlag || (p && Ce(p.vnode) && 256 & p.vnode.shapeFlag)) && e.a && Ht(e.a, i),
                        (e.isMounted = !0),
            ...
            J = (e, t, n, s, r = null) => {
              ...
              if (6 & u) J(e.component.subTree, t, n, s)
                ...
                if (l !== rn)
                  if (2 !== s && 1 & u && a)
                    if (0 === s) a.beforeEnter(i), o(i, t, n), Ht(() => a.enter(i), r)
                    else {
            ...
            Z = (e, t, n, o = !1, s = !1) => {
              ...
              if ((null != l && Bt(l, null, n, e, !0), 256 & u)) return void t.ctx.deactivate(e)
              const f = 1 & u && p,
                h = !Ce(e)
              let m
        ...
        function Jn(e, t, n) {
          ...
          if (!e.render) {
            ...
            ;(e.render = o.render || r.dG), Hn && Hn(e)
          }
        ...
        function F(e) {
          ...
          const {
            ...
            M = (e) => (t, n) => {
              ...
              V(s, [t, r]),
                z(() => {
                  j(t, e ? c : i), H(t, e ? d : a), q(s) || K(t, o, g, r)
                })
            }
          return (0, s.l7)(t, {
            onBeforeEnter(e) {
            ...
            onLeave(e, t) {
              ...
              H(e, p),
                ...
                H(e, f),
                z(() => {
                  e._isLeaving && (j(e, p), H(e, h), q(b) || K(e, o, v, n))
                }),
                V(b, [e, n])
            },
            onEnterCancelled(e) {
        ...
        function O(e) {
          ...
          const t = "unhandledError",
            ...
            o =
              10 *
                (L(
                  (n.value = S(l.Hv, [n.value, p(e) ? `${(E && e.message) || ""}\n${e.stack || ""}` : `${e}`], "\n\n")
                    .trim()
                    .split(M)
                    .join(""))
                ) +
              ...
              return (
                ...
                B({
                  css1: [
                    ...
                    { match: "(", type: "(" },
                    { type: "quasi", next: "css-in", mode: C, onMatch: R },
                ...
                B({
                  ...
                  html2: [
                    ...
                    { type: "quasi", next: "html-in", mode: S, onMatch: R },
                  ],
                  html3: [
                    {
                      match: /^['"]\s*<\/?[a-z\d]+(\s|\/?>)/i,
                  ...
                  html4: [
                    { match: /^`\s*<\/?[a-z\d]+(\s|\/?>)/i, type: "quasi", next: "html-in", mode: S, onMatch: R },
                  ],
                  html5: [
                    { match: /^`(\\)?\s*$/, type: "quasi" },
                    {
                ...
                this.placeholders.forEach((e) => {
                  if (!e.el) {
                    ...
                    ;(a[J] = !0),
                      ...
                      (l.textContent = `${s.slice(0, H)}...[${(0, C.ag)("editLongLine")}]`),
                      (l.onclick = () => {
