{
  const e = this,
    ...
    C = "isApplied",
    S = "contextualIdentities" in v,
    k = v.runtime.getURL("/"),
    E = (k.slice(0, -1), v.runtime.getManifest()),
    T = (v.runtime.getURL(E.options_ui.page).split("#", 1)[0], v.runtime.getURL(E.icons[16].replace("16.png", "")))
  ;(self.webpackChunkviolentmonkey = self.webpackChunkviolentmonkey || []).push([
    [987],
    {
      ...
      953: (e, t, n) => {
        ...
        class U {
          ...
          get(e, t, n) {
            ...
            return ((0, o.Bm)(t) ? $.has(t) : L(t))
              ? l
              : (r || M(e, 0, t),
                s ? l : Ae(l) ? (i && (0, o.yI)(t) ? l : l.value) : (0, o.Gv)(l) ? (r ? ve(l) : he(l)) : l)
          }
        }
        class P extends U {
          constructor(e = !1) {
        ...
        function he(e) {
          return _e(e) ? e : ge(e, !1, D, ie, ce)
        }
        function me(e) {
          return ge(e, !1, q, le, ue)
        }
        function ve(e) {
          return ge(e, !0, I, ae, de)
        }
      ...
      641: (e, n, o) => {
        ...
        function S(e) {
          ;(m.length && m.includes(e, d && e.allowRecurse ? v + 1 : v)) ||
        ...
        function R(e) {
          if (g.length) {
            const e = [...new Set(g)].sort((e, t) => M(e) - M(t))
            if (((g.length = 0), y)) return void y.push(...e)
        ...
        function L(e) {
          ...
          try {
            ...
            ;(v = 0), (m.length = 0), R(), (d = !1), (x = null), (m.length || g.length) && L(e)
          }
        }
        let $,
          O = [],
          ...
          const {
            ...
            E = {
              ...
              leave(t, o) {
                ...
                let s = !1
                const i = (t[Q] = (n) => {
                  s || ((s = !0), o(), S(n ? g : v, [t]), (t[Q] = void 0), C[r] === e && delete C[r])
                })
                ;(C[r] = e), m ? k(m, [t, i]) : i()
              },
              clone(e) {
                  ...
                  return (
                    ...
                    h
                      ? ((s.el = h.el),
                        ...
                        i.delete(f),
                        i.add(f))
                      : (i.add(f), p && i.size > parseInt(p, 10) && v(i.values().next().value)),
                    (s.shapeFlag |= 256),
                    (l = s),
                    yn(o.type) ? o : s
                  )
              ...
              mount(s, i, c) {
                if (!l) {
                  ...
                  return (
                    ...
                    (a._container = s),
                    (s.__vue_app__ = a),
                    __VUE_PROD_DEVTOOLS__ && ((a._instance = u.component), P(a, vo)),
                    po(u.component)
                  )
                }
              },
        ...
        function mt(e, t, n, o = !1) {
          const s = {},
            i = ft()
          ;(e.propsDefaults = p.create(null)), gt(e, t, s, i)
          ...
          process(e, t, n, o, r, s, i, l, a, c) {
            ...
            if (null == e) {
              ...
              if (
                ...
                b ? (p(e.dynamicChildren, b, v, r, s, i, l), zt(e, t, !0)) : a || d(e, t, v, y, r, s, i, l, !1),
                g)
              )
        ...
        const qt = function (e, t) {
          t && t.pendingBranch
            ? (0, s.cy)(e)
              ...
              : t.effects.push(e)
            : ((n = e),
              (0, s.cy)(n) ? g.push(...n) : (y && y.includes(n, n.allowRecurse ? _ + 1 : _)) || g.push(n),
              k())
          var n
        }
        function Nt(e) {
        ...
        function Kt(e, t) {
          ...
          const {
            ...
            g = (e, t, n, o = null, r = null, s = null, i = void 0, l = null, a = !!t.dynamicChildren) => {
              if (e === t) return
            ...
            k = (e, t, n, r, i, c, u, d) => {
              let f, h
              const { props: m, shapeFlag: v, transition: g, dirs: y } = e
              if (
                ((f = e.el = a(e.type, c, m && m.is, m)),
                8 & v ? p(f, e.children) : 16 & v && A(e.children, f, null, r, i, Wt(e, c), u, d),
              ...
              _ && g.beforeEnter(f),
                ...
                ((h = m && m.onVnodeMounted) || _ || y) &&
                  qt(() => {
                    h && Hn(h, r, e), _ && g.enter(f), y && Z(e, null, r, "mounted")
                  }, i)
            },
            M = (e, t, n, o, r) => {
            ...
            L = (e, t, n, o, r, i, a) => {
              ...
              if (
                (n && Ht(n, !1),
                (v = m.onVnodeBeforeUpdate) && Hn(v, n, t, e),
              ...
              ;((v = m.onVnodeUpdated) || f) &&
                qt(() => {
                  v && Hn(v, n, t, e), f && Z(t, e, n, "updated")
                }, o)
            },
            $ = (e, t, n, o, r, s, i) => {
            ...
            j = (e, t, n, o, r, i, l, a, c) => {
              ...
              for (; u <= p && u <= f; ) {
                ...
                if (!$n(o, s)) break
                g(o, s, n, null, r, i, l, a, c), u++
              }
              for (; u <= p && u <= f; ) {
                const o = e[p],
                  s = (t[f] = c ? Nn(t[f]) : qn(t[f]))
                if (!$n(o, s)) break
                g(o, s, n, null, r, i, l, a, c), p--, f--
              }
              if (u > p) {
                if (u <= f) {
                  const e = f + 1,
                    s = e < d ? t[e].el : o
                  for (; u <= f; ) g(null, (t[u] = c ? Nn(t[u]) : qn(t[u])), n, s, r, i, l, a, c), u++
                }
                ...
                for (u = h; u <= p; u++) {
                  ...
                  void 0 === s
                    ? X(o, r, i, !0)
                    : ((C[s - m] = u + 1), s >= w ? (w = s) : (x = !0), g(o, t[s], n, null, r, i, l, a, c), _++)
                }
                const S = x ? Xt(C) : s.Oj
                for (y = S.length - 1, u = b - 1; u >= 0; u--) {
                  const e = m + u,
                    s = t[e],
                    p = e + 1 < d ? t[e + 1].el : o
                  0 === C[u] ? g(null, s, n, p, r, i, l, a, c) : x && (y < 0 || u !== S[y] ? z(s, n, p, 2) : y--)
                }
              }
            },
            z = (e, t, n, r, s = null) => {
            ...
            X = (e, t, n, o = !1, r = !1) => {
              ...
              const h = 1 & u && p,
                m = !ue(e)
              let v
              if ((m && (v = i && i.onVnodeBeforeUnmount) && Hn(v, t, e), 6 & u)) Y(e.component, n, o)
              else {
              ...
              ;((m && (v = i && i.onVnodeUnmounted)) || h) &&
                qt(() => {
                  v && Hn(v, t, e), h && Z(e, null, t, "unmounted")
                }, n)
            },
            G = (e) => {
          ...
          const ne = (e, t, n) => {
            ...
            oe = { p: g, um: X, m: z, r: G, mt: P, mc: A, pc: W, pbc: $, n: ee, o: e }
          let re, se
        ...
        function nn(e, t, { immediate: n, deep: o, flush: a, once: c, onTrack: u, onTrigger: d } = s.MZ) {
          ...
          if (
            ((0, r.i9)(e)
              ? ((h = () => e.value), (v = (0, r.fE)(e)))
              : (0, r.g8)(e)
                ? ((h = () => f(e)), (v = !0))
                : (0, s.cy)(e)
                  ? ((g = !0),
                    (v = e.some((e) => (0, r.g8)(e) || (0, r.fE)(e))),
                    (h = () =>
                      e.map((e) =>
          ...
          if (ro) {
            if (((_ = s.tE), t ? n && l(t, p, 3, [h(), g ? [] : void 0, _]) : h(), "sync" !== a)) return s.tE
            {
              const e = Yt()
              y = e.__watcherHandles || (e.__watcherHandles = [])
            }
          }
          let b = g ? new Array(e.length).fill(en) : en
          const x = () => {
            if (C.active && C.dirty)
              if (t) {
                const e = C.run()
                ;(o || v || (g ? e.some((e, t) => (0, s.$H)(e, b[t])) : (0, s.$H)(e, b))) &&
                  (m && m(), l(t, p, 3, [e, b === en ? void 0 : g && b[0] === en ? [] : b, _]), (b = e))
              } else C.run()
          }
          let w
          ;(x.allowRecurse = !!t),
        ...
        function mn(e, t, n) {
          ...
          if (!(n && a >= 0)) return !((!r && !l) || (l && l.$stable)) || (o !== i && (o ? !i || vn(o, i, c) : !!i))
          if (1024 & a) return !0
          if (16 & a) return o ? vn(o, i, c) : !!i
          if (8 & a) {
            const e = t.dynamicProps
            for (let t = 0; t < e.length; t++) {
              const n = e[t]
      ...
      3751: (e, n, o) => {
        ...
        const ge = ["ctrl", "shift", "alt", "meta"],
          ye = {
            ...
            exact: (e, t) => ge.some((n) => e[`${n}Key`] && !t.includes(n)),
          },
          _e = (e, t) => {
      ...
      4526: (n, o, r) => {
        ...
        function re(e, t) {
          ...
          if (((n = g(e)), (o = g(t)), n || o)) return !(!n || !o) && oe(e, t)
          if (((n = k(e)), (o = k(t)), n || o)) {
            if (!n || !o) return !1
        ...
        const ie = (e) => !(!e || !0 !== e.__v_isRef),
          le = (e) =>
            C(e)
              ...
              : null == e
                ? ""
                : g(e) || (k(e) && (e.toString === T || !w(e.toString)))
                  ? ie(e)
                    ? le(e.value)
      ...
      9773: (e, n, o) => {
        ...
        document.addEventListener("scroll", g, !0), t.addEventListener("resize", g, !1)
        const _ = "top",
          b = "bottom",
          x = "left",
          w = "auto-y",
        ...
        if (S || (null != (r = s) && r.runtime));
          ...
          const { Proxy: t } = e,
            ...
            b = (e, t, n, o) => {
              try {
                const r = e(t, n)
                if (r && r instanceof f) return g(r, o), !0
                void 0 !== r && o(m(r))
              } catch (e) {
                o(m(0, e))
              }
      ...
      8916: (e, o, r) => {
        ...
        const p = s.T.windows,
          h = (e) => (e ? "1" : null == e ? "" : "0"),
          m = /(Receiving end does not exist)|The message port closed before|moved into back\/forward cache|$/
        function v() {
          const e = new Set()
          return {
        ...
        function y(e, t, n) {
          return S && c(t) && (t = (0, i.A4)(t)), C({ cmd: e, data: t }, n)
        }
        const _ = ["ConfirmInstall", "Notification", "TabClose", "TabFocus", "TabOpen"],
          b = () => (null == s.T.extension.getBackgroundPage ? void 0 : s.T.extension.getBackgroundPage())
        function x(e, n, o, r) {
          const s = !_.includes(e) && b(),
            l = s && s !== t && s.deepCopy
          return l
        ...
        function w(e, t, n, o) {
          return s.T.tabs.sendMessage(e, { cmd: t, data: n }, o).catch(E)
        }
        function C(e, { retry: t } = {}) {
          if (t) return k(e)
          let n = s.T.runtime.sendMessage(e)
          return (n = n.catch(E)), n
        }
        async function k(e, t = 1e4) {
          for (let o = g.now(); g.now() - o < t; ) {
            try {
              const t = await C(e)
              if (void 0 !== t) return t
            } catch (e) {
              if (!m.exec(e)[1]) throw e
            }
        ...
        function E(e) {
          if (!m.exec(e)[0]) return f.reject(e)
        }
        function T(e, t) {
          return navigator.languages.map((n) => e[`${t}:${n}`] || e[`${t}:${n.toLowerCase()}`]).find(u) || e[t] || ""
        }
        function R(e) {
          var t
          let n
        ...
        function A(e) {
          var t
          return e.custom.name || T(e.meta, "name") || `#${null != (t = e.props.id) ? t : (0, a.Ru)("labelNoName")}`
        }
        function L(e) {
          var t
          return (null == (t = `${e.custom[l] || e.meta[l] || ""}`.match(s.a7)) ? void 0 : t[1]) || "end"
        }
        function $(e, { all: t, allowedOnly: n, enabledOnly: o } = {}) {
          ...
          T = (0, o(6262).A)(E, [
            [
              ...
              (e, t, n, o, i, l) => (
                ...
                (0, r.CE)("div", m, [
                  (0, r.Lk)("div", v, [
                    (0, r.Lk)("p", { textContent: (0, d.v_)(o.content.title) }, null, 8, g),
                    o.content.desc
      ...
      5005: (t, n, o) => {
        ...
        ;(i = d(c[u] || "")),
          ...
          (document.documentElement.lang = v.i18n.getUILanguage())
      },
      8275: (e, t, n) => {
        "use strict"
        n.d(t, { Gg: () => c, gv: () => i })
      ...
      4758: (e, t, n) => {
        ...
        n.d(t, {
          ...
          n(618)
        const o = r((e, t) => v.i18n.getMessage(e, t) || e)
        function r(e) {
          const t = p.create(null)
          return function (...n) {
            ...
            (e) => {
              ...
              return (
                ...
                p.assign(S, {
                  ...
                  [g](e, t) {
                    const n = t[m]
                    return (t[g] = null), (t[m] = null), n && e.match(o[n], !0) ? "string" : null
                  },
                }),
                N({
                  css1: [
                ...
                }),
                {
                  ...
                  token: (e, n) => {
                    let o = null
                    if (!n[u] && ((o = w.token(e, n[a])), null === o)) return n[a][v] === C ? "string-2" : null
              ...
              function oe() {
                b.forEach((e) => {
                  if (!e.el) {
                    ...
                    ;(l[X] = !0),
                      (i.className = z),
                      (i.title = (0, v.Ru)("editLongLineTooltip")),
                      (i.textContent = `${r.slice(0, d)}...[${(0, v.Ru)("editLongLine")}]`),
                      (i.onclick = () => {
              ...
              return (
                ...
                (0, r.sV)(() => {
                  ...
                  ;(u = f()(s, o)),
                    ...
                    (0, y.A)("editor", (t) => {
                      w(g.ZB, { ...O.A, ...t }, ([o, r]) => {
                        ;(!(o in t) && !(o in e)) || o in n || (0, g.bD)(u.getOption(o), r) || u.setOption(o, r)
                      }),
                        (e = t)
                    }),
                    (0, v.dr)("Storage", ["base", "getOne", "editorSearch"]).then((e) => {
                      const t = (0, v.sg)(() => {
                          ;(0, v.dr)("Storage", [
                            "base",
                            "setOne",
                            "editorSearch",
                            (0, g.je)(R, ["query", "replace", "options"]),
                          ])
                        }, 500),
                        n = () => {
                          t(), ae({ pos: "from" })
                          ...
                          [
                            (0, r.Lk)(
                              ...
                              [
                                (0, r.Lk)(
                                  "span",
                                  { textContent: (0, l.v_)((0, s.R1)(v.Ru)("labelLineNumber")) },
                                  null,
                                  8,
                                  P
                                ),
                            ...
                            (0, r.Lk)(
                              ...
                              [
                                (0, r.Lk)(
                                  "span",
                                  { textContent: (0, l.v_)((0, s.R1)(v.Ru)("labelSearch")) },
                                  null,
                                  8,
                                  F
                                ),
                              ...
                              : ((0, r.uX)(),
                                (0, r.CE)(
                                  ...
                                  [
                                    (0, r.Lk)(
                                      "span",
                                      { textContent: (0, l.v_)((0, s.R1)(v.Ru)("labelReplace")) },
                                      null,
                                      8,
                                      q
                                    ),
                                      ...
                                      { content: M.replace, align: "end" },
                                      {
                                        default: (0, r.k6)(() => [
                                          (0, r.Lk)(
                                            ...
                                            {
                                              type: "submit",
                                              textContent: (0, l.v_)((0, s.R1)(v.Ru)("buttonReplace")),
                                            },
                                            null,
                                            8,
                                            N
                                      ...
                                      { content: M.replaceAll, align: "end" },
                                      {
                                        default: (0, r.k6)(() => [
                                          (0, r.Lk)(
                                            ...
                                            {
                                              type: "button",
                                              textContent: (0, l.v_)((0, s.R1)(v.Ru)("buttonReplaceAll")),
                            ...
                            (0, r.Lk)("div", null, [
                              (0, r.bF)(
                                (0, s.R1)(a.A),
                                { content: (0, s.R1)(v.Ru)("searchUseRegex"), align: "end" },
                                {
                                  default: (0, r.k6)(() => [
                                    (0, r.bF)(
                                      (0, s.R1)(c),
                              ...
                              (0, r.bF)(
                                (0, s.R1)(a.A),
                                { content: (0, s.R1)(v.Ru)("searchCaseSensitive"), align: "end" },
                                {
                                  default: (0, r.k6)(() => [
                                    (0, r.bF)(
                                      (0, s.R1)(c),
      ...
      3901: (e, t, n) => {
        ...
        const m = { class: "setting-text" },
          v = ["disabled", "placeholder", "rows"],
          g = ["textContent", "title", "disabled"],
