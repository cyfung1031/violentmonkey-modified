  ...
  c.runtime.getURL(m.icons[16].replace("16.png", "")),
    (() => {
          ...
          8017: (e, a, o) => {
            ...
            const $ = { key: 0, id: "wall" },
              ...
              ce = {
                __name: "app",
                setup(e) {
                  const a = ("m" === k.LY.ctrlcmd ? "\u2318" : "Ctrl-") + "Enter",
                    ...
                    Ee = (0, d.Fl)(() => {
                      ...
                      return [
                        ...
                        a && [a, "question", (0, u.ag)("buttonSupport")],
                      ].filter(n)
                    })
                  ...
                  async function lt(e) {
                    var t
                    Ce.value = !1
                    const a = Pe ? await new s(dt) : await ut(Ae.url)
                    if (null == a || (e && pe.value === a)) throw 0
                    const l = null == (t = fe.value) ? void 0 : t.$code.cm,
                      n = l && a.split(/\r?\n/)
                    let o,
                      i = -1
                    null == l || l.eachLine(({ text: e }) => (o = e !== n[++i])),
                      (pe.value = a),
                      (o || (l && i < n.length - 1)) &&
                        (await (0, d.Y3)(), l.setCursor(i), l.scrollIntoView(null, l.display.lastWrapHeight / 3))
                  }
                  async function nt() {
                    const e = await (0, u.gj)("ParseMeta", pe.value),
                      ...
                      l = (0, u.iQ)(t, "name")
                    if (
                      ((document.title = `${l.slice(0, 100) || a[0]}${l.length > 100 ? "..." : ""} - ${Ye || (Ye = document.title)}`),
                      (De.value = g(u.Hv, [l, t.version], ", ")),
                  ...
                  async function ot() {
                    ...
                    const t = Ke.length + Ve.length,
                      a = v.now(),
                      l = () => {
                        v.now() - a > 500 && ($e.value = (0, u.ag)("msgLoadingDependency", [e, t]))
                      },
                      n = async (t, a, n) => {
                        const o = (0, u.mn)(t, Ae.url),
                          i = `${+n}${t}`
                        try {
                          ;(he.value[i] = a[o] = await st(o, { isBlob: n, useCache: !0 })), (e += 1), l()
                        } catch (e) {
                  ...
                  async function st(e, { isBlob: t, useCache: a } = {}) {
                    const n = t ? `blob+${e}` : `text+${e}`
                    if (a && o.has(n)) return o.get(n)
                    const i = await (0, u.WY)(e, { [l]: t ? "blob" : null }),
                      s = t ? await (0, u.LZ)(i) : i.data
                    return a && o.put(n, s), s
                  }
                  async function ut(e) {
                    try {
                  ...
                  async function rt(e, t) {
                    ...
                    if ("+track" === a && We.value) null == Re || Re(!0)
                    else {
                      Ce.value = !1
                      try {
                  ...
                  async function vt() {
                    const { name: e, namespace: t } = Te.value.meta || {},
                      a = await (0, u.gj)("GetScript", { meta: { name: e, namespace: t } })
                    ;(Le.value = !!a), (je.value = a && pe.value === (await (0, u.gj)("GetScriptCode", a.props.id)))
                  }
                  function dt(e) {
                    ;(qe = e),
                      Ie ||
      ...
      function r(e) {
        ...
        var l = (u[e] = { exports: {} })
        return a[e].call(l.exports, l, l.exports, r), l.exports
      }
      ;(r.m = a),
        (e = []),
        (r.O = (t, a, l, n) => {
          if (!a) {
            ...
            for (v = 0; v < e.length; v++) {
              for (var [a, l, n] = e[v], s = !0, u = 0; u < a.length; u++)
                (!1 & n || o >= n) && i.keys(r.O).every((e) => r.O[e](a[u]))
                  ? a.splice(u--, 1)
                  : ((s = !1), n < o && (o = n))
              if (s) {
                e.splice(v--, 1)
        ...
        (r.d = (e, t) => {
          for (var a in t) r.o(t, a) && !r.o(e, a) && i.defineProperty(e, a, { enumerable: !0, get: t[a] })
        }),
        ...
        (() => {
          ...
          var t = (t, a) => {
              ...
              for (t && t(a); u < o.length; u++) (n = o[u]), r.o(e, n) && e[n] && e[n][0](), (e[n] = 0)
              return r.O(c)
            },
