            ...
            const F = { key: 0, id: "wall" },
              ...
              de = {
                ...
                setup(l) {
                  ...
                  let Ue, Me, je, Qe, He, qe, Ne, Be, Ge, Ve, Ye, Je, ze, Ze, et, tt, lt, at
                  async function nt() {
                    await st(),
                      (await rt()) &&
                        (await s.all([
                          ...
                          (async () => {
                            let e = 2
                            for (; !(await it()) && e; ) await (0, i.F1)(3e3), (e -= 1)
                          })(),
                        ]),
                  ...
                  async function ot(e) {
                    ;(we.value.fs = Le.value = De.value = !1),
                      ...
                      (ye.value = Oe.value = $e.value = Ze = tt = null),
                      await nt(),
                      Ve || ut()
                  }
                  async function st(e) {
                    var t
                    Le.value = !1
                    const l = He ? await new s(Rt) : await dt(Je.url)
                  ...
                  async function rt() {
                    ...
                    if (
                      ...
                      t && ((et = [...new Set(t.require)]), (lt = [...new Set(o.values(t.resources))])),
                      a)
                    )
                      return e
                  ...
                  async function it() {
                    if (
                      ...
                      Ze &&
                        ...
                        (0, E.bD)([...lt].sort(), o.keys(tt).sort()))
                    )
                      return
                    ;(Ze = {}), (tt = {})
                    let e = 0
                    const t = et.length + lt.length,
                      l = v.now(),
                      a = () => {
                      ...
                      n = async (t, l, n) => {
                        const u = (0, i.bO)(t, Je.url),
                          o = `${+n}${t}`
                        try {
                          ;(he.value[o] = l[u] = await vt(u, { isBlob: n, useCache: !0 })), (e += 1), a()
                        } catch (e) {
                          return (he.value[o] = !1), t
                        }
                      },
                      u = setTimeout(a, 500),
                      r = [...et.map((e) => n(e, Ze, !1)), ...lt.map((e) => n(e, tt, !0))],
                  ...
                  async function dt(e) {
                    try {
                      return Ue ? await (await Ue.getFile()).text() : (Ne && (await Ne)) || (await vt(e))
                    } catch (e) {
                      var t
                  ...
                  async function pt() {
                    if (!De.value && Ee.value && _e.value) {
                      if (
                        ((Ne = null),
                        (De.value = !0),
                        Ue && null == Me && (Me = e.FileSystemObserver || !1) && (Me = new Me((0, i.sg)(mt, 20))),
                        Me)
                      )
                        try {
                          await Me.observe(Ue)
                      ...
                      for (
                        ...
                        !(await (Me ? at : s.race([(0, i.F1)(500), at]))));

                      )
                        await mt(), Be()
                      Me && Me.disconnect(), (at = De.value = !1)
                    }
                  }
                  async function mt() {
                    try {
                      await st(!0)
                      const e = await rt()
                      await it(), await ft(null, e), (Te.value = !1)
                    } catch (e) {}
                  }
                  async function kt() {
                                            ...
                                            [
                                              (0, m.Lk)(
                                                ...
                                                (0, m.v6)(
                                                  ...
                                                  (e._bind = { disabled: !Le.value, onclick: ft })
                                                ),
                                                null,
                                                16,
                                                te
                                              ...
                                              (0, m.Lk)(
                                                "button",
                                                { textContent: (0, R.v_)((0, g.R1)(i.Ru)("buttonClose")), onClick: ct },
                                                null,
                                                8,
                                                se
                                              ),
