{
  ...
  if (1 !== window[e]) {
    const t = this,
      ...
      { append: se, appendChild: ce, attachShadow: le, remove: de, setAttribute: ue } = Element[L],
      {
        assign: pe,
        defineProperty: fe,
    ...
    ;(() => {
      ...
      const qe = (e, t) => $(I($e, Me, e), t || 0),
        ...
        ot = (e, t, o) => {
          ...
          I(
            ...
            e,
            (e) => {
              if ((I(ve, e), a)) (a.node = I(_e, e)), (e = a), (a = null)
              else if (((e = I(ke, e)), J && (e = J(e, n)), e.node && (a = e))) return
              o.onHandle(e)
            },
            !0
          ),
            (o.post = (e, a, r, i) => {
              const s = o[c] ? i : r,
                l = s && new V(t, { __proto__: null, relatedTarget: s })
              nt(t, { cmd: e, data: a, node: !!l }), l && I(z, n, l)
            })
        },
        at = Q(),
        rt = Q(),
      ...
      be.runtime.onMessage.addListener(async ({ cmd: e, data: t }, n) => {
        ...
        it.push(({ clipFF: e }) => {
          ...
          ct({ SetClipboard: ht || Se })
        })
      const yt = Q(),
        mt = ["script", "style", "link", "meta"],
        { toLowerCase: gt } = "",
        { [c]: bt } = ut
      let vt, kt
      async function _t(e) {
        if (kt) {
          ...
          await et("SetPopup", { [c]: bt, [u]: ut[u], menus: yt })
        }
      }
      lt(
        {
        ...
        ct({
          AddElement({ tag: e, attrs: t, cbId: n }, o) {
            let a, r
            try {
              const n = this || (I(ne, mt, I(gt, `${e}`)) && qe("head")) || qe("body") || qe("*")
              ;(a = Ye(e, t)), Qt(a), I(ce, n, a)
            } catch (e) {
              r = [`${e}`, e.stack]
            }
      ...
      function St(e, t) {
        P(Ct, e), (ut[c][e] = t || f), Mt || (Mt = Tt(2))
      }
      async function Tt(e, t = !xt) {
        for (; --e >= 0; ) await He()
        et("Run", { reset: t, [c]: Ct }), _t(!!Mt), (Mt = !1), (xt = !0)
      }
      function Et(e) {
      ...
      function Ht(e) {
        ...
        function u(e) {
          ;(Ot = !0), I(ve, e), ot(s, c, ut), nt(`${i}*`, [c, s])
        }
      }
      async function qt(e, t) {
        ...
        a && Re.warn(a),
          ...
          (Pt[r] = i),
          pe(ut[l], e[l]),
          t || e[s] ? (Ot = !1) : e[f] && null == Ot && Ht(e)
        const d = e[h].filter((e) => Bt(e) === r).map((e) => [e.id, e.key.data]),
          u = (c || d.length) && et("InjectionFeedback", { [s]: !Ot, [r]: d, [p]: c, url: Te && location.href }),
      ...
      const { fetch: tn, FileReader: nn, FormData: on } = t,
        ...
        { createObjectURL: sn, revokeObjectURL: cn } = URL,
        ln = O[L],
        dn = we(ln, "type").get,
      ...
      async function _n(e, t, n, o, a, r) {
        for (
          o ? (await Cn(n, o), (t = null)) : (t = await Ln(n, gn(e)));
          Rn(
            (e = { id: e.id, type: a ? yn : mn, data: { finalUrl: n, readyState: 4, status: 200, [y]: t, [m]: "" } }),
            r
          ),
            a;
      ...
      it.push((e) => {
        ...
        ct({
          async HttpRequest(e, t) {
            ...
            const { events: o, url: a, [x]: r } = e,
              i = I(ne, o, yn),
              s = I(re, a, 0, 5)
            return "data:" === s || ("blob:" === s && 5 === I(ae, a, location.origin + "/"))
              ? _n(e, n, a, r, i, t)
        ...
        lt({
          async HttpRequested(e) {
            ...
            null != a &&
              (e.blobbed
                ? ((a = await Ln(a, gn(o))), et("RevokeBlob", a))
                : e.chunked &&
                  (Mn(o, a),
                  (a = o[hn]),
                  delete o[hn],
                  gn(o) ? (a = new O([a], { type: e.contentType })) : o[v] && (a = I(un, a))),
              (n[y] = a)),
              a && o[x] && (o[y] = a),
              e.type === yn && o[x] && (await Cn(sn(o[y]), o[x], !0)),
      ...
      lt({ [o]: () => !0 }, !0),
        ...
        ct({ Log: (e) => j(Re[e[0]], Re, e[1]), TabFocus: Se, UpdateValue: Se }),
        (async () => {
          const e = Me instanceof XMLDocument,
            n = Pn(),
            o = et("GetInjected", { url: Te && location.href, [s]: e, done: !(!n && !t.vmData) }, { retry: !0 }),
            a = n || (Te && Event[L].composedPath ? await Un(o) : await o),
            r = (ut[u] = a[u])
          pe(Dn, a[c]),
            Te && !a.clipFF && K("copy", pt, !0),
            null != a[i] && !e && Ht(a) && (ct({ GetScriptVer: !0 }), ut.post("Expose", a[i])),
            me(Dn).length && (it.forEach((e) => e(a)), await qt(a, e)),
            (it.length = 0),
            Et(r)
        })().catch(Te && Re.error),
        Te &&
