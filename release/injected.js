  ...
  if (1 !== window[e]) {
    ...
    ;(() => {
      ...
      async function Wt(e, t, n) {
        var o, a
        const { errors: i, [p]: c } = e,
          l = "cache"
        i && Re.warn(i),
          (t.gmi = { isIncognito: J.extension.inIncognitoContext }),
          (Nt = K()),
          (Nt[f] = t),
          (Nt[r] = t),
          pe(wt[l], e[l]),
          n || e[s] ? (Ft = !1) : e[f] && null == Ft && Gt(e)
        ...
        if (
          ...
          (jt = K()),
          await et("*", zt, "start"),
          ((null != (o = At) && o.body) || (null != (a = Ot) && a.body)) && (await et("body", zt, "body")),
          c && (e = await u))
        ) {
          pe(wt[l], e[l]),
            "loading" === I(w, Me) &&
      ...
      pt({ [o]: () => !0 }, !0),
        ...
        (async () => {
          ...
          pe(Un, a[c]),
            ...
            Ee && r && (Ee = parseFloat(r.ua.browserVersion)),
            null != a[i] && !e && Gt(a) && (ut({ GetScriptVer: !0 }), wt.post("Expose", a[i])),
            me(Un).length && (lt.forEach((e) => e(a)), await Wt(a, r, e)),
            (lt.length = 0),
            Pt(l)
        })().catch(Ee && Re.error),
        Ee &&
